...
wire   [21:0] tmp_73_fu_352_p1;
reg   [21:0] tmp_73_reg_872;
...
reg  signed [21:0] tmp_49_reg_893;
wire   [0:0] tmp_39_fu_370_p2;
wire   [0:0] ap_CS_fsm_state5;
wire   [0:0] tmp_46_fu_411_p2;
wire   [8:0] tmp_50_fu_469_p2;
reg   [8:0] tmp_50_reg_917;
...
wire   [0:0] tmp_37_fu_341_p2;
reg   [10:0] col_img_reg_210;
wire   [0:0] tmp_35_fu_322_p2;
...
wire  signed [63:0] tmp_63_cast_fu_434_p1;
wire   [63:0] tmp_64_cast_fu_448_p1;
wire  signed [63:0] tmp_65_cast_fu_535_p1;
wire   [63:0] tmp_66_cast_fu_549_p1;
wire  signed [63:0] tmp_67_cast_fu_635_p1;
wire   [63:0] tmp_68_cast_fu_649_p1;
wire  signed [63:0] tmp_69_cast_fu_734_p1;
wire   [63:0] tmp_70_cast_fu_747_p1;
...
wire  signed [31:0] tmp_34_fu_314_p1;
wire  signed [31:0] tmp_36_fu_333_p1;
wire  signed [31:0] tmp_38_fu_362_p1;
wire   [0:0] tmp_43_fu_384_p2;
wire   [0:0] tmp_44_fu_390_p2;
wire  signed [31:0] tmp_45_fu_407_p1;
wire  signed [11:0] tmp_95_cast_fu_416_p1;
wire   [11:0] tmp_47_fu_420_p2;
wire  signed [21:0] tmp_48_cast_fu_425_p1;
(* use_dsp48 = "no" *) wire   [21:0] tmp_51_fu_429_p2;
wire  signed [21:0] tmp_49_cast_fu_439_p1;
wire   [21:0] tmp_52_fu_443_p2;
wire   [7:0] tmp_74_fu_453_p1;
wire   [7:0] tmp_75_fu_461_p1;
...
(* use_dsp48 = "no" *) wire   [21:0] tmp_53_fu_530_p2;
wire  signed [21:0] tmp_99_1_cast_fu_540_p1;
wire   [21:0] tmp_54_fu_544_p2;
wire   [7:0] tmp_76_fu_554_p1;
wire   [7:0] tmp_77_fu_562_p1;
...
(* use_dsp48 = "no" *) wire   [21:0] tmp_55_fu_630_p2;
wire  signed [21:0] tmp_99_2_cast_fu_640_p1;
wire   [21:0] tmp_56_fu_644_p2;
wire  signed [31:0] tmp_95_3_fu_660_p1;
wire   [7:0] tmp_78_fu_669_p1;
wire   [7:0] tmp_79_fu_677_p1;
...
(* use_dsp48 = "no" *) wire   [21:0] tmp_57_fu_729_p2;
wire  signed [21:0] tmp_99_3_cast_fu_739_p1;
wire   [21:0] tmp_58_fu_742_p2;
wire   [7:0] tmp_80_fu_758_p1;
wire   [7:0] tmp_81_fu_766_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == tmp_35_fu_322_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) & (1'b0 == tmp_46_fu_411_p2))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state4) & ~(tmp_39_fu_370_p2 == 1'b0))) begin
        SAD_1_reg_270 <= minSAD_1_reg_234;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_39_fu_370_p2 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & ~(1'b0 == tmp_37_fu_341_p2))) begin
        minSAD_1_reg_234 <= ap_const_lv32_0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_39_fu_370_p2 == 1'b0) & ~(1'b0 == or_cond_fu_396_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b0 == tmp_37_fu_341_p2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_CS_fsm_state2) & (1'b0 == tmp_35_fu_322_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'b0 == tmp_35_fu_322_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        imINPUT_address0 = tmp_69_cast_fu_734_p1;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        imINPUT_address0 = tmp_67_cast_fu_635_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        imINPUT_address0 = tmp_65_cast_fu_535_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        imINPUT_address0 = tmp_63_cast_fu_434_p1;
    end else begin
        imINPUT_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        tplINPUT_address0 = tmp_70_cast_fu_747_p1;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        tplINPUT_address0 = tmp_68_cast_fu_649_p1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        tplINPUT_address0 = tmp_66_cast_fu_549_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        tplINPUT_address0 = tmp_64_cast_fu_448_p1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((1'b0 == tmp_35_fu_322_p2)) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else begin
        ...
        ap_ST_fsm_state3 : begin
            if ((1'b0 == tmp_37_fu_341_p2)) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if ((tmp_39_fu_370_p2 == 1'b0)) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if ((1'b0 == tmp_46_fu_411_p2)) begin
...
assign abs_fu_485_p3 = ((abscond_fu_480_p2[0:0] === 1'b1) ? tmp_50_reg_917 : neg_fu_475_p2);
...
assign abscond_fu_480_p2 = (($signed(tmp_50_reg_917) > $signed(9'b000000000)) ? 1'b1 : 1'b0);
...
assign neg_fu_475_p2 = (ap_const_lv9_0 - tmp_50_reg_917);

assign next_mul_fu_356_p2 = (ap_const_lv64_4B0 + phi_mul_reg_247);

assign or_cond_fu_396_p2 = (tmp_43_fu_384_p2 | tmp_44_fu_390_p2);
...
assign tmp_100_1_cast_fu_558_p1 = $signed(tmp_76_fu_554_p1);

assign tmp_100_2_cast_fu_673_p1 = $signed(tmp_78_fu_669_p1);

assign tmp_100_3_cast_fu_762_p1 = $signed(tmp_80_fu_758_p1);

assign tmp_100_cast_fu_457_p1 = $signed(tmp_74_fu_453_p1);

assign tmp_101_1_cast_fu_566_p1 = $signed(tmp_77_fu_562_p1);

assign tmp_101_2_cast_fu_681_p1 = $signed(tmp_79_fu_677_p1);

assign tmp_101_3_cast_fu_770_p1 = $signed(tmp_81_fu_766_p1);

assign tmp_101_cast_fu_465_p1 = $signed(tmp_75_fu_461_p1);
...
assign tmp_34_fu_314_p1 = $signed(row_img_reg_197);

assign tmp_35_fu_322_p2 = (($signed(tmp_34_fu_314_p1) < $signed(tmp_reg_833)) ? 1'b1 : 1'b0);

assign tmp_36_fu_333_p1 = $signed(col_img_reg_210);

assign tmp_37_fu_341_p2 = (($signed(tmp_36_fu_333_p1) < $signed(tmp_s_reg_838)) ? 1'b1 : 1'b0);

assign tmp_38_fu_362_p1 = row_tpl_reg_223;

assign tmp_39_fu_370_p2 = (($signed(tmp_38_fu_362_p1) < $signed(tplHeight)) ? 1'b1 : 1'b0);

assign tmp_40_cast_fu_318_p1 = $signed(row_img_reg_197);

assign tmp_42_cast_fu_337_p1 = $signed(col_img_reg_210);

assign tmp_43_fu_384_p2 = (($signed(minSAD_fu_76) > $signed(minSAD_1_reg_234)) ? 1'b1 : 1'b0);

assign tmp_44_fu_390_p2 = ((minSAD_fu_76 == ap_const_lv32_0) ? 1'b1 : 1'b0);

assign tmp_45_fu_407_p1 = $signed(col_tpl_reg_258);

assign tmp_46_fu_411_p2 = (($signed(tmp_45_fu_407_p1) < $signed(tplWidth)) ? 1'b1 : 1'b0);

assign tmp_47_fu_420_p2 = ($signed(tmp_42_cast_reg_856) + $signed(tmp_95_cast_fu_416_p1));

assign tmp_48_cast_fu_425_p1 = $signed(tmp_47_fu_420_p2);

assign tmp_49_cast_fu_439_p1 = $signed(col_tpl_reg_258);

assign tmp_50_fu_469_p2 = ($signed(tmp_100_cast_fu_457_p1) - $signed(tmp_101_cast_fu_465_p1));

assign tmp_51_fu_429_p2 = ($signed(tmp_49_reg_893) + $signed(tmp_48_cast_fu_425_p1));

assign tmp_52_fu_443_p2 = ($signed(tmp_73_reg_872) + $signed(tmp_49_cast_fu_439_p1));

assign tmp_53_fu_530_p2 = ($signed(tmp_49_reg_893) + $signed(tmp_98_1_cast_fu_526_p1));

assign tmp_54_fu_544_p2 = ($signed(tmp_73_reg_872) + $signed(tmp_99_1_cast_fu_540_p1));

assign tmp_55_fu_630_p2 = ($signed(tmp_49_reg_893) + $signed(tmp_98_2_cast_fu_626_p1));

assign tmp_56_fu_644_p2 = ($signed(tmp_73_reg_872) + $signed(tmp_99_2_cast_fu_640_p1));

assign tmp_57_fu_729_p2 = ($signed(tmp_49_reg_893) + $signed(tmp_98_3_cast_fu_725_p1));

assign tmp_58_fu_742_p2 = ($signed(tmp_73_reg_872) + $signed(tmp_99_3_cast_fu_739_p1));

assign tmp_63_cast_fu_434_p1 = $signed(tmp_51_fu_429_p2);

assign tmp_64_cast_fu_448_p1 = tmp_52_fu_443_p2;

assign tmp_65_cast_fu_535_p1 = $signed(tmp_53_fu_530_p2);

assign tmp_66_cast_fu_549_p1 = tmp_54_fu_544_p2;

assign tmp_67_cast_fu_635_p1 = $signed(tmp_55_fu_630_p2);

assign tmp_68_cast_fu_649_p1 = tmp_56_fu_644_p2;

assign tmp_69_cast_fu_734_p1 = $signed(tmp_57_fu_729_p2);

assign tmp_70_cast_fu_747_p1 = tmp_58_fu_742_p2;

assign tmp_73_fu_352_p1 = phi_mul_reg_247[21:0];

assign tmp_74_fu_453_p1 = imINPUT_q0[7:0];

assign tmp_75_fu_461_p1 = tplINPUT_q0[7:0];

assign tmp_76_fu_554_p1 = imINPUT_q0[7:0];

assign tmp_77_fu_562_p1 = tplINPUT_q0[7:0];

assign tmp_78_fu_669_p1 = imINPUT_q0[7:0];

assign tmp_79_fu_677_p1 = tplINPUT_q0[7:0];

assign tmp_80_fu_758_p1 = imINPUT_q0[7:0];

assign tmp_81_fu_766_p1 = tplINPUT_q0[7:0];
