...
set C_modelArgList {
	...
	{ output_struct_x int 11 regular {pointer 1}  }
	{ output_struct_y int 11 regular {pointer 1}  }
	{ output_struct_SAD int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "imINPUT", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_struct_x", "interface" : "wire", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	{ "Name" : "output_struct_y", "interface" : "wire", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	{ "Name" : "output_struct_SAD", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_struct_x sc_out sc_lv 11 signal 6 } 
	{ output_struct_y sc_out sc_lv 11 signal 7 } 
	{ output_struct_SAD sc_out sc_lv 32 signal 8 } 
	...
	{ output_struct_y_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ output_struct_x_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ output_struct_SAD_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set NewPortList {[ 
	{ "name": "imINPUT_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "imINPUT", "role": "address0" }} , 
 	...
 	{ "name": "output_struct_x", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "output_struct_x", "role": "default" }} , 
 	{ "name": "output_struct_y", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "output_struct_y", "role": "default" }} , 
 	{ "name": "output_struct_SAD", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_struct_SAD", "role": "default" }} , 
 	...
 	{ "name": "output_struct_y_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "output_struct_y", "role": "ap_vld" }} , 
 	{ "name": "output_struct_x_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "output_struct_x", "role": "ap_vld" }} , 
 	{ "name": "output_struct_SAD_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "output_struct_SAD", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		{"Name" : "output_struct_x", "Type" : "Vld", "Direction" : "O",
			"SubConnect" : [
			{"ID" : "1", "SubInstance" : "imDiff_Loop_L66_proc_U0", "Port" : "output_struct_x"}]},
		{"Name" : "output_struct_y", "Type" : "Vld", "Direction" : "O",
			"SubConnect" : [
			{"ID" : "1", "SubInstance" : "imDiff_Loop_L66_proc_U0", "Port" : "output_struct_y"}]},
		{"Name" : "output_struct_SAD", "Type" : "Vld", "Direction" : "O",
			"SubConnect" : [
			{"ID" : "1", "SubInstance" : "imDiff_Loop_L66_proc_U0", "Port" : "output_struct_SAD"}]}],
		"InputProcess" : [
			{"ID" : "1", "Name" : "imDiff_Loop_L66_proc_U0", "ReadyCount" : "imDiff_Loop_L66_proc_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "imDiff_Loop_L66_proc_U0"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.imDiff_Loop_L66_proc_U0", "Parent" : "0", "Child" : ["2"],
		...
		{"Name" : "output_struct_x", "Type" : "Vld", "Direction" : "O"},
		{"Name" : "output_struct_SAD", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.imDiff_Loop_L66_proc_U0.imTemplateMatching8j_U25", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	output_struct_x { ap_vld {  { output_struct_x out_data 1 11 }  { output_struct_x_ap_vld out_vld 1 1 } } }
	output_struct_y { ap_vld {  { output_struct_y out_data 1 11 }  { output_struct_y_ap_vld out_vld 1 1 } } }
	output_struct_SAD { ap_vld {  { output_struct_SAD out_data 1 32 }  { output_struct_SAD_ap_vld out_vld 1 1 } } }
}
