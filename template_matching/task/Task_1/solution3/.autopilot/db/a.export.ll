; ModuleID = '/home/student/workspace_HLS/template_matching/task/Task_1/solution3/.autopilot/db/a.o.2.bc'
...
@p_str930 = private unnamed_addr constant [4 x i8] c"L44\00", align 1
@p_str829 = private unnamed_addr constant [4 x i8] c"L33\00", align 1
@p_str728 = private unnamed_addr constant [4 x i8] c"L22\00", align 1
@p_str627 = private unnamed_addr constant [20 x i8] c"imGreyNormalization\00", align 1
@p_str526 = private unnamed_addr constant [4 x i8] c"L11\00", align 1
@p_str425 = private unnamed_addr constant [4 x i8] c"L00\00", align 1
@p_str21 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@p_str1637 = private unnamed_addr constant [5 x i8] c"L111\00", align 1
@p_str1536 = private unnamed_addr constant [5 x i8] c"L110\00", align 1
@p_str1435 = private unnamed_addr constant [4 x i8] c"L99\00", align 1
@p_str1334 = private unnamed_addr constant [4 x i8] c"L88\00", align 1
@p_str1233 = private unnamed_addr constant [4 x i8] c"L77\00", align 1
@p_str122 = private unnamed_addr constant [12 x i8] c"imGrayScale\00", align 1
@p_str1132 = private unnamed_addr constant [4 x i8] c"L66\00", align 1
@p_str1031 = private unnamed_addr constant [4 x i8] c"L55\00", align 1
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([5 x i8]* @p_str1536) nounwind
  %tmp_23_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([5 x i8]* @p_str1536) nounwind
...
; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([5 x i8]* @p_str1637) nounwind
  %tmp_24_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([5 x i8]* @p_str1637) nounwind
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, [1 x i8]* @p_str21) nounwind
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([5 x i8]* @p_str1637, i32 %tmp_24_i) nounwind
  br label %3

; <label>:5                                       ; preds = %3
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([5 x i8]* @p_str1536, i32 %tmp_23_i) nounwind
  br label %1
...
define internal fastcc void @imGreyNormalization([1440000 x i32]* nocapture %imINPUT, i32 %imHeight, i32 %imWidth) {
  ...
  call void (...)* @_ssdm_op_SpecResourceLimit(i32 1, [1 x i8]* @p_str21, [1 x i8]* @p_str21, [20 x i8]* @p_str627, [1 x i8]* @p_str21) nounwind
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str728)
...
; <label>:4                                       ; preds = %._crit_edge.2, %._crit_edge.1, %._crit_edge.0, %3
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str728, i32 %tmp_7)
  br label %1
...
; <label>:5                                       ; preds = %.preheader
  ...
  %tmp_12 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str930)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, [1 x i8]* @p_str21) nounwind
  br label %6
...
; <label>:8                                       ; preds = %7
  ...
  %tmp_i_i1_12 = sub i11 1023, %loc_V_2
  %tmp_i_i21_cast = sext i11 %tmp_i_i1_12 to i12
...
; <label>:9                                       ; preds = %8
  ...
  %tmp_i_i2_13 = sub i11 1023, %loc_V_4
  %tmp_i_i42_cast = sext i11 %tmp_i_i2_13 to i12
...
; <label>:10                                      ; preds = %9
  ...
  %tmp_i_i3_14 = sub i11 1023, %loc_V_6
  %tmp_i_i63_cast = sext i11 %tmp_i_i3_14 to i12
...
; <label>:11                                      ; preds = %9, %8, %7, %6
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str930, i32 %tmp_12)
  br label %.preheader
...
define internal fastcc void @imGrayScale([1440000 x i32]* %imINPUT, [1440000 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth) {
  %imWidth_read = call i32 @_ssdm_op_Read.ap_auto.i32(i32 %imWidth)
  %imHeight_read = call i32 @_ssdm_op_Read.ap_auto.i32(i32 %imHeight)
  call void (...)* @_ssdm_op_SpecResourceLimit(i32 1, [1 x i8]* @p_str21, [1 x i8]* @p_str21, [12 x i8]* @p_str122, [1 x i8]* @p_str21) nounwind
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_16 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str425)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, [1 x i8]* @p_str21) nounwind
  br label %3
...
._crit_edge:                                      ; preds = %3
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str526, i32 %tmp_19)
  br label %3

; <label>:4                                       ; preds = %3
  %empty_17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str425, i32 %tmp_16)
  br label %1
...
; <label>:0                                       ; preds = %1, %newFuncRoot
  ...
  %tmp_32 = sext i11 %row_img to i32
  %tmp_40_cast = sext i11 %row_img to i12
  %tmp_33 = icmp slt i32 %tmp_32, %tmp
  %row_img_1 = add i11 %row_img, 1
  br i1 %tmp_33, label %3, label %.exitStub

; <label>:1                                       ; preds = %2
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1132, i32 %tmp_20)
  br label %0

; <label>:2                                       ; preds = %._crit_edge, %3
  %col_img = phi i11 [ 0, %3 ], [ %col_img_1, %._crit_edge ]
  %tmp_34 = sext i11 %col_img to i32
  %tmp_42_cast = sext i11 %col_img to i12
  %tmp_35 = icmp slt i32 %tmp_34, %tmp_s
  %col_img_1 = add i11 %col_img, 1
  br i1 %tmp_35, label %6, label %1

; <label>:3                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1132) nounwind
  %tmp_20 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1132)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, [1 x i8]* @p_str21) nounwind
  br label %2

._crit_edge:                                      ; preds = %14, %4
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1233, i32 %tmp_21)
  br label %2

; <label>:4                                       ; preds = %5
  %minSAD_load = load i32* %minSAD
  %tmp_41 = icmp sgt i32 %minSAD_load, %minSAD_1
  %tmp_42 = icmp eq i32 %minSAD_load, 0
  %or_cond = or i1 %tmp_41, %tmp_42
...
; <label>:5                                       ; preds = %7, %6
  ...
  %next_mul = add i64 1200, %phi_mul
  %tmp_36 = sext i11 %row_tpl to i32
  %tmp_44_cast = sext i11 %row_tpl to i12
  %tmp_37 = icmp slt i32 %tmp_36, %tplHeight_read
  %row_tpl_1 = add i11 1, %row_tpl
  br i1 %tmp_37, label %9, label %4

; <label>:6                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1233) nounwind
  %tmp_21 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1233)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, [1 x i8]* @p_str21) nounwind
  br label %5

; <label>:7                                       ; preds = %13, %12, %11, %8
  %SAD_1_lcssa = phi i32 [ %SAD_1, %8 ], [ %SAD, %13 ], [ %SAD_s, %12 ], [ %SAD_2, %11 ]
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1334, i32 %tmp_22)
  br label %5

; <label>:8                                       ; preds = %10, %9
  %col_tpl = phi i11 [ 0, %9 ], [ %col_tpl_1_3, %10 ]
  %SAD_1 = phi i32 [ %minSAD_1, %9 ], [ %SAD_3, %10 ]
  %tmp_43 = sext i11 %col_tpl to i32
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 50, i64 25)
  %tmp_44 = icmp slt i32 %tmp_43, %tplWidth_read
  br i1 %tmp_44, label %13, label %7

; <label>:9                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1334) nounwind
  %tmp_22 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1334)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, [1 x i8]* @p_str21) nounwind
  %tmp_38 = add i12 %tmp_40_cast, %tmp_44_cast
  %tmp_39_cast = sext i12 %tmp_38 to i22
  %tmp_46 = mul i22 %tmp_39_cast, 1200
  br label %8

; <label>:10                                      ; preds = %11
  %tmp_97_3 = add i12 %tmp_42_cast, %tmp_95_3_cast
  %tmp_98_3_cast = sext i12 %tmp_97_3 to i22
  %tmp_54 = add i22 %tmp_46, %tmp_98_3_cast
  %tmp_63_cast = sext i22 %tmp_54 to i64
  %imINPUT_addr_3 = getelementptr [1440000 x i32]* %imINPUT, i64 0, i64 %tmp_63_cast
  %imINPUT_load_3 = load i32* %imINPUT_addr_3, align 4
  %tmp_75 = trunc i32 %imINPUT_load_3 to i8
  %tmp_100_3_cast = sext i8 %tmp_75 to i9
  %tmp_99_3_cast = sext i11 %col_tpl_1_2 to i22
  %tmp_55 = add i22 %tmp_68, %tmp_99_3_cast
  %tmp_64_cast = zext i22 %tmp_55 to i64
  %tplINPUT_addr_3 = getelementptr [1440000 x i32]* %tplINPUT, i64 0, i64 %tmp_64_cast
  %tplINPUT_load_3 = load i32* %tplINPUT_addr_3, align 4
  %tmp_76 = trunc i32 %tplINPUT_load_3 to i8
  %tmp_101_3_cast = sext i8 %tmp_76 to i9
...
; <label>:11                                      ; preds = %12
  ...
  %tmp_52 = add i22 %tmp_46, %tmp_98_2_cast
  %tmp_61_cast = sext i22 %tmp_52 to i64
  %imINPUT_addr_2 = getelementptr [1440000 x i32]* %imINPUT, i64 0, i64 %tmp_61_cast
  %imINPUT_load_2 = load i32* %imINPUT_addr_2, align 4
  %tmp_73 = trunc i32 %imINPUT_load_2 to i8
  %tmp_100_2_cast = sext i8 %tmp_73 to i9
  %tmp_99_2_cast = sext i11 %col_tpl_1_1 to i22
  %tmp_53 = add i22 %tmp_68, %tmp_99_2_cast
  %tmp_62_cast = zext i22 %tmp_53 to i64
  %tplINPUT_addr_2 = getelementptr [1440000 x i32]* %tplINPUT, i64 0, i64 %tmp_62_cast
  %tplINPUT_load_2 = load i32* %tplINPUT_addr_2, align 4
  %tmp_74 = trunc i32 %tplINPUT_load_2 to i8
  %tmp_101_2_cast = sext i8 %tmp_74 to i9
...
; <label>:12                                      ; preds = %13
  ...
  %tmp_50 = add i22 %tmp_46, %tmp_98_1_cast
  %tmp_59_cast = sext i22 %tmp_50 to i64
  %imINPUT_addr_1 = getelementptr [1440000 x i32]* %imINPUT, i64 0, i64 %tmp_59_cast
  %imINPUT_load_1 = load i32* %imINPUT_addr_1, align 4
  %tmp_71 = trunc i32 %imINPUT_load_1 to i8
  %tmp_100_1_cast = sext i8 %tmp_71 to i9
  %tmp_99_1_cast = sext i11 %col_tpl_1_s to i22
  %tmp_51 = add i22 %tmp_68, %tmp_99_1_cast
  %tmp_60_cast = zext i22 %tmp_51 to i64
  %tplINPUT_addr_1 = getelementptr [1440000 x i32]* %tplINPUT, i64 0, i64 %tmp_60_cast
  %tplINPUT_load_1 = load i32* %tplINPUT_addr_1, align 4
  %tmp_72 = trunc i32 %tplINPUT_load_1 to i8
  %tmp_101_1_cast = sext i8 %tmp_72 to i9
...
; <label>:13                                      ; preds = %8
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str1435) nounwind
  %tmp_95_cast = sext i11 %col_tpl to i12
  %tmp_45 = add i12 %tmp_42_cast, %tmp_95_cast
  %tmp_46_cast = sext i12 %tmp_45 to i22
  %tmp_47 = add i22 %tmp_46, %tmp_46_cast
  %tmp_57_cast = sext i22 %tmp_47 to i64
  %imINPUT_addr = getelementptr [1440000 x i32]* %imINPUT, i64 0, i64 %tmp_57_cast
  %imINPUT_load = load i32* %imINPUT_addr, align 4
  %tmp_69 = trunc i32 %imINPUT_load to i8
  %tmp_100_cast = sext i8 %tmp_69 to i9
  %tmp_47_cast = sext i11 %col_tpl to i22
  %tmp_49 = add i22 %tmp_68, %tmp_47_cast
  %tmp_58_cast = zext i22 %tmp_49 to i64
  %tplINPUT_addr = getelementptr [1440000 x i32]* %tplINPUT, i64 0, i64 %tmp_58_cast
  %tplINPUT_load = load i32* %tplINPUT_addr, align 4
  %tmp_70 = trunc i32 %tplINPUT_load to i8
  %tmp_101_cast = sext i8 %tmp_70 to i9
  %tmp_48 = sub i9 %tmp_100_cast, %tmp_101_cast
  %neg = sub i9 0, %tmp_48
  %abscond = icmp sgt i9 %tmp_48, 0
  %abs = select i1 %abscond, i9 %tmp_48, i9 %neg
...
entry:
  ...
  %empty_21 = trunc i112 %empty to i8
  ret i8 %empty_21
}
...
entry:
  ...
  %empty_23 = shl i64 1, %empty
  %empty_24 = and i64 %0, %empty_23
  %empty_25 = icmp ne i64 %empty_24, 0
  ret i1 %empty_25
}
...
entry:
  ...
  %empty_26 = shl i53 1, %empty
  %empty_27 = and i53 %0, %empty_26
  %empty_28 = icmp ne i53 %empty_27, 0
  ret i1 %empty_28
}
...
entry:
  ...
  %empty_35 = zext i8 %3 to i16
  %empty_36 = shl i16 %empty, 8
  %empty_37 = or i16 %empty_36, %empty_35
  %empty_38 = zext i8 %1 to i24
  %empty_39 = zext i16 %empty_37 to i24
  %empty_40 = shl i24 %empty_38, 16
  %empty_41 = or i24 %empty_40, %empty_39
  %empty_42 = zext i8 %0 to i32
  %empty_43 = zext i24 %empty_41 to i32
  %empty_44 = shl i32 %empty_42, 24
...
entry:
  ...
  %empty_46 = zext i24 %1 to i32
  %empty_47 = shl i32 %empty, 24
...
entry:
  ...
  %empty_52 = zext i8 %1 to i18
  %empty_53 = shl i18 %empty, 8
  %empty_54 = or i18 %empty_53, %empty_52
  ret i18 %empty_54
}
