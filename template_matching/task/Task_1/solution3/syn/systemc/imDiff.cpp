...
const sc_lv<11> imDiff::ap_const_lv11_0 = "00000000000";
...
imDiff::imDiff(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    imDiff_Loop_L66_proc_U0->output_struct_y(imDiff_Loop_L66_proc_U0_output_struct_y);
    imDiff_Loop_L66_proc_U0->output_struct_y_ap_vld(imDiff_Loop_L66_proc_U0_output_struct_y_ap_vld);
    imDiff_Loop_L66_proc_U0->output_struct_x(imDiff_Loop_L66_proc_U0_output_struct_x);
    imDiff_Loop_L66_proc_U0->output_struct_x_ap_vld(imDiff_Loop_L66_proc_U0_output_struct_x_ap_vld);
    imDiff_Loop_L66_proc_U0->output_struct_SAD(imDiff_Loop_L66_proc_U0_output_struct_SAD);
    imDiff_Loop_L66_proc_U0->output_struct_SAD_ap_vld(imDiff_Loop_L66_proc_U0_output_struct_SAD_ap_vld);
    ...
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_SAD );

    SC_METHOD(thread_output_struct_SAD_ap_vld);
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_SAD_ap_vld );

    SC_METHOD(thread_output_struct_x);
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_x );

    SC_METHOD(thread_output_struct_x_ap_vld);
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_x_ap_vld );

    SC_METHOD(thread_output_struct_y);
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_y );

    SC_METHOD(thread_output_struct_y_ap_vld);
    sensitive << ( imDiff_Loop_L66_proc_U0_output_struct_y_ap_vld );
    ...
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_y, "imDiff_Loop_L66_proc_U0_output_struct_y");
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_y_ap_vld, "imDiff_Loop_L66_proc_U0_output_struct_y_ap_vld");
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_x, "imDiff_Loop_L66_proc_U0_output_struct_x");
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_x_ap_vld, "imDiff_Loop_L66_proc_U0_output_struct_x_ap_vld");
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_SAD, "imDiff_Loop_L66_proc_U0_output_struct_SAD");
    sc_trace(mVcdFile, imDiff_Loop_L66_proc_U0_output_struct_SAD_ap_vld, "imDiff_Loop_L66_proc_U0_output_struct_SAD_ap_vld");
...
void imDiff::thread_output_struct_SAD() {
    output_struct_SAD = imDiff_Loop_L66_proc_U0_output_struct_SAD.read();
}

void imDiff::thread_output_struct_SAD_ap_vld() {
    output_struct_SAD_ap_vld = imDiff_Loop_L66_proc_U0_output_struct_SAD_ap_vld.read();
}

void imDiff::thread_output_struct_x() {
    output_struct_x = imDiff_Loop_L66_proc_U0_output_struct_x.read();
}

void imDiff::thread_output_struct_x_ap_vld() {
    output_struct_x_ap_vld = imDiff_Loop_L66_proc_U0_output_struct_x_ap_vld.read();
}

void imDiff::thread_output_struct_y() {
    output_struct_y = imDiff_Loop_L66_proc_U0_output_struct_y.read();
}

void imDiff::thread_output_struct_y_ap_vld() {
    output_struct_y_ap_vld = imDiff_Loop_L66_proc_U0_output_struct_y_ap_vld.read();
}
