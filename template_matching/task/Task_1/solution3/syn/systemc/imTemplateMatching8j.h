...
#ifndef __imTemplateMatching8j__HH__
#define __imTemplateMatching8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(imTemplateMatching8j) {
    ...
    SC_CTOR(imTemplateMatching8j):  simcore_am_0_U ("simcore_am_0_U") {
