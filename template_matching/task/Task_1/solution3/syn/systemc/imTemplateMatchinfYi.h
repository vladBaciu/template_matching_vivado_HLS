...
#ifndef __imTemplateMatchinfYi__HH__
#define __imTemplateMatchinfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(imTemplateMatchinfYi) {
    ...
    SC_CTOR(imTemplateMatchinfYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
