...
#ifndef __imTemplateMatchindEe__HH__
#define __imTemplateMatchindEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(imTemplateMatchindEe) {
    ...
    SC_CTOR(imTemplateMatchindEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
