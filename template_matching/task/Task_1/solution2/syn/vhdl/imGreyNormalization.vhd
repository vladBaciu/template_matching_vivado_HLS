...
architecture behav of imGreyNormalization is 
    ...
    signal tmp_6_fu_229_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_6_reg_602 : STD_LOGIC_VECTOR (21 downto 0);
    ...
    signal tmp_10_fu_348_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_10_reg_643 : STD_LOGIC_VECTOR (21 downto 0);
    ...
    signal min1_fu_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_5_cast_fu_215_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal min_2_fu_330_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_fu_82 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_6_cast_max_1_cas_fu_320_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal max_3_fu_211_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal row_cast_fu_239_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal col_cast_fu_261_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_11_fu_276_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_16_fu_280_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal max_4_fu_290_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal max_6_cast_fu_294_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_8_fu_302_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal max_6_cast_cast_fu_298_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_21_fu_308_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal max_6_cast_max_1_fu_312_p3 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_22_fu_388_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_20_fu_392_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_23_fu_402_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_11_cast_fu_406_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_24_fu_416_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_i_i_i_cast_fu_464_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal sh_assign_fu_468_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_i_i_14_fu_482_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sh_assign_2_i_i_cast_fu_500_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_61_i_i_cast_fu_508_p1 : STD_LOGIC_VECTOR (52 downto 0);
    signal tmp_i_i_fu_460_p1 : STD_LOGIC_VECTOR (135 downto 0);
    signal tmp_61_i_i_fu_504_p1 : STD_LOGIC_VECTOR (135 downto 0);
    signal tmp_62_i_i_fu_512_p2 : STD_LOGIC_VECTOR (52 downto 0);
    signal tmp_30_fu_524_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_63_i_i_fu_518_p2 : STD_LOGIC_VECTOR (135 downto 0);
    signal tmp_25_fu_532_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_26_fu_536_p4 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    imTemplateMatchindEe_x_U21 : component imTemplateMatchindEe
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    imTemplateMatchinfYi_U22 : component imTemplateMatchinfYi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 26,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state9))) then 
                                max_fu_82(30 downto 0) <= max_6_cast_max_1_cas_fu_320_p1(30 downto 0);
    ...
    min1_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state9))) then 
                min1_fu_78 <= min_2_fu_330_p3;
            elsif (((ap_const_lv1_1 = ap_CS_fsm_state4))) then 
                min1_fu_78 <= max_5_cast_fu_215_p1;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state15))) then
                ...
                tmp_10_reg_643 <= tmp_10_fu_348_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    max_3_fu_211_p1 <= imINPUT_q0(8 - 1 downto 0);
    max_4_fu_290_p1 <= imINPUT_q0(8 - 1 downto 0);
    max_5_cast_fu_215_p1 <= std_logic_vector(resize(unsigned(max_3_fu_211_p1),32));
    max_6_cast_cast_fu_298_p1 <= std_logic_vector(resize(unsigned(max_4_fu_290_p1),31));
    max_6_cast_fu_294_p1 <= std_logic_vector(resize(unsigned(max_4_fu_290_p1),32));
    max_6_cast_max_1_cas_fu_320_p1 <= std_logic_vector(resize(unsigned(max_6_cast_max_1_fu_312_p3),32));
    max_6_cast_max_1_fu_312_p3 <= 
        max_6_cast_cast_fu_298_p1 when (tmp_8_fu_302_p2(0) = '1') else 
        tmp_21_fu_308_p1;
    min_2_fu_330_p3 <= 
        max_6_cast_fu_294_p1 when (tmp_7_fu_324_p2(0) = '1') else 
        min1_fu_78;
    ...
    p_Val2_4_fu_546_p3 <= 
        tmp_25_fu_532_p1 when (isNeg_fu_474_p3(0) = '1') else 
        tmp_26_fu_536_p4;
    ...
    sh_assign_1_fu_492_p3 <= 
        ...
        sh_assign_fu_468_p2;
        sh_assign_2_i_i_cast_fu_500_p1 <= std_logic_vector(resize(signed(sh_assign_1_fu_492_p3),32));

    sh_assign_fu_468_p2 <= std_logic_vector(signed(ap_const_lv12_C01) + signed(tmp_i_i_i_cast_fu_464_p1));
    tmp_10_fu_348_p1 <= phi_mul2_reg_171(22 - 1 downto 0);
    tmp_11_cast_fu_406_p1 <= std_logic_vector(resize(unsigned(tmp_23_fu_402_p1),32));
    tmp_11_fu_276_p1 <= col_reg_149(22 - 1 downto 0);
    tmp_12_fu_410_p2 <= std_logic_vector(unsigned(tmp_11_cast_fu_406_p1) - unsigned(min1_fu_78));
    tmp_13_fu_421_p2 <= std_logic_vector(unsigned(tmp_24_fu_416_p2) - unsigned(tmp_12_reg_674));
    tmp_16_fu_280_p2 <= std_logic_vector(unsigned(tmp_11_fu_276_p1) + unsigned(tmp_6_reg_602));
    tmp_20_fu_392_p2 <= std_logic_vector(unsigned(tmp_22_fu_388_p1) + unsigned(tmp_10_reg_643));
    tmp_21_cast_fu_285_p1 <= std_logic_vector(resize(unsigned(tmp_16_fu_280_p2),64));
    tmp_21_fu_308_p1 <= max_fu_82(31 - 1 downto 0);
    tmp_22_fu_388_p1 <= col_1_reg_182(22 - 1 downto 0);
    tmp_23_cast_fu_397_p1 <= std_logic_vector(resize(unsigned(tmp_20_fu_392_p2),64));
    tmp_23_fu_402_p1 <= imINPUT_q0(8 - 1 downto 0);
    tmp_24_fu_416_p2 <= std_logic_vector(shift_left(unsigned(tmp_12_reg_674),to_integer(unsigned('0' & ap_const_lv32_8(31-1 downto 0)))));
    tmp_25_fu_532_p1 <= std_logic_vector(resize(unsigned(tmp_30_fu_524_p3),32));
    tmp_26_fu_536_p4 <= tmp_63_i_i_fu_518_p2(83 downto 52);
    tmp_2_fu_254_p2 <= std_logic_vector(unsigned(max_fu_82) - unsigned(min1_fu_78));
    tmp_30_fu_524_p3 <= tmp_62_i_i_fu_512_p2(52 downto 52);
    ...
    tmp_61_i_i_cast_fu_508_p1 <= std_logic_vector(resize(unsigned(sh_assign_2_i_i_cast_fu_500_p1),53));
    tmp_61_i_i_fu_504_p1 <= std_logic_vector(resize(unsigned(sh_assign_2_i_i_cast_fu_500_p1),136));
    tmp_62_i_i_fu_512_p2 <= std_logic_vector(shift_right(unsigned(p_Result_1_fu_452_p3),to_integer(unsigned('0' & tmp_61_i_i_cast_fu_508_p1(31-1 downto 0)))));
    tmp_63_i_i_fu_518_p2 <= std_logic_vector(shift_left(unsigned(tmp_i_i_fu_460_p1),to_integer(unsigned('0' & tmp_61_i_i_fu_504_p1(31-1 downto 0)))));
    tmp_6_fu_229_p1 <= phi_mul_reg_138(22 - 1 downto 0);
    tmp_7_fu_324_p2 <= "1" when (signed(max_6_cast_fu_294_p1) < signed(min1_fu_78)) else "0";
    tmp_8_fu_302_p2 <= "1" when (signed(max_6_cast_fu_294_p1) > signed(max_fu_82)) else "0";
    ...
    tmp_i_i_14_fu_482_p2 <= std_logic_vector(unsigned(ap_const_lv11_3FF) - unsigned(loc_V_fu_438_p4));
        tmp_i_i_cast_fu_488_p1 <= std_logic_vector(resize(signed(tmp_i_i_14_fu_482_p2),12));

    tmp_i_i_fu_460_p1 <= std_logic_vector(resize(unsigned(p_Result_1_fu_452_p3),136));
    tmp_i_i_i_cast_fu_464_p1 <= std_logic_vector(resize(unsigned(loc_V_fu_438_p4),12));
end behav;
