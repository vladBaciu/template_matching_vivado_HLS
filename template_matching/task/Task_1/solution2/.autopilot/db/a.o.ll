; ModuleID = '/home/student/workspace_HLS/template_matching/task/Task_1/solution2/.autopilot/db/a.o.bc'
...
@.str21 = private unnamed_addr constant [6 x i8] c"BLOCK\00", align 1 ; [#uses=1 type=[6 x i8]*]
@.str122 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=1 type=[1 x i8]*]
@.str223 = private unnamed_addr constant [4 x i8] c"L00\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str324 = private unnamed_addr constant [4 x i8] c"L11\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str425 = private unnamed_addr constant [4 x i8] c"L22\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str526 = private unnamed_addr constant [4 x i8] c"L33\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str627 = private unnamed_addr constant [4 x i8] c"L44\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str728 = private unnamed_addr constant [4 x i8] c"L55\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str829 = private unnamed_addr constant [4 x i8] c"L66\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str930 = private unnamed_addr constant [4 x i8] c"L77\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str1031 = private unnamed_addr constant [4 x i8] c"L88\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str1132 = private unnamed_addr constant [4 x i8] c"L99\00", align 1 ; [#uses=1 type=[4 x i8]*]
@.str1233 = private unnamed_addr constant [5 x i8] c"L110\00", align 1 ; [#uses=1 type=[5 x i8]*]
@.str1334 = private unnamed_addr constant [5 x i8] c"L111\00", align 1 ; [#uses=1 type=[5 x i8]*]
...
define void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, i32 %imVersion) nounwind uwtable {
  ...
  %8 = load [1200 x i32]** %1, align 8, !dbg !666 ; [#uses=1 type=[1200 x i32]*] [debug line = 38:1]
  call void (...)* @_ssdm_SpecArrayPartition([1200 x i32]* %8, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str21, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !666 ; [debug line = 38:1]
  %9 = load [1200 x i32]** %2, align 8, !dbg !667 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:1]
  call void (...)* @_ssdm_SpecArrayPartition([1200 x i32]* %9, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str21, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !667 ; [debug line = 39:1]
  call void @llvm.dbg.declare(metadata !{i11* %row}, metadata !668), !dbg !669 ; [debug line = 48:8] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i11* %col}, metadata !670), !dbg !671 ; [debug line = 49:8] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i8* %gray_pixel}, metadata !672), !dbg !673 ; [debug line = 50:16] [debug variable = gray_pixel]
  br label %10, !dbg !674                         ; [debug line = 50:26]

; <label>:10                                      ; preds = %0
  store i11 0, i11* %row, align 2, !dbg !675      ; [debug line = 53:12]
  br label %11, !dbg !675                         ; [debug line = 53:12]

; <label>:11                                      ; preds = %169, %10
  %12 = load i11* %row, align 2, !dbg !675        ; [#uses=1 type=i11] [debug line = 53:12]
  %13 = sext i11 %12 to i32, !dbg !675            ; [#uses=1 type=i32] [debug line = 53:12]
  %14 = load i32* %3, align 4, !dbg !675          ; [#uses=1 type=i32] [debug line = 53:12]
  %15 = icmp slt i32 %13, %14, !dbg !675          ; [#uses=1 type=i1] [debug line = 53:12]
  br i1 %15, label %16, label %172, !dbg !675     ; [debug line = 53:12]

; <label>:16                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !677 ; [debug line = 53:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !677 ; [debug line = 53:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !679 ; [debug line = 54:1]
  br label %17, !dbg !679                         ; [debug line = 54:1]

; <label>:17                                      ; preds = %16
  store i11 0, i11* %col, align 2, !dbg !680      ; [debug line = 55:12]
  br label %18, !dbg !680                         ; [debug line = 55:12]

; <label>:18                                      ; preds = %165, %17
  %19 = load i11* %col, align 2, !dbg !680        ; [#uses=1 type=i11] [debug line = 55:12]
  %20 = sext i11 %19 to i32, !dbg !680            ; [#uses=1 type=i32] [debug line = 55:12]
  %21 = load i32* %4, align 4, !dbg !680          ; [#uses=1 type=i32] [debug line = 55:12]
  %22 = icmp slt i32 %20, %21, !dbg !680          ; [#uses=1 type=i1] [debug line = 55:12]
  br i1 %22, label %23, label %168, !dbg !680     ; [debug line = 55:12]

; <label>:23                                      ; preds = %18
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !682 ; [debug line = 55:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !682 ; [debug line = 55:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !684 ; [debug line = 56:1]
  %24 = load i32* %5, align 4, !dbg !685          ; [#uses=1 type=i32] [debug line = 58:2]
  switch i32 %24, label %142 [
    i32 0, label %25
    i32 1, label %64
    i32 2, label %103
  ], !dbg !685                                    ; [debug line = 58:2]

; <label>:25                                      ; preds = %23
  %26 = load i11* %col, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %27 = sext i11 %26 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %28 = load i11* %row, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %29 = sext i11 %28 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %30 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %31 = getelementptr inbounds [1200 x i32]* %30, i64 %29, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %32 = getelementptr inbounds [1200 x i32]* %31, i32 0, i64 %27, !dbg !686 ; [#uses=1 type=i32*] [debug line = 60:5]
  %33 = load i32* %32, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 60:5]
  %34 = and i32 %33, 255, !dbg !686               ; [#uses=1 type=i32] [debug line = 60:5]
  %35 = sitofp i32 %34 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 60:5]
  %36 = fmul double 1.140000e-01, %35, !dbg !686  ; [#uses=1 type=double] [debug line = 60:5]
  %37 = load i11* %col, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %38 = sext i11 %37 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %39 = load i11* %row, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %40 = sext i11 %39 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %41 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %42 = getelementptr inbounds [1200 x i32]* %41, i64 %40, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %43 = getelementptr inbounds [1200 x i32]* %42, i32 0, i64 %38, !dbg !686 ; [#uses=1 type=i32*] [debug line = 60:5]
  %44 = load i32* %43, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 60:5]
  %45 = and i32 %44, 65280, !dbg !686             ; [#uses=1 type=i32] [debug line = 60:5]
  %46 = ashr i32 %45, 8, !dbg !686                ; [#uses=1 type=i32] [debug line = 60:5]
  %47 = sitofp i32 %46 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 60:5]
  %48 = fmul double 2.990000e-01, %47, !dbg !686  ; [#uses=1 type=double] [debug line = 60:5]
  %49 = fadd double %36, %48, !dbg !686           ; [#uses=1 type=double] [debug line = 60:5]
  %50 = load i11* %col, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %51 = sext i11 %50 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %52 = load i11* %row, align 2, !dbg !686        ; [#uses=1 type=i11] [debug line = 60:5]
  %53 = sext i11 %52 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 60:5]
  %54 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %55 = getelementptr inbounds [1200 x i32]* %54, i64 %53, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 60:5]
  %56 = getelementptr inbounds [1200 x i32]* %55, i32 0, i64 %51, !dbg !686 ; [#uses=1 type=i32*] [debug line = 60:5]
  %57 = load i32* %56, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 60:5]
  %58 = and i32 %57, 16711680, !dbg !686          ; [#uses=1 type=i32] [debug line = 60:5]
  %59 = ashr i32 %58, 16, !dbg !686               ; [#uses=1 type=i32] [debug line = 60:5]
  %60 = sitofp i32 %59 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 60:5]
  %61 = fmul double 5.870000e-01, %60, !dbg !686  ; [#uses=1 type=double] [debug line = 60:5]
  %62 = fadd double %49, %61, !dbg !686           ; [#uses=1 type=double] [debug line = 60:5]
  %63 = fptoui double %62 to i8, !dbg !686        ; [#uses=1 type=i8] [debug line = 60:5]
  store i8 %63, i8* %gray_pixel, align 1, !dbg !686 ; [debug line = 60:5]
  br label %143, !dbg !688                        ; [debug line = 61:5]

; <label>:64                                      ; preds = %23
  %65 = load i11* %col, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %66 = sext i11 %65 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %67 = load i11* %row, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %68 = sext i11 %67 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %69 = load [1200 x i32]** %1, align 8, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %70 = getelementptr inbounds [1200 x i32]* %69, i64 %68, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %71 = getelementptr inbounds [1200 x i32]* %70, i32 0, i64 %66, !dbg !689 ; [#uses=1 type=i32*] [debug line = 63:5]
  %72 = load i32* %71, align 4, !dbg !689         ; [#uses=1 type=i32] [debug line = 63:5]
  %73 = and i32 %72, 255, !dbg !689               ; [#uses=1 type=i32] [debug line = 63:5]
  %74 = sitofp i32 %73 to double, !dbg !689       ; [#uses=1 type=double] [debug line = 63:5]
  %75 = fmul double 7.720000e-02, %74, !dbg !689  ; [#uses=1 type=double] [debug line = 63:5]
  %76 = load i11* %col, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %77 = sext i11 %76 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %78 = load i11* %row, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %79 = sext i11 %78 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %80 = load [1200 x i32]** %1, align 8, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %81 = getelementptr inbounds [1200 x i32]* %80, i64 %79, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %82 = getelementptr inbounds [1200 x i32]* %81, i32 0, i64 %77, !dbg !689 ; [#uses=1 type=i32*] [debug line = 63:5]
  %83 = load i32* %82, align 4, !dbg !689         ; [#uses=1 type=i32] [debug line = 63:5]
  %84 = and i32 %83, 65280, !dbg !689             ; [#uses=1 type=i32] [debug line = 63:5]
  %85 = ashr i32 %84, 8, !dbg !689                ; [#uses=1 type=i32] [debug line = 63:5]
  %86 = sitofp i32 %85 to double, !dbg !689       ; [#uses=1 type=double] [debug line = 63:5]
  %87 = fmul double 2.120000e-01, %86, !dbg !689  ; [#uses=1 type=double] [debug line = 63:5]
  %88 = fadd double %75, %87, !dbg !689           ; [#uses=1 type=double] [debug line = 63:5]
  %89 = load i11* %col, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %90 = sext i11 %89 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %91 = load i11* %row, align 2, !dbg !689        ; [#uses=1 type=i11] [debug line = 63:5]
  %92 = sext i11 %91 to i64, !dbg !689            ; [#uses=1 type=i64] [debug line = 63:5]
  %93 = load [1200 x i32]** %1, align 8, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %94 = getelementptr inbounds [1200 x i32]* %93, i64 %92, !dbg !689 ; [#uses=1 type=[1200 x i32]*] [debug line = 63:5]
  %95 = getelementptr inbounds [1200 x i32]* %94, i32 0, i64 %90, !dbg !689 ; [#uses=1 type=i32*] [debug line = 63:5]
  %96 = load i32* %95, align 4, !dbg !689         ; [#uses=1 type=i32] [debug line = 63:5]
  %97 = and i32 %96, 16711680, !dbg !689          ; [#uses=1 type=i32] [debug line = 63:5]
  %98 = ashr i32 %97, 16, !dbg !689               ; [#uses=1 type=i32] [debug line = 63:5]
  %99 = sitofp i32 %98 to double, !dbg !689       ; [#uses=1 type=double] [debug line = 63:5]
  %100 = fmul double 7.150000e-01, %99, !dbg !689 ; [#uses=1 type=double] [debug line = 63:5]
  %101 = fadd double %88, %100, !dbg !689         ; [#uses=1 type=double] [debug line = 63:5]
  %102 = fptoui double %101 to i8, !dbg !689      ; [#uses=1 type=i8] [debug line = 63:5]
  store i8 %102, i8* %gray_pixel, align 1, !dbg !689 ; [debug line = 63:5]
  br label %143, !dbg !690                        ; [debug line = 64:5]

; <label>:103                                     ; preds = %23
  %104 = load i11* %col, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %105 = sext i11 %104 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %106 = load i11* %row, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %107 = sext i11 %106 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %108 = load [1200 x i32]** %1, align 8, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %109 = getelementptr inbounds [1200 x i32]* %108, i64 %107, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %110 = getelementptr inbounds [1200 x i32]* %109, i32 0, i64 %105, !dbg !691 ; [#uses=1 type=i32*] [debug line = 66:5]
  %111 = load i32* %110, align 4, !dbg !691       ; [#uses=1 type=i32] [debug line = 66:5]
  %112 = and i32 %111, 255, !dbg !691             ; [#uses=1 type=i32] [debug line = 66:5]
  %113 = sitofp i32 %112 to double, !dbg !691     ; [#uses=1 type=double] [debug line = 66:5]
  %114 = fmul double 5.900000e-02, %113, !dbg !691 ; [#uses=1 type=double] [debug line = 66:5]
  %115 = load i11* %col, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %116 = sext i11 %115 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %117 = load i11* %row, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %118 = sext i11 %117 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %119 = load [1200 x i32]** %1, align 8, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %120 = getelementptr inbounds [1200 x i32]* %119, i64 %118, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %121 = getelementptr inbounds [1200 x i32]* %120, i32 0, i64 %116, !dbg !691 ; [#uses=1 type=i32*] [debug line = 66:5]
  %122 = load i32* %121, align 4, !dbg !691       ; [#uses=1 type=i32] [debug line = 66:5]
  %123 = and i32 %122, 65280, !dbg !691           ; [#uses=1 type=i32] [debug line = 66:5]
  %124 = ashr i32 %123, 8, !dbg !691              ; [#uses=1 type=i32] [debug line = 66:5]
  %125 = sitofp i32 %124 to double, !dbg !691     ; [#uses=1 type=double] [debug line = 66:5]
  %126 = fmul double 2.620000e-01, %125, !dbg !691 ; [#uses=1 type=double] [debug line = 66:5]
  %127 = fadd double %114, %126, !dbg !691        ; [#uses=1 type=double] [debug line = 66:5]
  %128 = load i11* %col, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %129 = sext i11 %128 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %130 = load i11* %row, align 2, !dbg !691       ; [#uses=1 type=i11] [debug line = 66:5]
  %131 = sext i11 %130 to i64, !dbg !691          ; [#uses=1 type=i64] [debug line = 66:5]
  %132 = load [1200 x i32]** %1, align 8, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %133 = getelementptr inbounds [1200 x i32]* %132, i64 %131, !dbg !691 ; [#uses=1 type=[1200 x i32]*] [debug line = 66:5]
  %134 = getelementptr inbounds [1200 x i32]* %133, i32 0, i64 %129, !dbg !691 ; [#uses=1 type=i32*] [debug line = 66:5]
  %135 = load i32* %134, align 4, !dbg !691       ; [#uses=1 type=i32] [debug line = 66:5]
  %136 = and i32 %135, 16711680, !dbg !691        ; [#uses=1 type=i32] [debug line = 66:5]
  %137 = ashr i32 %136, 16, !dbg !691             ; [#uses=1 type=i32] [debug line = 66:5]
  %138 = sitofp i32 %137 to double, !dbg !691     ; [#uses=1 type=double] [debug line = 66:5]
  %139 = fmul double 6.780000e-01, %138, !dbg !691 ; [#uses=1 type=double] [debug line = 66:5]
  %140 = fadd double %127, %139, !dbg !691        ; [#uses=1 type=double] [debug line = 66:5]
  %141 = fptoui double %140 to i8, !dbg !691      ; [#uses=1 type=i8] [debug line = 66:5]
  store i8 %141, i8* %gray_pixel, align 1, !dbg !691 ; [debug line = 66:5]
  br label %143, !dbg !692                        ; [debug line = 67:5]

; <label>:142                                     ; preds = %23
  store i8 0, i8* %gray_pixel, align 1, !dbg !693 ; [debug line = 69:5]
  br label %143, !dbg !694                        ; [debug line = 70:4]

; <label>:143                                     ; preds = %142, %103, %64, %25
  %144 = load i8* %gray_pixel, align 1, !dbg !695 ; [#uses=1 type=i8] [debug line = 72:4]
  %145 = zext i8 %144 to i32, !dbg !695           ; [#uses=1 type=i32] [debug line = 72:4]
  %146 = shl i32 %145, 24, !dbg !695              ; [#uses=1 type=i32] [debug line = 72:4]
  %147 = load i8* %gray_pixel, align 1, !dbg !695 ; [#uses=1 type=i8] [debug line = 72:4]
  %148 = zext i8 %147 to i32, !dbg !695           ; [#uses=1 type=i32] [debug line = 72:4]
  %149 = shl i32 %148, 16, !dbg !695              ; [#uses=1 type=i32] [debug line = 72:4]
  %150 = add nsw i32 %146, %149, !dbg !695        ; [#uses=1 type=i32] [debug line = 72:4]
  %151 = load i8* %gray_pixel, align 1, !dbg !695 ; [#uses=1 type=i8] [debug line = 72:4]
  %152 = zext i8 %151 to i32, !dbg !695           ; [#uses=1 type=i32] [debug line = 72:4]
  %153 = shl i32 %152, 8, !dbg !695               ; [#uses=1 type=i32] [debug line = 72:4]
  %154 = add nsw i32 %150, %153, !dbg !695        ; [#uses=1 type=i32] [debug line = 72:4]
  %155 = load i8* %gray_pixel, align 1, !dbg !695 ; [#uses=1 type=i8] [debug line = 72:4]
  %156 = zext i8 %155 to i32, !dbg !695           ; [#uses=1 type=i32] [debug line = 72:4]
  %157 = add nsw i32 %154, %156, !dbg !695        ; [#uses=1 type=i32] [debug line = 72:4]
  %158 = load i11* %col, align 2, !dbg !695       ; [#uses=1 type=i11] [debug line = 72:4]
  %159 = sext i11 %158 to i64, !dbg !695          ; [#uses=1 type=i64] [debug line = 72:4]
  %160 = load i11* %row, align 2, !dbg !695       ; [#uses=1 type=i11] [debug line = 72:4]
  %161 = sext i11 %160 to i64, !dbg !695          ; [#uses=1 type=i64] [debug line = 72:4]
  %162 = load [1200 x i32]** %2, align 8, !dbg !695 ; [#uses=1 type=[1200 x i32]*] [debug line = 72:4]
  %163 = getelementptr inbounds [1200 x i32]* %162, i64 %161, !dbg !695 ; [#uses=1 type=[1200 x i32]*] [debug line = 72:4]
  %164 = getelementptr inbounds [1200 x i32]* %163, i32 0, i64 %159, !dbg !695 ; [#uses=1 type=i32*] [debug line = 72:4]
  store i32 %157, i32* %164, align 4, !dbg !695   ; [debug line = 72:4]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !696 ; [debug line = 75:3]
  br label %165, !dbg !696                        ; [debug line = 75:3]

; <label>:165                                     ; preds = %143
  %166 = load i11* %col, align 2, !dbg !697       ; [#uses=1 type=i11] [debug line = 55:36]
  %167 = add i11 %166, 1, !dbg !697               ; [#uses=1 type=i11] [debug line = 55:36]
  store i11 %167, i11* %col, align 2, !dbg !697   ; [debug line = 55:36]
  br label %18, !dbg !697                         ; [debug line = 55:36]

; <label>:168                                     ; preds = %18
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !698 ; [debug line = 76:2]
  br label %169, !dbg !698                        ; [debug line = 76:2]

; <label>:169                                     ; preds = %168
  %170 = load i11* %row, align 2, !dbg !699       ; [#uses=1 type=i11] [debug line = 53:37]
  %171 = add i11 %170, 1, !dbg !699               ; [#uses=1 type=i11] [debug line = 53:37]
  store i11 %171, i11* %row, align 2, !dbg !699   ; [debug line = 53:37]
  br label %11, !dbg !699                         ; [debug line = 53:37]

; <label>:172                                     ; preds = %11
  ret void, !dbg !700                             ; [debug line = 78:1]
}
...
define void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, i32 %newMax, i32 %newMin) nounwind uwtable {
  ...
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !701), !dbg !702 ; [debug line = 82:30] [debug variable = imINPUT]
  store [1200 x i32]* %imOUTPUT, [1200 x i32]** %2, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %2}, metadata !703), !dbg !704 ; [debug line = 83:7] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !705), !dbg !706 ; [debug line = 83:33] [debug variable = imHeight]
  store i32 %imWidth, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !707), !dbg !708 ; [debug line = 83:47] [debug variable = imWidth]
  store i32 %newMax, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !709), !dbg !710 ; [debug line = 84:7] [debug variable = newMax]
  store i32 %newMin, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !711), !dbg !712 ; [debug line = 84:19] [debug variable = newMin]
  %7 = load [1200 x i32]** %1, align 8, !dbg !713 ; [#uses=1 type=[1200 x i32]*] [debug line = 84:28]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %7, i32 1200) nounwind, !dbg !713 ; [debug line = 84:28]
  %8 = load [1200 x i32]** %2, align 8, !dbg !715 ; [#uses=1 type=[1200 x i32]*] [debug line = 84:65]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !715 ; [debug line = 84:65]
  call void @llvm.dbg.declare(metadata !{i11* %row}, metadata !716), !dbg !717 ; [debug line = 94:8] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i11* %col}, metadata !718), !dbg !719 ; [debug line = 95:8] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i8* %max}, metadata !720), !dbg !723 ; [debug line = 96:7] [debug variable = max]
  %9 = load [1200 x i32]** %1, align 8, !dbg !724 ; [#uses=1 type=[1200 x i32]*] [debug line = 96:37]
  %10 = getelementptr inbounds [1200 x i32]* %9, i64 0, !dbg !724 ; [#uses=1 type=[1200 x i32]*] [debug line = 96:37]
  %11 = getelementptr inbounds [1200 x i32]* %10, i32 0, i64 0, !dbg !724 ; [#uses=1 type=i32*] [debug line = 96:37]
  %12 = load i32* %11, align 4, !dbg !724         ; [#uses=1 type=i32] [debug line = 96:37]
  %13 = and i32 %12, 255, !dbg !724               ; [#uses=1 type=i32] [debug line = 96:37]
  %14 = trunc i32 %13 to i8, !dbg !724            ; [#uses=1 type=i8] [debug line = 96:37]
  store i8 %14, i8* %max, align 1, !dbg !724      ; [debug line = 96:37]
  call void @llvm.dbg.declare(metadata !{i8* %min}, metadata !725), !dbg !726 ; [debug line = 97:7] [debug variable = min]
  %15 = load i8* %max, align 1, !dbg !727         ; [#uses=1 type=i8] [debug line = 97:16]
  store i8 %15, i8* %min, align 1, !dbg !727      ; [debug line = 97:16]
  call void @llvm.dbg.declare(metadata !{i8* %newValue}, metadata !728), !dbg !729 ; [debug line = 98:7] [debug variable = newValue]
  br label %16, !dbg !730                         ; [debug line = 98:15]

; <label>:16                                      ; preds = %0
  store i11 0, i11* %row, align 2, !dbg !731      ; [debug line = 100:12]
  br label %17, !dbg !731                         ; [debug line = 100:12]

; <label>:17                                      ; preds = %82, %16
  %18 = load i11* %row, align 2, !dbg !731        ; [#uses=1 type=i11] [debug line = 100:12]
  %19 = sext i11 %18 to i32, !dbg !731            ; [#uses=1 type=i32] [debug line = 100:12]
  %20 = load i32* %3, align 4, !dbg !731          ; [#uses=1 type=i32] [debug line = 100:12]
  %21 = icmp slt i32 %19, %20, !dbg !731          ; [#uses=1 type=i1] [debug line = 100:12]
  br i1 %21, label %22, label %85, !dbg !731      ; [debug line = 100:12]

; <label>:22                                      ; preds = %17
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !733 ; [debug line = 100:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !733 ; [debug line = 100:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !735 ; [debug line = 101:1]
  br label %23, !dbg !735                         ; [debug line = 101:1]

; <label>:23                                      ; preds = %22
  store i11 0, i11* %col, align 2, !dbg !736      ; [debug line = 102:12]
  br label %24, !dbg !736                         ; [debug line = 102:12]

; <label>:24                                      ; preds = %78, %23
  %25 = load i11* %col, align 2, !dbg !736        ; [#uses=1 type=i11] [debug line = 102:12]
  %26 = sext i11 %25 to i32, !dbg !736            ; [#uses=1 type=i32] [debug line = 102:12]
  %27 = load i32* %4, align 4, !dbg !736          ; [#uses=1 type=i32] [debug line = 102:12]
  %28 = icmp slt i32 %26, %27, !dbg !736          ; [#uses=1 type=i1] [debug line = 102:12]
  br i1 %28, label %29, label %81, !dbg !736      ; [debug line = 102:12]

; <label>:29                                      ; preds = %24
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !738 ; [debug line = 102:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !738 ; [debug line = 102:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !740 ; [debug line = 103:1]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 4, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !741 ; [debug line = 106:1]
  %30 = load i11* %col, align 2, !dbg !742        ; [#uses=1 type=i11] [debug line = 113:2]
  %31 = sext i11 %30 to i64, !dbg !742            ; [#uses=1 type=i64] [debug line = 113:2]
  %32 = load i11* %row, align 2, !dbg !742        ; [#uses=1 type=i11] [debug line = 113:2]
  %33 = sext i11 %32 to i64, !dbg !742            ; [#uses=1 type=i64] [debug line = 113:2]
  %34 = load [1200 x i32]** %1, align 8, !dbg !742 ; [#uses=1 type=[1200 x i32]*] [debug line = 113:2]
  %35 = getelementptr inbounds [1200 x i32]* %34, i64 %33, !dbg !742 ; [#uses=1 type=[1200 x i32]*] [debug line = 113:2]
  %36 = getelementptr inbounds [1200 x i32]* %35, i32 0, i64 %31, !dbg !742 ; [#uses=1 type=i32*] [debug line = 113:2]
  %37 = load i32* %36, align 4, !dbg !742         ; [#uses=1 type=i32] [debug line = 113:2]
  %38 = and i32 %37, 255, !dbg !742               ; [#uses=1 type=i32] [debug line = 113:2]
  %39 = load i8* %max, align 1, !dbg !742         ; [#uses=1 type=i8] [debug line = 113:2]
  %40 = sext i8 %39 to i32, !dbg !742             ; [#uses=1 type=i32] [debug line = 113:2]
  %41 = icmp sgt i32 %38, %40, !dbg !742          ; [#uses=1 type=i1] [debug line = 113:2]
  br i1 %41, label %42, label %53, !dbg !742      ; [debug line = 113:2]

; <label>:42                                      ; preds = %29
  %43 = load i11* %col, align 2, !dbg !743        ; [#uses=1 type=i11] [debug line = 114:5]
  %44 = sext i11 %43 to i64, !dbg !743            ; [#uses=1 type=i64] [debug line = 114:5]
  %45 = load i11* %row, align 2, !dbg !743        ; [#uses=1 type=i11] [debug line = 114:5]
  %46 = sext i11 %45 to i64, !dbg !743            ; [#uses=1 type=i64] [debug line = 114:5]
  %47 = load [1200 x i32]** %1, align 8, !dbg !743 ; [#uses=1 type=[1200 x i32]*] [debug line = 114:5]
  %48 = getelementptr inbounds [1200 x i32]* %47, i64 %46, !dbg !743 ; [#uses=1 type=[1200 x i32]*] [debug line = 114:5]
  %49 = getelementptr inbounds [1200 x i32]* %48, i32 0, i64 %44, !dbg !743 ; [#uses=1 type=i32*] [debug line = 114:5]
  %50 = load i32* %49, align 4, !dbg !743         ; [#uses=1 type=i32] [debug line = 114:5]
  %51 = and i32 %50, 255, !dbg !743               ; [#uses=1 type=i32] [debug line = 114:5]
  %52 = trunc i32 %51 to i8, !dbg !743            ; [#uses=1 type=i8] [debug line = 114:5]
  store i8 %52, i8* %max, align 1, !dbg !743      ; [debug line = 114:5]
  br label %53, !dbg !745                         ; [debug line = 115:4]

; <label>:53                                      ; preds = %42, %29
  %54 = load i11* %col, align 2, !dbg !746        ; [#uses=1 type=i11] [debug line = 116:4]
  %55 = sext i11 %54 to i64, !dbg !746            ; [#uses=1 type=i64] [debug line = 116:4]
  %56 = load i11* %row, align 2, !dbg !746        ; [#uses=1 type=i11] [debug line = 116:4]
  %57 = sext i11 %56 to i64, !dbg !746            ; [#uses=1 type=i64] [debug line = 116:4]
  %58 = load [1200 x i32]** %1, align 8, !dbg !746 ; [#uses=1 type=[1200 x i32]*] [debug line = 116:4]
  %59 = getelementptr inbounds [1200 x i32]* %58, i64 %57, !dbg !746 ; [#uses=1 type=[1200 x i32]*] [debug line = 116:4]
  %60 = getelementptr inbounds [1200 x i32]* %59, i32 0, i64 %55, !dbg !746 ; [#uses=1 type=i32*] [debug line = 116:4]
  %61 = load i32* %60, align 4, !dbg !746         ; [#uses=1 type=i32] [debug line = 116:4]
  %62 = and i32 %61, 255, !dbg !746               ; [#uses=1 type=i32] [debug line = 116:4]
  %63 = load i8* %min, align 1, !dbg !746         ; [#uses=1 type=i8] [debug line = 116:4]
  %64 = sext i8 %63 to i32, !dbg !746             ; [#uses=1 type=i32] [debug line = 116:4]
  %65 = icmp slt i32 %62, %64, !dbg !746          ; [#uses=1 type=i1] [debug line = 116:4]
  br i1 %65, label %66, label %77, !dbg !746      ; [debug line = 116:4]

; <label>:66                                      ; preds = %53
  %67 = load i11* %col, align 2, !dbg !747        ; [#uses=1 type=i11] [debug line = 117:5]
  %68 = sext i11 %67 to i64, !dbg !747            ; [#uses=1 type=i64] [debug line = 117:5]
  %69 = load i11* %row, align 2, !dbg !747        ; [#uses=1 type=i11] [debug line = 117:5]
  %70 = sext i11 %69 to i64, !dbg !747            ; [#uses=1 type=i64] [debug line = 117:5]
  %71 = load [1200 x i32]** %1, align 8, !dbg !747 ; [#uses=1 type=[1200 x i32]*] [debug line = 117:5]
  %72 = getelementptr inbounds [1200 x i32]* %71, i64 %70, !dbg !747 ; [#uses=1 type=[1200 x i32]*] [debug line = 117:5]
  %73 = getelementptr inbounds [1200 x i32]* %72, i32 0, i64 %68, !dbg !747 ; [#uses=1 type=i32*] [debug line = 117:5]
  %74 = load i32* %73, align 4, !dbg !747         ; [#uses=1 type=i32] [debug line = 117:5]
  %75 = and i32 %74, 255, !dbg !747               ; [#uses=1 type=i32] [debug line = 117:5]
  %76 = trunc i32 %75 to i8, !dbg !747            ; [#uses=1 type=i8] [debug line = 117:5]
  store i8 %76, i8* %min, align 1, !dbg !747      ; [debug line = 117:5]
  br label %77, !dbg !749                         ; [debug line = 118:4]

; <label>:77                                      ; preds = %66, %53
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !750 ; [debug line = 119:3]
  br label %78, !dbg !750                         ; [debug line = 119:3]

; <label>:78                                      ; preds = %77
  %79 = load i11* %col, align 2, !dbg !751        ; [#uses=1 type=i11] [debug line = 102:36]
  %80 = add i11 %79, 1, !dbg !751                 ; [#uses=1 type=i11] [debug line = 102:36]
  store i11 %80, i11* %col, align 2, !dbg !751    ; [debug line = 102:36]
  br label %24, !dbg !751                         ; [debug line = 102:36]

; <label>:81                                      ; preds = %24
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !752 ; [debug line = 121:2]
  br label %82, !dbg !752                         ; [debug line = 121:2]

; <label>:82                                      ; preds = %81
  %83 = load i11* %row, align 2, !dbg !753        ; [#uses=1 type=i11] [debug line = 100:37]
  %84 = add i11 %83, 1, !dbg !753                 ; [#uses=1 type=i11] [debug line = 100:37]
  store i11 %84, i11* %row, align 2, !dbg !753    ; [debug line = 100:37]
  br label %17, !dbg !753                         ; [debug line = 100:37]

; <label>:85                                      ; preds = %17
  br label %86, !dbg !754                         ; [debug line = 121:2]

; <label>:86                                      ; preds = %85
  store i11 0, i11* %row, align 2, !dbg !755      ; [debug line = 123:12]
  br label %87, !dbg !755                         ; [debug line = 123:12]

; <label>:87                                      ; preds = %153, %86
  %88 = load i11* %row, align 2, !dbg !755        ; [#uses=1 type=i11] [debug line = 123:12]
  %89 = sext i11 %88 to i32, !dbg !755            ; [#uses=1 type=i32] [debug line = 123:12]
  %90 = load i32* %3, align 4, !dbg !755          ; [#uses=1 type=i32] [debug line = 123:12]
  %91 = icmp slt i32 %89, %90, !dbg !755          ; [#uses=1 type=i1] [debug line = 123:12]
  br i1 %91, label %92, label %156, !dbg !755     ; [debug line = 123:12]

; <label>:92                                      ; preds = %87
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !757 ; [debug line = 123:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !757 ; [debug line = 123:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !759 ; [debug line = 124:1]
  br label %93, !dbg !759                         ; [debug line = 124:1]

; <label>:93                                      ; preds = %92
  store i11 0, i11* %col, align 2, !dbg !760      ; [debug line = 125:12]
  br label %94, !dbg !760                         ; [debug line = 125:12]

; <label>:94                                      ; preds = %149, %93
  %95 = load i11* %col, align 2, !dbg !760        ; [#uses=1 type=i11] [debug line = 125:12]
  %96 = sext i11 %95 to i32, !dbg !760            ; [#uses=1 type=i32] [debug line = 125:12]
  %97 = load i32* %4, align 4, !dbg !760          ; [#uses=1 type=i32] [debug line = 125:12]
  %98 = icmp slt i32 %96, %97, !dbg !760          ; [#uses=1 type=i1] [debug line = 125:12]
  br i1 %98, label %99, label %152, !dbg !760     ; [debug line = 125:12]

; <label>:99                                      ; preds = %94
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !762 ; [debug line = 125:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !762 ; [debug line = 125:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !764 ; [debug line = 126:1]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 4, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !765 ; [debug line = 129:1]
  %100 = load i11* %col, align 2, !dbg !766       ; [#uses=1 type=i11] [debug line = 136:2]
  %101 = sext i11 %100 to i64, !dbg !766          ; [#uses=1 type=i64] [debug line = 136:2]
  %102 = load i11* %row, align 2, !dbg !766       ; [#uses=1 type=i11] [debug line = 136:2]
  %103 = sext i11 %102 to i64, !dbg !766          ; [#uses=1 type=i64] [debug line = 136:2]
  %104 = load [1200 x i32]** %1, align 8, !dbg !766 ; [#uses=1 type=[1200 x i32]*] [debug line = 136:2]
  %105 = getelementptr inbounds [1200 x i32]* %104, i64 %103, !dbg !766 ; [#uses=1 type=[1200 x i32]*] [debug line = 136:2]
  %106 = getelementptr inbounds [1200 x i32]* %105, i32 0, i64 %101, !dbg !766 ; [#uses=1 type=i32*] [debug line = 136:2]
  %107 = load i32* %106, align 4, !dbg !766       ; [#uses=1 type=i32] [debug line = 136:2]
  %108 = and i32 %107, 255, !dbg !766             ; [#uses=1 type=i32] [debug line = 136:2]
  %109 = load i8* %min, align 1, !dbg !766        ; [#uses=1 type=i8] [debug line = 136:2]
  %110 = sext i8 %109 to i32, !dbg !766           ; [#uses=1 type=i32] [debug line = 136:2]
  %111 = sub nsw i32 %108, %110, !dbg !766        ; [#uses=1 type=i32] [debug line = 136:2]
  %112 = load i32* %5, align 4, !dbg !766         ; [#uses=1 type=i32] [debug line = 136:2]
  %113 = load i32* %6, align 4, !dbg !766         ; [#uses=1 type=i32] [debug line = 136:2]
  %114 = sub nsw i32 %112, %113, !dbg !766        ; [#uses=1 type=i32] [debug line = 136:2]
  %115 = mul nsw i32 %111, %114, !dbg !766        ; [#uses=1 type=i32] [debug line = 136:2]
  %116 = sitofp i32 %115 to double, !dbg !766     ; [#uses=1 type=double] [debug line = 136:2]
  %117 = load i8* %max, align 1, !dbg !766        ; [#uses=1 type=i8] [debug line = 136:2]
  %118 = sext i8 %117 to i32, !dbg !766           ; [#uses=1 type=i32] [debug line = 136:2]
  %119 = load i8* %min, align 1, !dbg !766        ; [#uses=1 type=i8] [debug line = 136:2]
  %120 = sext i8 %119 to i32, !dbg !766           ; [#uses=1 type=i32] [debug line = 136:2]
  %121 = sub nsw i32 %118, %120, !dbg !766        ; [#uses=1 type=i32] [debug line = 136:2]
  %122 = sitofp i32 %121 to double, !dbg !766     ; [#uses=1 type=double] [debug line = 136:2]
  %123 = fdiv double %116, %122, !dbg !766        ; [#uses=1 type=double] [debug line = 136:2]
  %124 = load i32* %6, align 4, !dbg !766         ; [#uses=1 type=i32] [debug line = 136:2]
  %125 = sitofp i32 %124 to double, !dbg !766     ; [#uses=1 type=double] [debug line = 136:2]
  %126 = fadd double %123, %125, !dbg !766        ; [#uses=1 type=double] [debug line = 136:2]
  %127 = fptosi double %126 to i8, !dbg !766      ; [#uses=1 type=i8] [debug line = 136:2]
  store i8 %127, i8* %newValue, align 1, !dbg !766 ; [debug line = 136:2]
  %128 = load i8* %newValue, align 1, !dbg !767   ; [#uses=1 type=i8] [debug line = 138:4]
  %129 = sext i8 %128 to i32, !dbg !767           ; [#uses=1 type=i32] [debug line = 138:4]
  %130 = shl i32 %129, 24, !dbg !767              ; [#uses=1 type=i32] [debug line = 138:4]
  %131 = load i8* %newValue, align 1, !dbg !767   ; [#uses=1 type=i8] [debug line = 138:4]
  %132 = sext i8 %131 to i32, !dbg !767           ; [#uses=1 type=i32] [debug line = 138:4]
  %133 = shl i32 %132, 16, !dbg !767              ; [#uses=1 type=i32] [debug line = 138:4]
  %134 = add nsw i32 %130, %133, !dbg !767        ; [#uses=1 type=i32] [debug line = 138:4]
  %135 = load i8* %newValue, align 1, !dbg !767   ; [#uses=1 type=i8] [debug line = 138:4]
  %136 = sext i8 %135 to i32, !dbg !767           ; [#uses=1 type=i32] [debug line = 138:4]
  %137 = shl i32 %136, 8, !dbg !767               ; [#uses=1 type=i32] [debug line = 138:4]
  %138 = add nsw i32 %134, %137, !dbg !767        ; [#uses=1 type=i32] [debug line = 138:4]
  %139 = load i8* %newValue, align 1, !dbg !767   ; [#uses=1 type=i8] [debug line = 138:4]
  %140 = sext i8 %139 to i32, !dbg !767           ; [#uses=1 type=i32] [debug line = 138:4]
  %141 = add nsw i32 %138, %140, !dbg !767        ; [#uses=1 type=i32] [debug line = 138:4]
  %142 = load i11* %col, align 2, !dbg !767       ; [#uses=1 type=i11] [debug line = 138:4]
  %143 = sext i11 %142 to i64, !dbg !767          ; [#uses=1 type=i64] [debug line = 138:4]
  %144 = load i11* %row, align 2, !dbg !767       ; [#uses=1 type=i11] [debug line = 138:4]
  %145 = sext i11 %144 to i64, !dbg !767          ; [#uses=1 type=i64] [debug line = 138:4]
  %146 = load [1200 x i32]** %2, align 8, !dbg !767 ; [#uses=1 type=[1200 x i32]*] [debug line = 138:4]
  %147 = getelementptr inbounds [1200 x i32]* %146, i64 %145, !dbg !767 ; [#uses=1 type=[1200 x i32]*] [debug line = 138:4]
  %148 = getelementptr inbounds [1200 x i32]* %147, i32 0, i64 %143, !dbg !767 ; [#uses=1 type=i32*] [debug line = 138:4]
  store i32 %141, i32* %148, align 4, !dbg !767   ; [debug line = 138:4]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !768 ; [debug line = 140:3]
  br label %149, !dbg !768                        ; [debug line = 140:3]

; <label>:149                                     ; preds = %99
  %150 = load i11* %col, align 2, !dbg !769       ; [#uses=1 type=i11] [debug line = 125:36]
  %151 = add i11 %150, 1, !dbg !769               ; [#uses=1 type=i11] [debug line = 125:36]
  store i11 %151, i11* %col, align 2, !dbg !769   ; [debug line = 125:36]
  br label %94, !dbg !769                         ; [debug line = 125:36]

; <label>:152                                     ; preds = %94
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !770 ; [debug line = 141:2]
  br label %153, !dbg !770                        ; [debug line = 141:2]

; <label>:153                                     ; preds = %152
  %154 = load i11* %row, align 2, !dbg !771       ; [#uses=1 type=i11] [debug line = 123:37]
  %155 = add i11 %154, 1, !dbg !771               ; [#uses=1 type=i11] [debug line = 123:37]
  store i11 %155, i11* %row, align 2, !dbg !771   ; [debug line = 123:37]
  br label %87, !dbg !771                         ; [debug line = 123:37]

; <label>:156                                     ; preds = %87
  ret void, !dbg !772                             ; [debug line = 143:1]
}
...
define void @_Z6imDiffPA1200_iiiS0_iiP5t_SAD([1200 x i32]* %imINPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, i32 %tplHeight, i32 %tplWidth, %struct.t_SAD* %output_struct) nounwind uwtable {
  ...
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !773), !dbg !774 ; [debug line = 145:17] [debug variable = imINPUT]
  store i32 %imHeight, i32* %2, align 4
  call void @llvm.dbg.declare(metadata !{i32* %2}, metadata !775), !dbg !776 ; [debug line = 145:42] [debug variable = imHeight]
  store i32 %imWidth, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !777), !dbg !778 ; [debug line = 145:56] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %4, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %4}, metadata !779), !dbg !780 ; [debug line = 146:7] [debug variable = tplINPUT]
  store i32 %tplHeight, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !781), !dbg !782 ; [debug line = 146:33] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !783), !dbg !784 ; [debug line = 147:7] [debug variable = tplWidth]
  store %struct.t_SAD* %output_struct, %struct.t_SAD** %7, align 8
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD** %7}, metadata !785), !dbg !786 ; [debug line = 147:24] [debug variable = output_struct]
  %8 = load [1200 x i32]** %1, align 8, !dbg !787 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:40]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !787 ; [debug line = 147:40]
  %9 = load [1200 x i32]** %4, align 8, !dbg !789 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:77]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !789 ; [debug line = 147:77]
  call void @llvm.dbg.declare(metadata !{i11* %row_img}, metadata !790), !dbg !791 ; [debug line = 148:8] [debug variable = row_img]
  call void @llvm.dbg.declare(metadata !{i11* %row_tpl}, metadata !792), !dbg !793 ; [debug line = 148:17] [debug variable = row_tpl]
  call void @llvm.dbg.declare(metadata !{i11* %col_img}, metadata !794), !dbg !795 ; [debug line = 149:8] [debug variable = col_img]
  call void @llvm.dbg.declare(metadata !{i11* %col_tpl}, metadata !796), !dbg !797 ; [debug line = 149:17] [debug variable = col_tpl]
  call void @llvm.dbg.declare(metadata !{i8* %search_img}, metadata !798), !dbg !799 ; [debug line = 150:7] [debug variable = search_img]
  call void @llvm.dbg.declare(metadata !{i8* %template_img}, metadata !800), !dbg !801 ; [debug line = 150:19] [debug variable = template_img]
  call void @llvm.dbg.declare(metadata !{i32* %SAD}, metadata !802), !dbg !803 ; [debug line = 151:6] [debug variable = SAD]
  call void @llvm.dbg.declare(metadata !{i32* %minSAD}, metadata !804), !dbg !805 ; [debug line = 151:11] [debug variable = minSAD]
  store i32 0, i32* %minSAD, align 4, !dbg !806   ; [debug line = 160:2]
  br label %10, !dbg !806                         ; [debug line = 160:2]

; <label>:10                                      ; preds = %0
  store i11 0, i11* %row_img, align 2, !dbg !807  ; [debug line = 161:12]
  br label %11, !dbg !807                         ; [debug line = 161:12]

; <label>:11                                      ; preds = %108, %10
  %12 = load i11* %row_img, align 2, !dbg !807    ; [#uses=1 type=i11] [debug line = 161:12]
  %13 = sext i11 %12 to i32, !dbg !807            ; [#uses=1 type=i32] [debug line = 161:12]
  %14 = load i32* %2, align 4, !dbg !807          ; [#uses=1 type=i32] [debug line = 161:12]
  %15 = load i32* %5, align 4, !dbg !807          ; [#uses=1 type=i32] [debug line = 161:12]
  %16 = sub nsw i32 %14, %15, !dbg !807           ; [#uses=1 type=i32] [debug line = 161:12]
  %17 = icmp slt i32 %13, %16, !dbg !807          ; [#uses=1 type=i1] [debug line = 161:12]
  br i1 %17, label %18, label %111, !dbg !807     ; [debug line = 161:12]

; <label>:18                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !809 ; [debug line = 161:69]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !809 ; [debug line = 161:69]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !811 ; [debug line = 163:1]
  br label %19, !dbg !811                         ; [debug line = 163:1]

; <label>:19                                      ; preds = %18
  store i11 0, i11* %col_img, align 2, !dbg !812  ; [debug line = 164:12]
  br label %20, !dbg !812                         ; [debug line = 164:12]

; <label>:20                                      ; preds = %104, %19
  %21 = load i11* %col_img, align 2, !dbg !812    ; [#uses=1 type=i11] [debug line = 164:12]
  %22 = sext i11 %21 to i32, !dbg !812            ; [#uses=1 type=i32] [debug line = 164:12]
  %23 = load i32* %3, align 4, !dbg !812          ; [#uses=1 type=i32] [debug line = 164:12]
  %24 = load i32* %6, align 4, !dbg !812          ; [#uses=1 type=i32] [debug line = 164:12]
  %25 = sub nsw i32 %23, %24, !dbg !812           ; [#uses=1 type=i32] [debug line = 164:12]
  %26 = icmp slt i32 %22, %25, !dbg !812          ; [#uses=1 type=i1] [debug line = 164:12]
  br i1 %26, label %27, label %107, !dbg !812     ; [debug line = 164:12]

; <label>:27                                      ; preds = %20
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !814 ; [debug line = 164:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !814 ; [debug line = 164:67]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !816 ; [debug line = 165:1]
  store i32 0, i32* %SAD, align 4, !dbg !817      ; [debug line = 166:2]
  br label %28, !dbg !817                         ; [debug line = 166:2]

; <label>:28                                      ; preds = %27
  store i11 0, i11* %row_tpl, align 2, !dbg !818  ; [debug line = 167:14]
  br label %29, !dbg !818                         ; [debug line = 167:14]

; <label>:29                                      ; preds = %82, %28
  %30 = load i11* %row_tpl, align 2, !dbg !818    ; [#uses=1 type=i11] [debug line = 167:14]
  %31 = sext i11 %30 to i32, !dbg !818            ; [#uses=1 type=i32] [debug line = 167:14]
  %32 = load i32* %5, align 4, !dbg !818          ; [#uses=1 type=i32] [debug line = 167:14]
  %33 = icmp slt i32 %31, %32, !dbg !818          ; [#uses=1 type=i1] [debug line = 167:14]
  br i1 %33, label %34, label %85, !dbg !818      ; [debug line = 167:14]

; <label>:34                                      ; preds = %29
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !820 ; [debug line = 167:60]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !820 ; [debug line = 167:60]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !822 ; [debug line = 169:1]
  br label %35, !dbg !822                         ; [debug line = 169:1]

; <label>:35                                      ; preds = %34
  store i11 0, i11* %col_tpl, align 2, !dbg !823  ; [debug line = 170:12]
  br label %36, !dbg !823                         ; [debug line = 170:12]

; <label>:36                                      ; preds = %78, %35
  %37 = load i11* %col_tpl, align 2, !dbg !823    ; [#uses=1 type=i11] [debug line = 170:12]
  %38 = sext i11 %37 to i32, !dbg !823            ; [#uses=1 type=i32] [debug line = 170:12]
  %39 = load i32* %6, align 4, !dbg !823          ; [#uses=1 type=i32] [debug line = 170:12]
  %40 = icmp slt i32 %38, %39, !dbg !823          ; [#uses=1 type=i1] [debug line = 170:12]
  br i1 %40, label %41, label %81, !dbg !823      ; [debug line = 170:12]

; <label>:41                                      ; preds = %36
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !825 ; [debug line = 170:57]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !825 ; [debug line = 170:57]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !827 ; [debug line = 171:1]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 4, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !828 ; [debug line = 174:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !829 ; [debug line = 175:1]
  %42 = load i11* %col_img, align 2, !dbg !830    ; [#uses=1 type=i11] [debug line = 184:2]
  %43 = sext i11 %42 to i32, !dbg !830            ; [#uses=1 type=i32] [debug line = 184:2]
  %44 = load i11* %col_tpl, align 2, !dbg !830    ; [#uses=1 type=i11] [debug line = 184:2]
  %45 = sext i11 %44 to i32, !dbg !830            ; [#uses=1 type=i32] [debug line = 184:2]
  %46 = add nsw i32 %43, %45, !dbg !830           ; [#uses=1 type=i32] [debug line = 184:2]
  %47 = sext i32 %46 to i64, !dbg !830            ; [#uses=1 type=i64] [debug line = 184:2]
  %48 = load i11* %row_img, align 2, !dbg !830    ; [#uses=1 type=i11] [debug line = 184:2]
  %49 = sext i11 %48 to i32, !dbg !830            ; [#uses=1 type=i32] [debug line = 184:2]
  %50 = load i11* %row_tpl, align 2, !dbg !830    ; [#uses=1 type=i11] [debug line = 184:2]
  %51 = sext i11 %50 to i32, !dbg !830            ; [#uses=1 type=i32] [debug line = 184:2]
  %52 = add nsw i32 %49, %51, !dbg !830           ; [#uses=1 type=i32] [debug line = 184:2]
  %53 = sext i32 %52 to i64, !dbg !830            ; [#uses=1 type=i64] [debug line = 184:2]
  %54 = load [1200 x i32]** %1, align 8, !dbg !830 ; [#uses=1 type=[1200 x i32]*] [debug line = 184:2]
  %55 = getelementptr inbounds [1200 x i32]* %54, i64 %53, !dbg !830 ; [#uses=1 type=[1200 x i32]*] [debug line = 184:2]
  %56 = getelementptr inbounds [1200 x i32]* %55, i32 0, i64 %47, !dbg !830 ; [#uses=1 type=i32*] [debug line = 184:2]
  %57 = load i32* %56, align 4, !dbg !830         ; [#uses=1 type=i32] [debug line = 184:2]
  %58 = and i32 %57, 255, !dbg !830               ; [#uses=1 type=i32] [debug line = 184:2]
  %59 = trunc i32 %58 to i8, !dbg !830            ; [#uses=1 type=i8] [debug line = 184:2]
  store i8 %59, i8* %search_img, align 1, !dbg !830 ; [debug line = 184:2]
  %60 = load i11* %col_tpl, align 2, !dbg !831    ; [#uses=1 type=i11] [debug line = 186:6]
  %61 = sext i11 %60 to i64, !dbg !831            ; [#uses=1 type=i64] [debug line = 186:6]
  %62 = load i11* %row_tpl, align 2, !dbg !831    ; [#uses=1 type=i11] [debug line = 186:6]
  %63 = sext i11 %62 to i64, !dbg !831            ; [#uses=1 type=i64] [debug line = 186:6]
  %64 = load [1200 x i32]** %4, align 8, !dbg !831 ; [#uses=1 type=[1200 x i32]*] [debug line = 186:6]
  %65 = getelementptr inbounds [1200 x i32]* %64, i64 %63, !dbg !831 ; [#uses=1 type=[1200 x i32]*] [debug line = 186:6]
  %66 = getelementptr inbounds [1200 x i32]* %65, i32 0, i64 %61, !dbg !831 ; [#uses=1 type=i32*] [debug line = 186:6]
  %67 = load i32* %66, align 4, !dbg !831         ; [#uses=1 type=i32] [debug line = 186:6]
  %68 = and i32 %67, 255, !dbg !831               ; [#uses=1 type=i32] [debug line = 186:6]
  %69 = trunc i32 %68 to i8, !dbg !831            ; [#uses=1 type=i8] [debug line = 186:6]
  store i8 %69, i8* %template_img, align 1, !dbg !831 ; [debug line = 186:6]
  %70 = load i8* %search_img, align 1, !dbg !832  ; [#uses=1 type=i8] [debug line = 188:13]
  %71 = sext i8 %70 to i32, !dbg !832             ; [#uses=1 type=i32] [debug line = 188:13]
  %72 = load i8* %template_img, align 1, !dbg !832 ; [#uses=1 type=i8] [debug line = 188:13]
  %73 = sext i8 %72 to i32, !dbg !832             ; [#uses=1 type=i32] [debug line = 188:13]
  %74 = sub nsw i32 %71, %73, !dbg !832           ; [#uses=1 type=i32] [debug line = 188:13]
  %75 = call i32 @abs(i32 %74) nounwind readnone, !dbg !832 ; [#uses=1 type=i32] [debug line = 188:13]
  %76 = load i32* %SAD, align 4, !dbg !832        ; [#uses=1 type=i32] [debug line = 188:13]
  %77 = add nsw i32 %76, %75, !dbg !832           ; [#uses=1 type=i32] [debug line = 188:13]
  store i32 %77, i32* %SAD, align 4, !dbg !832    ; [debug line = 188:13]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !833 ; [debug line = 189:5]
  br label %78, !dbg !833                         ; [debug line = 189:5]

; <label>:78                                      ; preds = %41
  %79 = load i11* %col_tpl, align 2, !dbg !834    ; [#uses=1 type=i11] [debug line = 170:45]
  %80 = add i11 %79, 1, !dbg !834                 ; [#uses=1 type=i11] [debug line = 170:45]
  store i11 %80, i11* %col_tpl, align 2, !dbg !834 ; [debug line = 170:45]
  br label %36, !dbg !834                         ; [debug line = 170:45]

; <label>:81                                      ; preds = %36
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !835 ; [debug line = 190:4]
  br label %82, !dbg !835                         ; [debug line = 190:4]

; <label>:82                                      ; preds = %81
  %83 = load i11* %row_tpl, align 2, !dbg !836    ; [#uses=1 type=i11] [debug line = 167:48]
  %84 = add i11 %83, 1, !dbg !836                 ; [#uses=1 type=i11] [debug line = 167:48]
  store i11 %84, i11* %row_tpl, align 2, !dbg !836 ; [debug line = 167:48]
  br label %29, !dbg !836                         ; [debug line = 167:48]

; <label>:85                                      ; preds = %29
  %86 = load i32* %minSAD, align 4, !dbg !837     ; [#uses=1 type=i32] [debug line = 191:4]
  %87 = load i32* %SAD, align 4, !dbg !837        ; [#uses=1 type=i32] [debug line = 191:4]
  %88 = icmp sgt i32 %86, %87, !dbg !837          ; [#uses=1 type=i1] [debug line = 191:4]
  br i1 %88, label %92, label %89, !dbg !837      ; [debug line = 191:4]

; <label>:89                                      ; preds = %85
  %90 = load i32* %minSAD, align 4, !dbg !837     ; [#uses=1 type=i32] [debug line = 191:4]
  %91 = icmp eq i32 %90, 0, !dbg !837             ; [#uses=1 type=i1] [debug line = 191:4]
  br i1 %91, label %92, label %103, !dbg !837     ; [debug line = 191:4]

; <label>:92                                      ; preds = %89, %85
  %93 = load i32* %SAD, align 4, !dbg !838        ; [#uses=1 type=i32] [debug line = 192:5]
  store i32 %93, i32* %minSAD, align 4, !dbg !838 ; [debug line = 192:5]
  %94 = load i11* %row_img, align 2, !dbg !840    ; [#uses=1 type=i11] [debug line = 193:5]
  %95 = load %struct.t_SAD** %7, align 8, !dbg !840 ; [#uses=1 type=%struct.t_SAD*] [debug line = 193:5]
  %96 = getelementptr inbounds %struct.t_SAD* %95, i32 0, i32 1, !dbg !840 ; [#uses=1 type=i11*] [debug line = 193:5]
  store i11 %94, i11* %96, align 2, !dbg !840     ; [debug line = 193:5]
  %97 = load i11* %col_img, align 2, !dbg !841    ; [#uses=1 type=i11] [debug line = 194:5]
  %98 = load %struct.t_SAD** %7, align 8, !dbg !841 ; [#uses=1 type=%struct.t_SAD*] [debug line = 194:5]
  %99 = getelementptr inbounds %struct.t_SAD* %98, i32 0, i32 0, !dbg !841 ; [#uses=1 type=i11*] [debug line = 194:5]
  store i11 %97, i11* %99, align 2, !dbg !841     ; [debug line = 194:5]
  %100 = load i32* %SAD, align 4, !dbg !842       ; [#uses=1 type=i32] [debug line = 195:5]
  %101 = load %struct.t_SAD** %7, align 8, !dbg !842 ; [#uses=1 type=%struct.t_SAD*] [debug line = 195:5]
  %102 = getelementptr inbounds %struct.t_SAD* %101, i32 0, i32 2, !dbg !842 ; [#uses=1 type=i32*] [debug line = 195:5]
  store i32 %100, i32* %102, align 4, !dbg !842   ; [debug line = 195:5]
  br label %103, !dbg !843                        ; [debug line = 196:4]

; <label>:103                                     ; preds = %92, %89
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !844 ; [debug line = 197:3]
  br label %104, !dbg !844                        ; [debug line = 197:3]

; <label>:104                                     ; preds = %103
  %105 = load i11* %col_img, align 2, !dbg !845   ; [#uses=1 type=i11] [debug line = 164:55]
  %106 = add i11 %105, 1, !dbg !845               ; [#uses=1 type=i11] [debug line = 164:55]
  store i11 %106, i11* %col_img, align 2, !dbg !845 ; [debug line = 164:55]
  br label %20, !dbg !845                         ; [debug line = 164:55]

; <label>:107                                     ; preds = %20
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !846 ; [debug line = 198:2]
  br label %108, !dbg !846                        ; [debug line = 198:2]

; <label>:108                                     ; preds = %107
  %109 = load i11* %row_img, align 2, !dbg !847   ; [#uses=1 type=i11] [debug line = 161:57]
  %110 = add i11 %109, 1, !dbg !847               ; [#uses=1 type=i11] [debug line = 161:57]
  store i11 %110, i11* %row_img, align 2, !dbg !847 ; [debug line = 161:57]
  br label %11, !dbg !847                         ; [debug line = 161:57]

; <label>:111                                     ; preds = %11
  ret void, !dbg !848                             ; [debug line = 200:1]
}
...
define void @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD([1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, i32 %tplHeight, i32 %tplWidth, %struct.t_SAD* %output_struct) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !849), !dbg !850 ; [debug line = 202:33] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %2, align 4
  call void @llvm.dbg.declare(metadata !{i32* %2}, metadata !851), !dbg !852 ; [debug line = 202:59] [debug variable = imHeight]
  store i32 %imWidth, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !853), !dbg !854 ; [debug line = 203:7] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %4, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %4}, metadata !855), !dbg !856 ; [debug line = 203:20] [debug variable = tplINPUT]
  store i32 %tplHeight, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !857), !dbg !858 ; [debug line = 203:46] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !859), !dbg !860 ; [debug line = 204:7] [debug variable = tplWidth]
  store %struct.t_SAD* %output_struct, %struct.t_SAD** %7, align 8
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD** %7}, metadata !861), !dbg !862 ; [debug line = 204:24] [debug variable = output_struct]
  %8 = load [1200 x i32]** %1, align 8, !dbg !863 ; [#uses=1 type=[1200 x i32]*] [debug line = 204:40]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !863 ; [debug line = 204:40]
  %9 = load [1200 x i32]** %4, align 8, !dbg !865 ; [#uses=1 type=[1200 x i32]*] [debug line = 204:78]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !865 ; [debug line = 204:78]
  call void @llvm.dbg.declare(metadata !{i11* %row}, metadata !866), !dbg !867 ; [debug line = 206:8] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i11* %col}, metadata !868), !dbg !869 ; [debug line = 207:8] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i11* %row_offset}, metadata !870), !dbg !871 ; [debug line = 208:8] [debug variable = row_offset]
  %10 = load %struct.t_SAD** %7, align 8, !dbg !872 ; [#uses=1 type=%struct.t_SAD*] [debug line = 208:37]
  %11 = getelementptr inbounds %struct.t_SAD* %10, i32 0, i32 1, !dbg !872 ; [#uses=1 type=i11*] [debug line = 208:37]
  %12 = load i11* %11, align 2, !dbg !872         ; [#uses=1 type=i11] [debug line = 208:37]
  store i11 %12, i11* %row_offset, align 2, !dbg !872 ; [debug line = 208:37]
  call void @llvm.dbg.declare(metadata !{i11* %col_offset}, metadata !873), !dbg !874 ; [debug line = 209:8] [debug variable = col_offset]
  %13 = load %struct.t_SAD** %7, align 8, !dbg !875 ; [#uses=1 type=%struct.t_SAD*] [debug line = 209:37]
  %14 = getelementptr inbounds %struct.t_SAD* %13, i32 0, i32 0, !dbg !875 ; [#uses=1 type=i11*] [debug line = 209:37]
  %15 = load i11* %14, align 2, !dbg !875         ; [#uses=1 type=i11] [debug line = 209:37]
  store i11 %15, i11* %col_offset, align 2, !dbg !875 ; [debug line = 209:37]
  br label %16, !dbg !875                         ; [debug line = 209:37]

; <label>:16                                      ; preds = %0
  store i11 0, i11* %row, align 2, !dbg !876      ; [debug line = 211:13]
  br label %17, !dbg !876                         ; [debug line = 211:13]

; <label>:17                                      ; preds = %57, %16
  %18 = load i11* %row, align 2, !dbg !876        ; [#uses=1 type=i11] [debug line = 211:13]
  %19 = sext i11 %18 to i32, !dbg !876            ; [#uses=1 type=i32] [debug line = 211:13]
  %20 = load i32* %5, align 4, !dbg !876          ; [#uses=1 type=i32] [debug line = 211:13]
  %21 = icmp slt i32 %19, %20, !dbg !876          ; [#uses=1 type=i1] [debug line = 211:13]
  br i1 %21, label %22, label %60, !dbg !876      ; [debug line = 211:13]

; <label>:22                                      ; preds = %17
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !878 ; [debug line = 211:47]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !878 ; [debug line = 211:47]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !880 ; [debug line = 212:1]
  br label %23, !dbg !880                         ; [debug line = 212:1]

; <label>:23                                      ; preds = %22
  store i11 0, i11* %col, align 2, !dbg !881      ; [debug line = 213:13]
  br label %24, !dbg !881                         ; [debug line = 213:13]

; <label>:24                                      ; preds = %53, %23
  %25 = load i11* %col, align 2, !dbg !881        ; [#uses=1 type=i11] [debug line = 213:13]
  %26 = sext i11 %25 to i32, !dbg !881            ; [#uses=1 type=i32] [debug line = 213:13]
  %27 = load i32* %6, align 4, !dbg !881          ; [#uses=1 type=i32] [debug line = 213:13]
  %28 = icmp slt i32 %26, %27, !dbg !881          ; [#uses=1 type=i1] [debug line = 213:13]
  br i1 %28, label %29, label %56, !dbg !881      ; [debug line = 213:13]

; <label>:29                                      ; preds = %24
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([5 x i8]* @.str1334, i32 0, i32 0)) nounwind, !dbg !883 ; [debug line = 213:46]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([5 x i8]* @.str1334, i32 0, i32 0)) nounwind, !dbg !883 ; [debug line = 213:46]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !885 ; [debug line = 214:1]
  %30 = load i11* %col, align 2, !dbg !886        ; [#uses=1 type=i11] [debug line = 215:2]
  %31 = sext i11 %30 to i64, !dbg !886            ; [#uses=1 type=i64] [debug line = 215:2]
  %32 = load i11* %row, align 2, !dbg !886        ; [#uses=1 type=i11] [debug line = 215:2]
  %33 = sext i11 %32 to i64, !dbg !886            ; [#uses=1 type=i64] [debug line = 215:2]
  %34 = load [1200 x i32]** %4, align 8, !dbg !886 ; [#uses=1 type=[1200 x i32]*] [debug line = 215:2]
  %35 = getelementptr inbounds [1200 x i32]* %34, i64 %33, !dbg !886 ; [#uses=1 type=[1200 x i32]*] [debug line = 215:2]
  %36 = getelementptr inbounds [1200 x i32]* %35, i32 0, i64 %31, !dbg !886 ; [#uses=1 type=i32*] [debug line = 215:2]
  %37 = load i32* %36, align 4, !dbg !886         ; [#uses=1 type=i32] [debug line = 215:2]
  %38 = load i11* %col_offset, align 2, !dbg !886 ; [#uses=1 type=i11] [debug line = 215:2]
  %39 = sext i11 %38 to i32, !dbg !886            ; [#uses=1 type=i32] [debug line = 215:2]
  %40 = load i11* %col, align 2, !dbg !886        ; [#uses=1 type=i11] [debug line = 215:2]
  %41 = sext i11 %40 to i32, !dbg !886            ; [#uses=1 type=i32] [debug line = 215:2]
  %42 = add nsw i32 %39, %41, !dbg !886           ; [#uses=1 type=i32] [debug line = 215:2]
  %43 = sext i32 %42 to i64, !dbg !886            ; [#uses=1 type=i64] [debug line = 215:2]
  %44 = load i11* %row_offset, align 2, !dbg !886 ; [#uses=1 type=i11] [debug line = 215:2]
  %45 = sext i11 %44 to i32, !dbg !886            ; [#uses=1 type=i32] [debug line = 215:2]
  %46 = load i11* %row, align 2, !dbg !886        ; [#uses=1 type=i11] [debug line = 215:2]
  %47 = sext i11 %46 to i32, !dbg !886            ; [#uses=1 type=i32] [debug line = 215:2]
  %48 = add nsw i32 %45, %47, !dbg !886           ; [#uses=1 type=i32] [debug line = 215:2]
  %49 = sext i32 %48 to i64, !dbg !886            ; [#uses=1 type=i64] [debug line = 215:2]
  %50 = load [1200 x i32]** %1, align 8, !dbg !886 ; [#uses=1 type=[1200 x i32]*] [debug line = 215:2]
  %51 = getelementptr inbounds [1200 x i32]* %50, i64 %49, !dbg !886 ; [#uses=1 type=[1200 x i32]*] [debug line = 215:2]
  %52 = getelementptr inbounds [1200 x i32]* %51, i32 0, i64 %43, !dbg !886 ; [#uses=1 type=i32*] [debug line = 215:2]
  store i32 %37, i32* %52, align 4, !dbg !886     ; [debug line = 215:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([5 x i8]* @.str1334, i32 0, i32 0)) nounwind, !dbg !887 ; [debug line = 216:3]
  br label %53, !dbg !887                         ; [debug line = 216:3]

; <label>:53                                      ; preds = %29
  %54 = load i11* %col, align 2, !dbg !888        ; [#uses=1 type=i11] [debug line = 213:38]
  %55 = add i11 %54, 1, !dbg !888                 ; [#uses=1 type=i11] [debug line = 213:38]
  store i11 %55, i11* %col, align 2, !dbg !888    ; [debug line = 213:38]
  br label %24, !dbg !888                         ; [debug line = 213:38]

; <label>:56                                      ; preds = %24
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !889 ; [debug line = 218:2]
  br label %57, !dbg !889                         ; [debug line = 218:2]

; <label>:57                                      ; preds = %56
  %58 = load i11* %row, align 2, !dbg !890        ; [#uses=1 type=i11] [debug line = 211:39]
  %59 = add i11 %58, 1, !dbg !890                 ; [#uses=1 type=i11] [debug line = 211:39]
  store i11 %59, i11* %row, align 2, !dbg !890    ; [debug line = 211:39]
  br label %17, !dbg !890                         ; [debug line = 211:39]

; <label>:60                                      ; preds = %17
  ret void, !dbg !891                             ; [debug line = 219:1]
}
...
define void @_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, [1200 x i32]* %tplOUTPUT, i32 %tplHeight, i32 %tplWidth) nounwind uwtable {
  ...
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !892), !dbg !893 ; [debug line = 221:29] [debug variable = imINPUT]
  store [1200 x i32]* %imOUTPUT, [1200 x i32]** %2, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %2}, metadata !894), !dbg !895 ; [debug line = 222:7] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !896), !dbg !897 ; [debug line = 222:33] [debug variable = imHeight]
  store i32 %imWidth, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !898), !dbg !899 ; [debug line = 222:47] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %5, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %5}, metadata !900), !dbg !901 ; [debug line = 223:7] [debug variable = tplINPUT]
  store [1200 x i32]* %tplOUTPUT, [1200 x i32]** %6, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %6}, metadata !902), !dbg !903 ; [debug line = 224:7] [debug variable = tplOUTPUT]
  store i32 %tplHeight, i32* %7, align 4
  call void @llvm.dbg.declare(metadata !{i32* %7}, metadata !904), !dbg !905 ; [debug line = 224:34] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %8, align 4
  call void @llvm.dbg.declare(metadata !{i32* %8}, metadata !906), !dbg !907 ; [debug line = 225:7] [debug variable = tplWidth]
  %9 = load [1200 x i32]** %1, align 8, !dbg !908 ; [#uses=1 type=[1200 x i32]*] [debug line = 225:18]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !908 ; [debug line = 225:18]
  %10 = load [1200 x i32]** %2, align 8, !dbg !910 ; [#uses=1 type=[1200 x i32]*] [debug line = 225:55]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %10, i32 1200) nounwind, !dbg !910 ; [debug line = 225:55]
  %11 = load [1200 x i32]** %6, align 8, !dbg !911 ; [#uses=1 type=[1200 x i32]*] [debug line = 225:93]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %11, i32 1200) nounwind, !dbg !911 ; [debug line = 225:93]
  %12 = load [1200 x i32]** %5, align 8, !dbg !912 ; [#uses=1 type=[1200 x i32]*] [debug line = 225:132]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %12, i32 1200) nounwind, !dbg !912 ; [debug line = 225:132]
  %13 = load [1200 x i32]** %1, align 8, !dbg !913 ; [#uses=1 type=[1200 x i32]*] [debug line = 229:1]
  call void (...)* @_ssdm_SpecStream([1200 x i32]* %13, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !913 ; [debug line = 229:1]
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD* %template_match_position}, metadata !914), !dbg !915 ; [debug line = 238:8] [debug variable = template_match_position]
  %14 = load [1200 x i32]** %1, align 8, !dbg !916 ; [#uses=1 type=[1200 x i32]*] [debug line = 240:2]
  %15 = load [1200 x i32]** %2, align 8, !dbg !916 ; [#uses=1 type=[1200 x i32]*] [debug line = 240:2]
  %16 = load i32* %3, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 240:2]
  %17 = load i32* %4, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 240:2]
  call void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %14, [1200 x i32]* %15, i32 %16, i32 %17, i32 0), !dbg !916 ; [debug line = 240:2]
  %18 = load [1200 x i32]** %5, align 8, !dbg !917 ; [#uses=1 type=[1200 x i32]*] [debug line = 241:2]
  %19 = load [1200 x i32]** %6, align 8, !dbg !917 ; [#uses=1 type=[1200 x i32]*] [debug line = 241:2]
  %20 = load i32* %7, align 4, !dbg !917          ; [#uses=1 type=i32] [debug line = 241:2]
  %21 = load i32* %8, align 4, !dbg !917          ; [#uses=1 type=i32] [debug line = 241:2]
  call void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %18, [1200 x i32]* %19, i32 %20, i32 %21, i32 0), !dbg !917 ; [debug line = 241:2]
  %22 = load [1200 x i32]** %2, align 8, !dbg !918 ; [#uses=1 type=[1200 x i32]*] [debug line = 242:2]
  %23 = load [1200 x i32]** %2, align 8, !dbg !918 ; [#uses=1 type=[1200 x i32]*] [debug line = 242:2]
  %24 = load i32* %3, align 4, !dbg !918          ; [#uses=1 type=i32] [debug line = 242:2]
  %25 = load i32* %4, align 4, !dbg !918          ; [#uses=1 type=i32] [debug line = 242:2]
  call void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %22, [1200 x i32]* %23, i32 %24, i32 %25, i32 255, i32 0), !dbg !918 ; [debug line = 242:2]
  %26 = load [1200 x i32]** %6, align 8, !dbg !919 ; [#uses=1 type=[1200 x i32]*] [debug line = 243:2]
  %27 = load [1200 x i32]** %6, align 8, !dbg !919 ; [#uses=1 type=[1200 x i32]*] [debug line = 243:2]
  %28 = load i32* %8, align 4, !dbg !919          ; [#uses=1 type=i32] [debug line = 243:2]
  %29 = load i32* %4, align 4, !dbg !919          ; [#uses=1 type=i32] [debug line = 243:2]
  call void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %26, [1200 x i32]* %27, i32 %28, i32 %29, i32 255, i32 0), !dbg !919 ; [debug line = 243:2]
  %30 = load [1200 x i32]** %2, align 8, !dbg !920 ; [#uses=1 type=[1200 x i32]*] [debug line = 246:2]
  %31 = load i32* %3, align 4, !dbg !920          ; [#uses=1 type=i32] [debug line = 246:2]
  %32 = load i32* %4, align 4, !dbg !920          ; [#uses=1 type=i32] [debug line = 246:2]
  %33 = load [1200 x i32]** %6, align 8, !dbg !920 ; [#uses=1 type=[1200 x i32]*] [debug line = 246:2]
  %34 = load i32* %7, align 4, !dbg !920          ; [#uses=1 type=i32] [debug line = 246:2]
  %35 = load i32* %8, align 4, !dbg !920          ; [#uses=1 type=i32] [debug line = 246:2]
  call void @_Z6imDiffPA1200_iiiS0_iiP5t_SAD([1200 x i32]* %30, i32 %31, i32 %32, [1200 x i32]* %33, i32 %34, i32 %35, %struct.t_SAD* %template_match_position), !dbg !920 ; [debug line = 246:2]
  %36 = load [1200 x i32]** %2, align 8, !dbg !921 ; [#uses=1 type=[1200 x i32]*] [debug line = 248:2]
  %37 = load i32* %3, align 4, !dbg !921          ; [#uses=1 type=i32] [debug line = 248:2]
  %38 = load i32* %4, align 4, !dbg !921          ; [#uses=1 type=i32] [debug line = 248:2]
  %39 = load [1200 x i32]** %5, align 8, !dbg !921 ; [#uses=1 type=[1200 x i32]*] [debug line = 248:2]
  %40 = load i32* %7, align 4, !dbg !921          ; [#uses=1 type=i32] [debug line = 248:2]
  %41 = load i32* %8, align 4, !dbg !921          ; [#uses=1 type=i32] [debug line = 248:2]
  call void @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD([1200 x i32]* %36, i32 %37, i32 %38, [1200 x i32]* %39, i32 %40, i32 %41, %struct.t_SAD* %template_match_position), !dbg !921 ; [debug line = 248:2]
  ret void, !dbg !922                             ; [debug line = 251:1]
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/student/workspace_HLS/template_matching/task/Task_1/solution2/.autopilot/db/ap_bmp.pragma.2.cpp", metadata !"/home/student/workspace_HLS/template_matching/task", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !142} ; [ DW_TAG_compile_unit ]
...
!183 = metadata !{i32 786478, i32 0, metadata !161, metadata !"imConstructOutputImage", metadata !"imConstructOutputImage", metadata !"_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD", metadata !161, i32 202, metadata !172, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([1200 x i32]*, i32, i32, [1200 x i32]*, i32, i32, %struct.t_SAD*)* @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD, null, null, metadata !67, i32 204} ; [ DW_TAG_subprogram ]
!184 = metadata !{i32 786478, i32 0, metadata !161, metadata !"imTemplateMatching", metadata !"imTemplateMatching", metadata !"_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii", metadata !161, i32 221, metadata !185, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([1200 x i32]*, [1200 x i32]*, i32, i32, [1200 x i32]*, [1200 x i32]*, i32, i32)* @_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii, null, null, metadata !67, i32 225} ; [ DW_TAG_subprogram ]
...
!666 = metadata !{i32 38, i32 1, metadata !664, null}
!667 = metadata !{i32 39, i32 1, metadata !664, null}
!668 = metadata !{i32 786688, metadata !664, metadata !"row", metadata !161, i32 48, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!669 = metadata !{i32 48, i32 8, metadata !664, null}
!670 = metadata !{i32 786688, metadata !664, metadata !"col", metadata !161, i32 49, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!671 = metadata !{i32 49, i32 8, metadata !664, null}
!672 = metadata !{i32 786688, metadata !664, metadata !"gray_pixel", metadata !161, i32 50, metadata !109, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!673 = metadata !{i32 50, i32 16, metadata !664, null}
!674 = metadata !{i32 50, i32 26, metadata !664, null}
!675 = metadata !{i32 53, i32 12, metadata !676, null}
!676 = metadata !{i32 786443, metadata !664, i32 53, i32 7, metadata !161, i32 1} ; [ DW_TAG_lexical_block ]
!677 = metadata !{i32 53, i32 45, metadata !678, null}
!678 = metadata !{i32 786443, metadata !676, i32 53, i32 44, metadata !161, i32 2} ; [ DW_TAG_lexical_block ]
!679 = metadata !{i32 54, i32 1, metadata !678, null}
!680 = metadata !{i32 55, i32 12, metadata !681, null}
!681 = metadata !{i32 786443, metadata !678, i32 55, i32 7, metadata !161, i32 3} ; [ DW_TAG_lexical_block ]
!682 = metadata !{i32 55, i32 44, metadata !683, null}
!683 = metadata !{i32 786443, metadata !681, i32 55, i32 43, metadata !161, i32 4} ; [ DW_TAG_lexical_block ]
!684 = metadata !{i32 56, i32 1, metadata !683, null}
!685 = metadata !{i32 58, i32 2, metadata !683, null}
!686 = metadata !{i32 60, i32 5, metadata !687, null}
!687 = metadata !{i32 786443, metadata !683, i32 58, i32 21, metadata !161, i32 5} ; [ DW_TAG_lexical_block ]
!688 = metadata !{i32 61, i32 5, metadata !687, null}
!689 = metadata !{i32 63, i32 5, metadata !687, null}
!690 = metadata !{i32 64, i32 5, metadata !687, null}
!691 = metadata !{i32 66, i32 5, metadata !687, null}
!692 = metadata !{i32 67, i32 5, metadata !687, null}
!693 = metadata !{i32 69, i32 5, metadata !687, null}
!694 = metadata !{i32 70, i32 4, metadata !687, null}
!695 = metadata !{i32 72, i32 4, metadata !683, null}
!696 = metadata !{i32 75, i32 3, metadata !683, null}
!697 = metadata !{i32 55, i32 36, metadata !681, null}
!698 = metadata !{i32 76, i32 2, metadata !678, null}
!699 = metadata !{i32 53, i32 37, metadata !676, null}
!700 = metadata !{i32 78, i32 1, metadata !664, null}
!701 = metadata !{i32 786689, metadata !168, metadata !"imINPUT", metadata !161, i32 16777298, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!702 = metadata !{i32 82, i32 30, metadata !168, null}
!703 = metadata !{i32 786689, metadata !168, metadata !"imOUTPUT", metadata !161, i32 33554515, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!704 = metadata !{i32 83, i32 7, metadata !168, null}
!705 = metadata !{i32 786689, metadata !168, metadata !"imHeight", metadata !161, i32 50331731, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!706 = metadata !{i32 83, i32 33, metadata !168, null}
!707 = metadata !{i32 786689, metadata !168, metadata !"imWidth", metadata !161, i32 67108947, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!708 = metadata !{i32 83, i32 47, metadata !168, null}
!709 = metadata !{i32 786689, metadata !168, metadata !"newMax", metadata !161, i32 83886164, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!710 = metadata !{i32 84, i32 7, metadata !168, null}
!711 = metadata !{i32 786689, metadata !168, metadata !"newMin", metadata !161, i32 100663380, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!712 = metadata !{i32 84, i32 19, metadata !168, null}
!713 = metadata !{i32 84, i32 28, metadata !714, null}
!714 = metadata !{i32 786443, metadata !168, i32 84, i32 27, metadata !161, i32 6} ; [ DW_TAG_lexical_block ]
!715 = metadata !{i32 84, i32 65, metadata !714, null}
!716 = metadata !{i32 786688, metadata !714, metadata !"row", metadata !161, i32 94, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!717 = metadata !{i32 94, i32 8, metadata !714, null}
!718 = metadata !{i32 786688, metadata !714, metadata !"col", metadata !161, i32 95, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!719 = metadata !{i32 95, i32 8, metadata !714, null}
!720 = metadata !{i32 786688, metadata !714, metadata !"max", metadata !161, i32 96, metadata !721, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!721 = metadata !{i32 786454, null, metadata !"int8", metadata !161, i32 10, i64 0, i64 0, i64 0, i32 0, metadata !722} ; [ DW_TAG_typedef ]
!722 = metadata !{i32 786468, null, metadata !"int8", null, i32 0, i64 8, i64 8, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!723 = metadata !{i32 96, i32 7, metadata !714, null}
!724 = metadata !{i32 96, i32 37, metadata !714, null}
!725 = metadata !{i32 786688, metadata !714, metadata !"min", metadata !161, i32 97, metadata !721, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!726 = metadata !{i32 97, i32 7, metadata !714, null}
!727 = metadata !{i32 97, i32 16, metadata !714, null}
!728 = metadata !{i32 786688, metadata !714, metadata !"newValue", metadata !161, i32 98, metadata !721, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!729 = metadata !{i32 98, i32 7, metadata !714, null}
!730 = metadata !{i32 98, i32 15, metadata !714, null}
!731 = metadata !{i32 100, i32 12, metadata !732, null}
!732 = metadata !{i32 786443, metadata !714, i32 100, i32 7, metadata !161, i32 7} ; [ DW_TAG_lexical_block ]
!733 = metadata !{i32 100, i32 45, metadata !734, null}
!734 = metadata !{i32 786443, metadata !732, i32 100, i32 44, metadata !161, i32 8} ; [ DW_TAG_lexical_block ]
!735 = metadata !{i32 101, i32 1, metadata !734, null}
!736 = metadata !{i32 102, i32 12, metadata !737, null}
!737 = metadata !{i32 786443, metadata !734, i32 102, i32 7, metadata !161, i32 9} ; [ DW_TAG_lexical_block ]
!738 = metadata !{i32 102, i32 44, metadata !739, null}
!739 = metadata !{i32 786443, metadata !737, i32 102, i32 43, metadata !161, i32 10} ; [ DW_TAG_lexical_block ]
!740 = metadata !{i32 103, i32 1, metadata !739, null}
!741 = metadata !{i32 106, i32 1, metadata !739, null}
!742 = metadata !{i32 113, i32 2, metadata !739, null}
!743 = metadata !{i32 114, i32 5, metadata !744, null}
!744 = metadata !{i32 786443, metadata !739, i32 113, i32 46, metadata !161, i32 11} ; [ DW_TAG_lexical_block ]
!745 = metadata !{i32 115, i32 4, metadata !744, null}
!746 = metadata !{i32 116, i32 4, metadata !739, null}
!747 = metadata !{i32 117, i32 5, metadata !748, null}
!748 = metadata !{i32 786443, metadata !739, i32 116, i32 48, metadata !161, i32 12} ; [ DW_TAG_lexical_block ]
!749 = metadata !{i32 118, i32 4, metadata !748, null}
!750 = metadata !{i32 119, i32 3, metadata !739, null}
!751 = metadata !{i32 102, i32 36, metadata !737, null}
!752 = metadata !{i32 121, i32 2, metadata !734, null}
!753 = metadata !{i32 100, i32 37, metadata !732, null}
!754 = metadata !{i32 121, i32 2, metadata !732, null}
!755 = metadata !{i32 123, i32 12, metadata !756, null}
!756 = metadata !{i32 786443, metadata !714, i32 123, i32 7, metadata !161, i32 13} ; [ DW_TAG_lexical_block ]
!757 = metadata !{i32 123, i32 45, metadata !758, null}
!758 = metadata !{i32 786443, metadata !756, i32 123, i32 44, metadata !161, i32 14} ; [ DW_TAG_lexical_block ]
!759 = metadata !{i32 124, i32 1, metadata !758, null}
!760 = metadata !{i32 125, i32 12, metadata !761, null}
!761 = metadata !{i32 786443, metadata !758, i32 125, i32 7, metadata !161, i32 15} ; [ DW_TAG_lexical_block ]
!762 = metadata !{i32 125, i32 44, metadata !763, null}
!763 = metadata !{i32 786443, metadata !761, i32 125, i32 43, metadata !161, i32 16} ; [ DW_TAG_lexical_block ]
!764 = metadata !{i32 126, i32 1, metadata !763, null}
!765 = metadata !{i32 129, i32 1, metadata !763, null}
!766 = metadata !{i32 136, i32 2, metadata !763, null}
!767 = metadata !{i32 138, i32 4, metadata !763, null}
!768 = metadata !{i32 140, i32 3, metadata !763, null}
!769 = metadata !{i32 125, i32 36, metadata !761, null}
!770 = metadata !{i32 141, i32 2, metadata !758, null}
!771 = metadata !{i32 123, i32 37, metadata !756, null}
!772 = metadata !{i32 143, i32 1, metadata !714, null}
!773 = metadata !{i32 786689, metadata !171, metadata !"imINPUT", metadata !161, i32 16777361, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!774 = metadata !{i32 145, i32 17, metadata !171, null}
!775 = metadata !{i32 786689, metadata !171, metadata !"imHeight", metadata !161, i32 33554577, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!776 = metadata !{i32 145, i32 42, metadata !171, null}
!777 = metadata !{i32 786689, metadata !171, metadata !"imWidth", metadata !161, i32 50331793, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!778 = metadata !{i32 145, i32 56, metadata !171, null}
!779 = metadata !{i32 786689, metadata !171, metadata !"tplINPUT", metadata !161, i32 67109010, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!780 = metadata !{i32 146, i32 7, metadata !171, null}
!781 = metadata !{i32 786689, metadata !171, metadata !"tplHeight", metadata !161, i32 83886226, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!782 = metadata !{i32 146, i32 33, metadata !171, null}
!783 = metadata !{i32 786689, metadata !171, metadata !"tplWidth", metadata !161, i32 100663443, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!784 = metadata !{i32 147, i32 7, metadata !171, null}
!785 = metadata !{i32 786689, metadata !171, metadata !"output_struct", metadata !161, i32 117440659, metadata !174, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!786 = metadata !{i32 147, i32 24, metadata !171, null}
!787 = metadata !{i32 147, i32 40, metadata !788, null}
!788 = metadata !{i32 786443, metadata !171, i32 147, i32 39, metadata !161, i32 17} ; [ DW_TAG_lexical_block ]
!789 = metadata !{i32 147, i32 77, metadata !788, null}
!790 = metadata !{i32 786688, metadata !788, metadata !"row_img", metadata !161, i32 148, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!791 = metadata !{i32 148, i32 8, metadata !788, null}
!792 = metadata !{i32 786688, metadata !788, metadata !"row_tpl", metadata !161, i32 148, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!793 = metadata !{i32 148, i32 17, metadata !788, null}
!794 = metadata !{i32 786688, metadata !788, metadata !"col_img", metadata !161, i32 149, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!795 = metadata !{i32 149, i32 8, metadata !788, null}
!796 = metadata !{i32 786688, metadata !788, metadata !"col_tpl", metadata !161, i32 149, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!797 = metadata !{i32 149, i32 17, metadata !788, null}
!798 = metadata !{i32 786688, metadata !788, metadata !"search_img", metadata !161, i32 150, metadata !721, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!799 = metadata !{i32 150, i32 7, metadata !788, null}
!800 = metadata !{i32 786688, metadata !788, metadata !"template_img", metadata !161, i32 150, metadata !721, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!801 = metadata !{i32 150, i32 19, metadata !788, null}
!802 = metadata !{i32 786688, metadata !788, metadata !"SAD", metadata !161, i32 151, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!803 = metadata !{i32 151, i32 6, metadata !788, null}
!804 = metadata !{i32 786688, metadata !788, metadata !"minSAD", metadata !161, i32 151, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!805 = metadata !{i32 151, i32 11, metadata !788, null}
!806 = metadata !{i32 160, i32 2, metadata !788, null}
!807 = metadata !{i32 161, i32 12, metadata !808, null}
!808 = metadata !{i32 786443, metadata !788, i32 161, i32 7, metadata !161, i32 18} ; [ DW_TAG_lexical_block ]
!809 = metadata !{i32 161, i32 69, metadata !810, null}
!810 = metadata !{i32 786443, metadata !808, i32 161, i32 68, metadata !161, i32 19} ; [ DW_TAG_lexical_block ]
!811 = metadata !{i32 163, i32 1, metadata !810, null}
!812 = metadata !{i32 164, i32 12, metadata !813, null}
!813 = metadata !{i32 786443, metadata !810, i32 164, i32 7, metadata !161, i32 20} ; [ DW_TAG_lexical_block ]
!814 = metadata !{i32 164, i32 67, metadata !815, null}
!815 = metadata !{i32 786443, metadata !813, i32 164, i32 66, metadata !161, i32 21} ; [ DW_TAG_lexical_block ]
!816 = metadata !{i32 165, i32 1, metadata !815, null}
!817 = metadata !{i32 166, i32 2, metadata !815, null}
!818 = metadata !{i32 167, i32 14, metadata !819, null}
!819 = metadata !{i32 786443, metadata !815, i32 167, i32 9, metadata !161, i32 22} ; [ DW_TAG_lexical_block ]
!820 = metadata !{i32 167, i32 60, metadata !821, null}
!821 = metadata !{i32 786443, metadata !819, i32 167, i32 59, metadata !161, i32 23} ; [ DW_TAG_lexical_block ]
!822 = metadata !{i32 169, i32 1, metadata !821, null}
!823 = metadata !{i32 170, i32 12, metadata !824, null}
!824 = metadata !{i32 786443, metadata !821, i32 170, i32 7, metadata !161, i32 24} ; [ DW_TAG_lexical_block ]
!825 = metadata !{i32 170, i32 57, metadata !826, null}
!826 = metadata !{i32 786443, metadata !824, i32 170, i32 56, metadata !161, i32 25} ; [ DW_TAG_lexical_block ]
!827 = metadata !{i32 171, i32 1, metadata !826, null}
!828 = metadata !{i32 174, i32 1, metadata !826, null}
!829 = metadata !{i32 175, i32 1, metadata !826, null}
!830 = metadata !{i32 184, i32 2, metadata !826, null}
!831 = metadata !{i32 186, i32 6, metadata !826, null}
!832 = metadata !{i32 188, i32 13, metadata !826, null}
!833 = metadata !{i32 189, i32 5, metadata !826, null}
!834 = metadata !{i32 170, i32 45, metadata !824, null}
!835 = metadata !{i32 190, i32 4, metadata !821, null}
!836 = metadata !{i32 167, i32 48, metadata !819, null}
!837 = metadata !{i32 191, i32 4, metadata !815, null}
!838 = metadata !{i32 192, i32 5, metadata !839, null}
!839 = metadata !{i32 786443, metadata !815, i32 191, i32 37, metadata !161, i32 26} ; [ DW_TAG_lexical_block ]
!840 = metadata !{i32 193, i32 5, metadata !839, null}
!841 = metadata !{i32 194, i32 5, metadata !839, null}
!842 = metadata !{i32 195, i32 5, metadata !839, null}
!843 = metadata !{i32 196, i32 4, metadata !839, null}
!844 = metadata !{i32 197, i32 3, metadata !815, null}
!845 = metadata !{i32 164, i32 55, metadata !813, null}
!846 = metadata !{i32 198, i32 2, metadata !810, null}
!847 = metadata !{i32 161, i32 57, metadata !808, null}
!848 = metadata !{i32 200, i32 1, metadata !788, null}
!849 = metadata !{i32 786689, metadata !183, metadata !"imOUTPUT", metadata !161, i32 16777418, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!850 = metadata !{i32 202, i32 33, metadata !183, null}
!851 = metadata !{i32 786689, metadata !183, metadata !"imHeight", metadata !161, i32 33554634, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!852 = metadata !{i32 202, i32 59, metadata !183, null}
!853 = metadata !{i32 786689, metadata !183, metadata !"imWidth", metadata !161, i32 50331851, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!854 = metadata !{i32 203, i32 7, metadata !183, null}
!855 = metadata !{i32 786689, metadata !183, metadata !"tplINPUT", metadata !161, i32 67109067, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!856 = metadata !{i32 203, i32 20, metadata !183, null}
!857 = metadata !{i32 786689, metadata !183, metadata !"tplHeight", metadata !161, i32 83886283, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!858 = metadata !{i32 203, i32 46, metadata !183, null}
!859 = metadata !{i32 786689, metadata !183, metadata !"tplWidth", metadata !161, i32 100663500, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!860 = metadata !{i32 204, i32 7, metadata !183, null}
!861 = metadata !{i32 786689, metadata !183, metadata !"output_struct", metadata !161, i32 117440716, metadata !174, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!862 = metadata !{i32 204, i32 24, metadata !183, null}
!863 = metadata !{i32 204, i32 40, metadata !864, null}
!864 = metadata !{i32 786443, metadata !183, i32 204, i32 39, metadata !161, i32 27} ; [ DW_TAG_lexical_block ]
!865 = metadata !{i32 204, i32 78, metadata !864, null}
!866 = metadata !{i32 786688, metadata !864, metadata !"row", metadata !161, i32 206, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!867 = metadata !{i32 206, i32 8, metadata !864, null}
!868 = metadata !{i32 786688, metadata !864, metadata !"col", metadata !161, i32 207, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!869 = metadata !{i32 207, i32 8, metadata !864, null}
!870 = metadata !{i32 786688, metadata !864, metadata !"row_offset", metadata !161, i32 208, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!871 = metadata !{i32 208, i32 8, metadata !864, null}
!872 = metadata !{i32 208, i32 37, metadata !864, null}
!873 = metadata !{i32 786688, metadata !864, metadata !"col_offset", metadata !161, i32 209, metadata !179, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!874 = metadata !{i32 209, i32 8, metadata !864, null}
!875 = metadata !{i32 209, i32 37, metadata !864, null}
!876 = metadata !{i32 211, i32 13, metadata !877, null}
!877 = metadata !{i32 786443, metadata !864, i32 211, i32 8, metadata !161, i32 28} ; [ DW_TAG_lexical_block ]
!878 = metadata !{i32 211, i32 47, metadata !879, null}
!879 = metadata !{i32 786443, metadata !877, i32 211, i32 46, metadata !161, i32 29} ; [ DW_TAG_lexical_block ]
!880 = metadata !{i32 212, i32 1, metadata !879, null}
!881 = metadata !{i32 213, i32 13, metadata !882, null}
!882 = metadata !{i32 786443, metadata !879, i32 213, i32 8, metadata !161, i32 30} ; [ DW_TAG_lexical_block ]
!883 = metadata !{i32 213, i32 46, metadata !884, null}
!884 = metadata !{i32 786443, metadata !882, i32 213, i32 45, metadata !161, i32 31} ; [ DW_TAG_lexical_block ]
!885 = metadata !{i32 214, i32 1, metadata !884, null}
!886 = metadata !{i32 215, i32 2, metadata !884, null}
!887 = metadata !{i32 216, i32 3, metadata !884, null}
!888 = metadata !{i32 213, i32 38, metadata !882, null}
!889 = metadata !{i32 218, i32 2, metadata !879, null}
!890 = metadata !{i32 211, i32 39, metadata !877, null}
!891 = metadata !{i32 219, i32 1, metadata !864, null}
!892 = metadata !{i32 786689, metadata !184, metadata !"imINPUT", metadata !161, i32 16777437, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!893 = metadata !{i32 221, i32 29, metadata !184, null}
!894 = metadata !{i32 786689, metadata !184, metadata !"imOUTPUT", metadata !161, i32 33554654, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!895 = metadata !{i32 222, i32 7, metadata !184, null}
!896 = metadata !{i32 786689, metadata !184, metadata !"imHeight", metadata !161, i32 50331870, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!897 = metadata !{i32 222, i32 33, metadata !184, null}
!898 = metadata !{i32 786689, metadata !184, metadata !"imWidth", metadata !161, i32 67109086, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!899 = metadata !{i32 222, i32 47, metadata !184, null}
!900 = metadata !{i32 786689, metadata !184, metadata !"tplINPUT", metadata !161, i32 83886303, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!901 = metadata !{i32 223, i32 7, metadata !184, null}
!902 = metadata !{i32 786689, metadata !184, metadata !"tplOUTPUT", metadata !161, i32 100663520, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!903 = metadata !{i32 224, i32 7, metadata !184, null}
!904 = metadata !{i32 786689, metadata !184, metadata !"tplHeight", metadata !161, i32 117440736, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!905 = metadata !{i32 224, i32 34, metadata !184, null}
!906 = metadata !{i32 786689, metadata !184, metadata !"tplWidth", metadata !161, i32 134217953, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!907 = metadata !{i32 225, i32 7, metadata !184, null}
!908 = metadata !{i32 225, i32 18, metadata !909, null}
!909 = metadata !{i32 786443, metadata !184, i32 225, i32 17, metadata !161, i32 32} ; [ DW_TAG_lexical_block ]
!910 = metadata !{i32 225, i32 55, metadata !909, null}
!911 = metadata !{i32 225, i32 93, metadata !909, null}
!912 = metadata !{i32 225, i32 132, metadata !909, null}
!913 = metadata !{i32 229, i32 1, metadata !909, null}
!914 = metadata !{i32 786688, metadata !909, metadata !"template_match_position", metadata !161, i32 238, metadata !175, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!915 = metadata !{i32 238, i32 8, metadata !909, null}
!916 = metadata !{i32 240, i32 2, metadata !909, null}
!917 = metadata !{i32 241, i32 2, metadata !909, null}
!918 = metadata !{i32 242, i32 2, metadata !909, null}
!919 = metadata !{i32 243, i32 2, metadata !909, null}
!920 = metadata !{i32 246, i32 2, metadata !909, null}
!921 = metadata !{i32 248, i32 2, metadata !909, null}
!922 = metadata !{i32 251, i32 1, metadata !909, null}
