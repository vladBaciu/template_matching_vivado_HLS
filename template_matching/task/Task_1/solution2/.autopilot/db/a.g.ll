...
@.str122 = private unnamed_addr constant [4 x i8] c"L00\00", align 1 ; [#uses=1 type=[4 x i8]*]
...
@.str1334 = private unnamed_addr constant [12 x i8] c"field_level\00", align 1 ; [#uses=1 type=[12 x i8]*]
...
define void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, i32 %imVersion) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !664 ; [debug line = 21:1]
  call void @llvm.dbg.declare(metadata !{i32* %row}, metadata !665), !dbg !666 ; [debug line = 24:6] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i32* %col}, metadata !667), !dbg !668 ; [debug line = 25:6] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i8* %gray_pixel}, metadata !669), !dbg !670 ; [debug line = 26:16] [debug variable = gray_pixel]
  br label %8, !dbg !671                          ; [debug line = 26:26]

; <label>:8                                       ; preds = %0
  store i32 0, i32* %row, align 4, !dbg !672      ; [debug line = 29:12]
  br label %9, !dbg !672                          ; [debug line = 29:12]

; <label>:9                                       ; preds = %165, %8
  %10 = load i32* %row, align 4, !dbg !672        ; [#uses=1 type=i32] [debug line = 29:12]
  %11 = load i32* %3, align 4, !dbg !672          ; [#uses=1 type=i32] [debug line = 29:12]
  %12 = icmp slt i32 %10, %11, !dbg !672          ; [#uses=1 type=i1] [debug line = 29:12]
  br i1 %12, label %13, label %168, !dbg !672     ; [debug line = 29:12]

; <label>:13                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !674 ; [debug line = 29:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !674 ; [debug line = 29:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !676 ; [debug line = 30:1]
  br label %14, !dbg !676                         ; [debug line = 30:1]

; <label>:14                                      ; preds = %13
  store i32 0, i32* %col, align 4, !dbg !677      ; [debug line = 31:12]
  br label %15, !dbg !677                         ; [debug line = 31:12]

; <label>:15                                      ; preds = %161, %14
  %16 = load i32* %col, align 4, !dbg !677        ; [#uses=1 type=i32] [debug line = 31:12]
  %17 = load i32* %4, align 4, !dbg !677          ; [#uses=1 type=i32] [debug line = 31:12]
  %18 = icmp slt i32 %16, %17, !dbg !677          ; [#uses=1 type=i1] [debug line = 31:12]
  br i1 %18, label %19, label %164, !dbg !677     ; [debug line = 31:12]

; <label>:19                                      ; preds = %15
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !679 ; [debug line = 31:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !679 ; [debug line = 31:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !681 ; [debug line = 32:1]
  %20 = load i32* %5, align 4, !dbg !682          ; [#uses=1 type=i32] [debug line = 34:2]
  switch i32 %20, label %138 [
    i32 0, label %21
    i32 1, label %60
    i32 2, label %99
  ], !dbg !682                                    ; [debug line = 34:2]

; <label>:21                                      ; preds = %19
  %22 = load i32* %col, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %23 = sext i32 %22 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %24 = load i32* %row, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %25 = sext i32 %24 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %26 = load [1200 x i32]** %1, align 8, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %27 = getelementptr inbounds [1200 x i32]* %26, i64 %25, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %28 = getelementptr inbounds [1200 x i32]* %27, i32 0, i64 %23, !dbg !683 ; [#uses=1 type=i32*] [debug line = 36:5]
  %29 = load i32* %28, align 4, !dbg !683         ; [#uses=1 type=i32] [debug line = 36:5]
  %30 = and i32 %29, 255, !dbg !683               ; [#uses=1 type=i32] [debug line = 36:5]
  %31 = sitofp i32 %30 to double, !dbg !683       ; [#uses=1 type=double] [debug line = 36:5]
  %32 = fmul double 1.140000e-01, %31, !dbg !683  ; [#uses=1 type=double] [debug line = 36:5]
  %33 = load i32* %col, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %34 = sext i32 %33 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %35 = load i32* %row, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %36 = sext i32 %35 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %37 = load [1200 x i32]** %1, align 8, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %38 = getelementptr inbounds [1200 x i32]* %37, i64 %36, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %39 = getelementptr inbounds [1200 x i32]* %38, i32 0, i64 %34, !dbg !683 ; [#uses=1 type=i32*] [debug line = 36:5]
  %40 = load i32* %39, align 4, !dbg !683         ; [#uses=1 type=i32] [debug line = 36:5]
  %41 = and i32 %40, 65280, !dbg !683             ; [#uses=1 type=i32] [debug line = 36:5]
  %42 = ashr i32 %41, 8, !dbg !683                ; [#uses=1 type=i32] [debug line = 36:5]
  %43 = sitofp i32 %42 to double, !dbg !683       ; [#uses=1 type=double] [debug line = 36:5]
  %44 = fmul double 2.990000e-01, %43, !dbg !683  ; [#uses=1 type=double] [debug line = 36:5]
  %45 = fadd double %32, %44, !dbg !683           ; [#uses=1 type=double] [debug line = 36:5]
  %46 = load i32* %col, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %47 = sext i32 %46 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %48 = load i32* %row, align 4, !dbg !683        ; [#uses=1 type=i32] [debug line = 36:5]
  %49 = sext i32 %48 to i64, !dbg !683            ; [#uses=1 type=i64] [debug line = 36:5]
  %50 = load [1200 x i32]** %1, align 8, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %51 = getelementptr inbounds [1200 x i32]* %50, i64 %49, !dbg !683 ; [#uses=1 type=[1200 x i32]*] [debug line = 36:5]
  %52 = getelementptr inbounds [1200 x i32]* %51, i32 0, i64 %47, !dbg !683 ; [#uses=1 type=i32*] [debug line = 36:5]
  %53 = load i32* %52, align 4, !dbg !683         ; [#uses=1 type=i32] [debug line = 36:5]
  %54 = and i32 %53, 16711680, !dbg !683          ; [#uses=1 type=i32] [debug line = 36:5]
  %55 = ashr i32 %54, 16, !dbg !683               ; [#uses=1 type=i32] [debug line = 36:5]
  %56 = sitofp i32 %55 to double, !dbg !683       ; [#uses=1 type=double] [debug line = 36:5]
  %57 = fmul double 5.870000e-01, %56, !dbg !683  ; [#uses=1 type=double] [debug line = 36:5]
  %58 = fadd double %45, %57, !dbg !683           ; [#uses=1 type=double] [debug line = 36:5]
  %59 = fptoui double %58 to i8, !dbg !683        ; [#uses=1 type=i8] [debug line = 36:5]
  store i8 %59, i8* %gray_pixel, align 1, !dbg !683 ; [debug line = 36:5]
  br label %139, !dbg !685                        ; [debug line = 37:5]

; <label>:60                                      ; preds = %19
  %61 = load i32* %col, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %62 = sext i32 %61 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %63 = load i32* %row, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %64 = sext i32 %63 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %65 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %66 = getelementptr inbounds [1200 x i32]* %65, i64 %64, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %67 = getelementptr inbounds [1200 x i32]* %66, i32 0, i64 %62, !dbg !686 ; [#uses=1 type=i32*] [debug line = 39:5]
  %68 = load i32* %67, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 39:5]
  %69 = and i32 %68, 255, !dbg !686               ; [#uses=1 type=i32] [debug line = 39:5]
  %70 = sitofp i32 %69 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 39:5]
  %71 = fmul double 7.720000e-02, %70, !dbg !686  ; [#uses=1 type=double] [debug line = 39:5]
  %72 = load i32* %col, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %73 = sext i32 %72 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %74 = load i32* %row, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %75 = sext i32 %74 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %76 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %77 = getelementptr inbounds [1200 x i32]* %76, i64 %75, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %78 = getelementptr inbounds [1200 x i32]* %77, i32 0, i64 %73, !dbg !686 ; [#uses=1 type=i32*] [debug line = 39:5]
  %79 = load i32* %78, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 39:5]
  %80 = and i32 %79, 65280, !dbg !686             ; [#uses=1 type=i32] [debug line = 39:5]
  %81 = ashr i32 %80, 8, !dbg !686                ; [#uses=1 type=i32] [debug line = 39:5]
  %82 = sitofp i32 %81 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 39:5]
  %83 = fmul double 2.120000e-01, %82, !dbg !686  ; [#uses=1 type=double] [debug line = 39:5]
  %84 = fadd double %71, %83, !dbg !686           ; [#uses=1 type=double] [debug line = 39:5]
  %85 = load i32* %col, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %86 = sext i32 %85 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %87 = load i32* %row, align 4, !dbg !686        ; [#uses=1 type=i32] [debug line = 39:5]
  %88 = sext i32 %87 to i64, !dbg !686            ; [#uses=1 type=i64] [debug line = 39:5]
  %89 = load [1200 x i32]** %1, align 8, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %90 = getelementptr inbounds [1200 x i32]* %89, i64 %88, !dbg !686 ; [#uses=1 type=[1200 x i32]*] [debug line = 39:5]
  %91 = getelementptr inbounds [1200 x i32]* %90, i32 0, i64 %86, !dbg !686 ; [#uses=1 type=i32*] [debug line = 39:5]
  %92 = load i32* %91, align 4, !dbg !686         ; [#uses=1 type=i32] [debug line = 39:5]
  %93 = and i32 %92, 16711680, !dbg !686          ; [#uses=1 type=i32] [debug line = 39:5]
  %94 = ashr i32 %93, 16, !dbg !686               ; [#uses=1 type=i32] [debug line = 39:5]
  %95 = sitofp i32 %94 to double, !dbg !686       ; [#uses=1 type=double] [debug line = 39:5]
  %96 = fmul double 7.150000e-01, %95, !dbg !686  ; [#uses=1 type=double] [debug line = 39:5]
  %97 = fadd double %84, %96, !dbg !686           ; [#uses=1 type=double] [debug line = 39:5]
  %98 = fptoui double %97 to i8, !dbg !686        ; [#uses=1 type=i8] [debug line = 39:5]
  store i8 %98, i8* %gray_pixel, align 1, !dbg !686 ; [debug line = 39:5]
  br label %139, !dbg !687                        ; [debug line = 40:5]

; <label>:99                                      ; preds = %19
  %100 = load i32* %col, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %101 = sext i32 %100 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %102 = load i32* %row, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %103 = sext i32 %102 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %104 = load [1200 x i32]** %1, align 8, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %105 = getelementptr inbounds [1200 x i32]* %104, i64 %103, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %106 = getelementptr inbounds [1200 x i32]* %105, i32 0, i64 %101, !dbg !688 ; [#uses=1 type=i32*] [debug line = 42:5]
  %107 = load i32* %106, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %108 = and i32 %107, 255, !dbg !688             ; [#uses=1 type=i32] [debug line = 42:5]
  %109 = sitofp i32 %108 to double, !dbg !688     ; [#uses=1 type=double] [debug line = 42:5]
  %110 = fmul double 5.900000e-02, %109, !dbg !688 ; [#uses=1 type=double] [debug line = 42:5]
  %111 = load i32* %col, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %112 = sext i32 %111 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %113 = load i32* %row, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %114 = sext i32 %113 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %115 = load [1200 x i32]** %1, align 8, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %116 = getelementptr inbounds [1200 x i32]* %115, i64 %114, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %117 = getelementptr inbounds [1200 x i32]* %116, i32 0, i64 %112, !dbg !688 ; [#uses=1 type=i32*] [debug line = 42:5]
  %118 = load i32* %117, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %119 = and i32 %118, 65280, !dbg !688           ; [#uses=1 type=i32] [debug line = 42:5]
  %120 = ashr i32 %119, 8, !dbg !688              ; [#uses=1 type=i32] [debug line = 42:5]
  %121 = sitofp i32 %120 to double, !dbg !688     ; [#uses=1 type=double] [debug line = 42:5]
  %122 = fmul double 2.620000e-01, %121, !dbg !688 ; [#uses=1 type=double] [debug line = 42:5]
  %123 = fadd double %110, %122, !dbg !688        ; [#uses=1 type=double] [debug line = 42:5]
  %124 = load i32* %col, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %125 = sext i32 %124 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %126 = load i32* %row, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %127 = sext i32 %126 to i64, !dbg !688          ; [#uses=1 type=i64] [debug line = 42:5]
  %128 = load [1200 x i32]** %1, align 8, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %129 = getelementptr inbounds [1200 x i32]* %128, i64 %127, !dbg !688 ; [#uses=1 type=[1200 x i32]*] [debug line = 42:5]
  %130 = getelementptr inbounds [1200 x i32]* %129, i32 0, i64 %125, !dbg !688 ; [#uses=1 type=i32*] [debug line = 42:5]
  %131 = load i32* %130, align 4, !dbg !688       ; [#uses=1 type=i32] [debug line = 42:5]
  %132 = and i32 %131, 16711680, !dbg !688        ; [#uses=1 type=i32] [debug line = 42:5]
  %133 = ashr i32 %132, 16, !dbg !688             ; [#uses=1 type=i32] [debug line = 42:5]
  %134 = sitofp i32 %133 to double, !dbg !688     ; [#uses=1 type=double] [debug line = 42:5]
  %135 = fmul double 6.780000e-01, %134, !dbg !688 ; [#uses=1 type=double] [debug line = 42:5]
  %136 = fadd double %123, %135, !dbg !688        ; [#uses=1 type=double] [debug line = 42:5]
  %137 = fptoui double %136 to i8, !dbg !688      ; [#uses=1 type=i8] [debug line = 42:5]
  store i8 %137, i8* %gray_pixel, align 1, !dbg !688 ; [debug line = 42:5]
  br label %139, !dbg !689                        ; [debug line = 43:5]

; <label>:138                                     ; preds = %19
  store i8 0, i8* %gray_pixel, align 1, !dbg !690 ; [debug line = 45:5]
  br label %139, !dbg !691                        ; [debug line = 46:4]

; <label>:139                                     ; preds = %138, %99, %60, %21
  %140 = load i8* %gray_pixel, align 1, !dbg !692 ; [#uses=1 type=i8] [debug line = 48:4]
  %141 = zext i8 %140 to i32, !dbg !692           ; [#uses=1 type=i32] [debug line = 48:4]
  %142 = shl i32 %141, 24, !dbg !692              ; [#uses=1 type=i32] [debug line = 48:4]
  %143 = load i8* %gray_pixel, align 1, !dbg !692 ; [#uses=1 type=i8] [debug line = 48:4]
  %144 = zext i8 %143 to i32, !dbg !692           ; [#uses=1 type=i32] [debug line = 48:4]
  %145 = shl i32 %144, 16, !dbg !692              ; [#uses=1 type=i32] [debug line = 48:4]
  %146 = add nsw i32 %142, %145, !dbg !692        ; [#uses=1 type=i32] [debug line = 48:4]
  %147 = load i8* %gray_pixel, align 1, !dbg !692 ; [#uses=1 type=i8] [debug line = 48:4]
  %148 = zext i8 %147 to i32, !dbg !692           ; [#uses=1 type=i32] [debug line = 48:4]
  %149 = shl i32 %148, 8, !dbg !692               ; [#uses=1 type=i32] [debug line = 48:4]
  %150 = add nsw i32 %146, %149, !dbg !692        ; [#uses=1 type=i32] [debug line = 48:4]
  %151 = load i8* %gray_pixel, align 1, !dbg !692 ; [#uses=1 type=i8] [debug line = 48:4]
  %152 = zext i8 %151 to i32, !dbg !692           ; [#uses=1 type=i32] [debug line = 48:4]
  %153 = add nsw i32 %150, %152, !dbg !692        ; [#uses=1 type=i32] [debug line = 48:4]
  %154 = load i32* %col, align 4, !dbg !692       ; [#uses=1 type=i32] [debug line = 48:4]
  %155 = sext i32 %154 to i64, !dbg !692          ; [#uses=1 type=i64] [debug line = 48:4]
  %156 = load i32* %row, align 4, !dbg !692       ; [#uses=1 type=i32] [debug line = 48:4]
  %157 = sext i32 %156 to i64, !dbg !692          ; [#uses=1 type=i64] [debug line = 48:4]
  %158 = load [1200 x i32]** %2, align 8, !dbg !692 ; [#uses=1 type=[1200 x i32]*] [debug line = 48:4]
  %159 = getelementptr inbounds [1200 x i32]* %158, i64 %157, !dbg !692 ; [#uses=1 type=[1200 x i32]*] [debug line = 48:4]
  %160 = getelementptr inbounds [1200 x i32]* %159, i32 0, i64 %155, !dbg !692 ; [#uses=1 type=i32*] [debug line = 48:4]
  store i32 %153, i32* %160, align 4, !dbg !692   ; [debug line = 48:4]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str223, i32 0, i32 0)) nounwind, !dbg !693 ; [debug line = 51:3]
  br label %161, !dbg !693                        ; [debug line = 51:3]

; <label>:161                                     ; preds = %139
  %162 = load i32* %col, align 4, !dbg !694       ; [#uses=1 type=i32] [debug line = 31:36]
  %163 = add nsw i32 %162, 1, !dbg !694           ; [#uses=1 type=i32] [debug line = 31:36]
  store i32 %163, i32* %col, align 4, !dbg !694   ; [debug line = 31:36]
  br label %15, !dbg !694                         ; [debug line = 31:36]

; <label>:164                                     ; preds = %15
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str122, i32 0, i32 0)) nounwind, !dbg !695 ; [debug line = 52:2]
  br label %165, !dbg !695                        ; [debug line = 52:2]

; <label>:165                                     ; preds = %164
  %166 = load i32* %row, align 4, !dbg !696       ; [#uses=1 type=i32] [debug line = 29:37]
  %167 = add nsw i32 %166, 1, !dbg !696           ; [#uses=1 type=i32] [debug line = 29:37]
  store i32 %167, i32* %row, align 4, !dbg !696   ; [debug line = 29:37]
  br label %9, !dbg !696                          ; [debug line = 29:37]

; <label>:168                                     ; preds = %9
  ret void, !dbg !697                             ; [debug line = 54:1]
}
...
define void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, i32 %newMax, i32 %newMin) nounwind uwtable {
  ...
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !698), !dbg !699 ; [debug line = 56:30] [debug variable = imINPUT]
  store [1200 x i32]* %imOUTPUT, [1200 x i32]** %2, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %2}, metadata !700), !dbg !701 ; [debug line = 57:7] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !702), !dbg !703 ; [debug line = 57:33] [debug variable = imHeight]
  store i32 %imWidth, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !704), !dbg !705 ; [debug line = 57:47] [debug variable = imWidth]
  store i32 %newMax, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !706), !dbg !707 ; [debug line = 58:7] [debug variable = newMax]
  store i32 %newMin, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !708), !dbg !709 ; [debug line = 58:19] [debug variable = newMin]
  %7 = load [1200 x i32]** %1, align 8, !dbg !710 ; [#uses=1 type=[1200 x i32]*] [debug line = 58:28]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %7, i32 1200) nounwind, !dbg !710 ; [debug line = 58:28]
  %8 = load [1200 x i32]** %2, align 8, !dbg !712 ; [#uses=1 type=[1200 x i32]*] [debug line = 58:65]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !712 ; [debug line = 58:65]
  call void @llvm.dbg.declare(metadata !{i32* %row}, metadata !713), !dbg !714 ; [debug line = 60:6] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i32* %col}, metadata !715), !dbg !716 ; [debug line = 61:6] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i32* %max}, metadata !717), !dbg !718 ; [debug line = 62:6] [debug variable = max]
  %9 = load [1200 x i32]** %1, align 8, !dbg !719 ; [#uses=1 type=[1200 x i32]*] [debug line = 62:36]
  %10 = getelementptr inbounds [1200 x i32]* %9, i64 0, !dbg !719 ; [#uses=1 type=[1200 x i32]*] [debug line = 62:36]
  %11 = getelementptr inbounds [1200 x i32]* %10, i32 0, i64 0, !dbg !719 ; [#uses=1 type=i32*] [debug line = 62:36]
  %12 = load i32* %11, align 4, !dbg !719         ; [#uses=1 type=i32] [debug line = 62:36]
  %13 = and i32 %12, 255, !dbg !719               ; [#uses=1 type=i32] [debug line = 62:36]
  store i32 %13, i32* %max, align 4, !dbg !719    ; [debug line = 62:36]
  call void @llvm.dbg.declare(metadata !{i32* %min}, metadata !720), !dbg !721 ; [debug line = 63:6] [debug variable = min]
  %14 = load i32* %max, align 4, !dbg !722        ; [#uses=1 type=i32] [debug line = 63:15]
  store i32 %14, i32* %min, align 4, !dbg !722    ; [debug line = 63:15]
  call void @llvm.dbg.declare(metadata !{i32* %newValue}, metadata !723), !dbg !724 ; [debug line = 64:6] [debug variable = newValue]
  br label %15, !dbg !725                         ; [debug line = 64:14]

; <label>:15                                      ; preds = %0
  store i32 0, i32* %row, align 4, !dbg !726      ; [debug line = 66:12]
  br label %16, !dbg !726                         ; [debug line = 66:12]

; <label>:16                                      ; preds = %75, %15
  %17 = load i32* %row, align 4, !dbg !726        ; [#uses=1 type=i32] [debug line = 66:12]
  %18 = load i32* %3, align 4, !dbg !726          ; [#uses=1 type=i32] [debug line = 66:12]
  %19 = icmp slt i32 %17, %18, !dbg !726          ; [#uses=1 type=i1] [debug line = 66:12]
  br i1 %19, label %20, label %78, !dbg !726      ; [debug line = 66:12]

; <label>:20                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !728 ; [debug line = 66:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !728 ; [debug line = 66:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !730 ; [debug line = 67:1]
  br label %21, !dbg !730                         ; [debug line = 67:1]

; <label>:21                                      ; preds = %20
  store i32 0, i32* %col, align 4, !dbg !731      ; [debug line = 68:12]
  br label %22, !dbg !731                         ; [debug line = 68:12]

; <label>:22                                      ; preds = %71, %21
  %23 = load i32* %col, align 4, !dbg !731        ; [#uses=1 type=i32] [debug line = 68:12]
  %24 = load i32* %4, align 4, !dbg !731          ; [#uses=1 type=i32] [debug line = 68:12]
  %25 = icmp slt i32 %23, %24, !dbg !731          ; [#uses=1 type=i1] [debug line = 68:12]
  br i1 %25, label %26, label %74, !dbg !731      ; [debug line = 68:12]

; <label>:26                                      ; preds = %22
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !733 ; [debug line = 68:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !733 ; [debug line = 68:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !735 ; [debug line = 69:1]
  %27 = load i32* %col, align 4, !dbg !736        ; [#uses=1 type=i32] [debug line = 71:2]
  %28 = sext i32 %27 to i64, !dbg !736            ; [#uses=1 type=i64] [debug line = 71:2]
  %29 = load i32* %row, align 4, !dbg !736        ; [#uses=1 type=i32] [debug line = 71:2]
  %30 = sext i32 %29 to i64, !dbg !736            ; [#uses=1 type=i64] [debug line = 71:2]
  %31 = load [1200 x i32]** %1, align 8, !dbg !736 ; [#uses=1 type=[1200 x i32]*] [debug line = 71:2]
  %32 = getelementptr inbounds [1200 x i32]* %31, i64 %30, !dbg !736 ; [#uses=1 type=[1200 x i32]*] [debug line = 71:2]
  %33 = getelementptr inbounds [1200 x i32]* %32, i32 0, i64 %28, !dbg !736 ; [#uses=1 type=i32*] [debug line = 71:2]
  %34 = load i32* %33, align 4, !dbg !736         ; [#uses=1 type=i32] [debug line = 71:2]
  %35 = and i32 %34, 255, !dbg !736               ; [#uses=1 type=i32] [debug line = 71:2]
  %36 = load i32* %max, align 4, !dbg !736        ; [#uses=1 type=i32] [debug line = 71:2]
  %37 = icmp sgt i32 %35, %36, !dbg !736          ; [#uses=1 type=i1] [debug line = 71:2]
  br i1 %37, label %38, label %48, !dbg !736      ; [debug line = 71:2]

; <label>:38                                      ; preds = %26
  %39 = load i32* %col, align 4, !dbg !737        ; [#uses=1 type=i32] [debug line = 72:5]
  %40 = sext i32 %39 to i64, !dbg !737            ; [#uses=1 type=i64] [debug line = 72:5]
  %41 = load i32* %row, align 4, !dbg !737        ; [#uses=1 type=i32] [debug line = 72:5]
  %42 = sext i32 %41 to i64, !dbg !737            ; [#uses=1 type=i64] [debug line = 72:5]
  %43 = load [1200 x i32]** %1, align 8, !dbg !737 ; [#uses=1 type=[1200 x i32]*] [debug line = 72:5]
  %44 = getelementptr inbounds [1200 x i32]* %43, i64 %42, !dbg !737 ; [#uses=1 type=[1200 x i32]*] [debug line = 72:5]
  %45 = getelementptr inbounds [1200 x i32]* %44, i32 0, i64 %40, !dbg !737 ; [#uses=1 type=i32*] [debug line = 72:5]
  %46 = load i32* %45, align 4, !dbg !737         ; [#uses=1 type=i32] [debug line = 72:5]
  %47 = and i32 %46, 255, !dbg !737               ; [#uses=1 type=i32] [debug line = 72:5]
  store i32 %47, i32* %max, align 4, !dbg !737    ; [debug line = 72:5]
  br label %48, !dbg !739                         ; [debug line = 73:4]

; <label>:48                                      ; preds = %38, %26
  %49 = load i32* %col, align 4, !dbg !740        ; [#uses=1 type=i32] [debug line = 74:4]
  %50 = sext i32 %49 to i64, !dbg !740            ; [#uses=1 type=i64] [debug line = 74:4]
  %51 = load i32* %row, align 4, !dbg !740        ; [#uses=1 type=i32] [debug line = 74:4]
  %52 = sext i32 %51 to i64, !dbg !740            ; [#uses=1 type=i64] [debug line = 74:4]
  %53 = load [1200 x i32]** %1, align 8, !dbg !740 ; [#uses=1 type=[1200 x i32]*] [debug line = 74:4]
  %54 = getelementptr inbounds [1200 x i32]* %53, i64 %52, !dbg !740 ; [#uses=1 type=[1200 x i32]*] [debug line = 74:4]
  %55 = getelementptr inbounds [1200 x i32]* %54, i32 0, i64 %50, !dbg !740 ; [#uses=1 type=i32*] [debug line = 74:4]
  %56 = load i32* %55, align 4, !dbg !740         ; [#uses=1 type=i32] [debug line = 74:4]
  %57 = and i32 %56, 255, !dbg !740               ; [#uses=1 type=i32] [debug line = 74:4]
  %58 = load i32* %min, align 4, !dbg !740        ; [#uses=1 type=i32] [debug line = 74:4]
  %59 = icmp slt i32 %57, %58, !dbg !740          ; [#uses=1 type=i1] [debug line = 74:4]
  br i1 %59, label %60, label %70, !dbg !740      ; [debug line = 74:4]

; <label>:60                                      ; preds = %48
  %61 = load i32* %col, align 4, !dbg !741        ; [#uses=1 type=i32] [debug line = 75:5]
  %62 = sext i32 %61 to i64, !dbg !741            ; [#uses=1 type=i64] [debug line = 75:5]
  %63 = load i32* %row, align 4, !dbg !741        ; [#uses=1 type=i32] [debug line = 75:5]
  %64 = sext i32 %63 to i64, !dbg !741            ; [#uses=1 type=i64] [debug line = 75:5]
  %65 = load [1200 x i32]** %1, align 8, !dbg !741 ; [#uses=1 type=[1200 x i32]*] [debug line = 75:5]
  %66 = getelementptr inbounds [1200 x i32]* %65, i64 %64, !dbg !741 ; [#uses=1 type=[1200 x i32]*] [debug line = 75:5]
  %67 = getelementptr inbounds [1200 x i32]* %66, i32 0, i64 %62, !dbg !741 ; [#uses=1 type=i32*] [debug line = 75:5]
  %68 = load i32* %67, align 4, !dbg !741         ; [#uses=1 type=i32] [debug line = 75:5]
  %69 = and i32 %68, 255, !dbg !741               ; [#uses=1 type=i32] [debug line = 75:5]
  store i32 %69, i32* %min, align 4, !dbg !741    ; [debug line = 75:5]
  br label %70, !dbg !743                         ; [debug line = 76:4]

; <label>:70                                      ; preds = %60, %48
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str425, i32 0, i32 0)) nounwind, !dbg !744 ; [debug line = 77:3]
  br label %71, !dbg !744                         ; [debug line = 77:3]

; <label>:71                                      ; preds = %70
  %72 = load i32* %col, align 4, !dbg !745        ; [#uses=1 type=i32] [debug line = 68:36]
  %73 = add nsw i32 %72, 1, !dbg !745             ; [#uses=1 type=i32] [debug line = 68:36]
  store i32 %73, i32* %col, align 4, !dbg !745    ; [debug line = 68:36]
  br label %22, !dbg !745                         ; [debug line = 68:36]

; <label>:74                                      ; preds = %22
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str324, i32 0, i32 0)) nounwind, !dbg !746 ; [debug line = 79:2]
  br label %75, !dbg !746                         ; [debug line = 79:2]

; <label>:75                                      ; preds = %74
  %76 = load i32* %row, align 4, !dbg !747        ; [#uses=1 type=i32] [debug line = 66:37]
  %77 = add nsw i32 %76, 1, !dbg !747             ; [#uses=1 type=i32] [debug line = 66:37]
  store i32 %77, i32* %row, align 4, !dbg !747    ; [debug line = 66:37]
  br label %16, !dbg !747                         ; [debug line = 66:37]

; <label>:78                                      ; preds = %16
  br label %79, !dbg !748                         ; [debug line = 79:2]

; <label>:79                                      ; preds = %78
  store i32 0, i32* %row, align 4, !dbg !749      ; [debug line = 81:12]
  br label %80, !dbg !749                         ; [debug line = 81:12]

; <label>:80                                      ; preds = %137, %79
  %81 = load i32* %row, align 4, !dbg !749        ; [#uses=1 type=i32] [debug line = 81:12]
  %82 = load i32* %3, align 4, !dbg !749          ; [#uses=1 type=i32] [debug line = 81:12]
  %83 = icmp slt i32 %81, %82, !dbg !749          ; [#uses=1 type=i1] [debug line = 81:12]
  br i1 %83, label %84, label %140, !dbg !749     ; [debug line = 81:12]

; <label>:84                                      ; preds = %80
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !751 ; [debug line = 81:45]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !751 ; [debug line = 81:45]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !753 ; [debug line = 82:1]
  br label %85, !dbg !753                         ; [debug line = 82:1]

; <label>:85                                      ; preds = %84
  store i32 0, i32* %col, align 4, !dbg !754      ; [debug line = 83:12]
  br label %86, !dbg !754                         ; [debug line = 83:12]

; <label>:86                                      ; preds = %133, %85
  %87 = load i32* %col, align 4, !dbg !754        ; [#uses=1 type=i32] [debug line = 83:12]
  %88 = load i32* %4, align 4, !dbg !754          ; [#uses=1 type=i32] [debug line = 83:12]
  %89 = icmp slt i32 %87, %88, !dbg !754          ; [#uses=1 type=i1] [debug line = 83:12]
  br i1 %89, label %90, label %136, !dbg !754     ; [debug line = 83:12]

; <label>:90                                      ; preds = %86
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !756 ; [debug line = 83:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !756 ; [debug line = 83:44]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1200, i32 600, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !758 ; [debug line = 84:1]
  %91 = load i32* %col, align 4, !dbg !759        ; [#uses=1 type=i32] [debug line = 86:2]
  %92 = sext i32 %91 to i64, !dbg !759            ; [#uses=1 type=i64] [debug line = 86:2]
  %93 = load i32* %row, align 4, !dbg !759        ; [#uses=1 type=i32] [debug line = 86:2]
  %94 = sext i32 %93 to i64, !dbg !759            ; [#uses=1 type=i64] [debug line = 86:2]
  %95 = load [1200 x i32]** %1, align 8, !dbg !759 ; [#uses=1 type=[1200 x i32]*] [debug line = 86:2]
  %96 = getelementptr inbounds [1200 x i32]* %95, i64 %94, !dbg !759 ; [#uses=1 type=[1200 x i32]*] [debug line = 86:2]
  %97 = getelementptr inbounds [1200 x i32]* %96, i32 0, i64 %92, !dbg !759 ; [#uses=1 type=i32*] [debug line = 86:2]
  %98 = load i32* %97, align 4, !dbg !759         ; [#uses=1 type=i32] [debug line = 86:2]
  %99 = and i32 %98, 255, !dbg !759               ; [#uses=1 type=i32] [debug line = 86:2]
  %100 = load i32* %min, align 4, !dbg !759       ; [#uses=1 type=i32] [debug line = 86:2]
  %101 = sub nsw i32 %99, %100, !dbg !759         ; [#uses=1 type=i32] [debug line = 86:2]
  %102 = load i32* %5, align 4, !dbg !759         ; [#uses=1 type=i32] [debug line = 86:2]
  %103 = load i32* %6, align 4, !dbg !759         ; [#uses=1 type=i32] [debug line = 86:2]
  %104 = sub nsw i32 %102, %103, !dbg !759        ; [#uses=1 type=i32] [debug line = 86:2]
  %105 = mul nsw i32 %101, %104, !dbg !759        ; [#uses=1 type=i32] [debug line = 86:2]
  %106 = sitofp i32 %105 to double, !dbg !759     ; [#uses=1 type=double] [debug line = 86:2]
  %107 = load i32* %max, align 4, !dbg !759       ; [#uses=1 type=i32] [debug line = 86:2]
  %108 = load i32* %min, align 4, !dbg !759       ; [#uses=1 type=i32] [debug line = 86:2]
  %109 = sub nsw i32 %107, %108, !dbg !759        ; [#uses=1 type=i32] [debug line = 86:2]
  %110 = sitofp i32 %109 to double, !dbg !759     ; [#uses=1 type=double] [debug line = 86:2]
  %111 = fdiv double %106, %110, !dbg !759        ; [#uses=1 type=double] [debug line = 86:2]
  %112 = load i32* %6, align 4, !dbg !759         ; [#uses=1 type=i32] [debug line = 86:2]
  %113 = sitofp i32 %112 to double, !dbg !759     ; [#uses=1 type=double] [debug line = 86:2]
  %114 = fadd double %111, %113, !dbg !759        ; [#uses=1 type=double] [debug line = 86:2]
  %115 = fptosi double %114 to i32, !dbg !759     ; [#uses=1 type=i32] [debug line = 86:2]
  store i32 %115, i32* %newValue, align 4, !dbg !759 ; [debug line = 86:2]
  %116 = load i32* %newValue, align 4, !dbg !760  ; [#uses=1 type=i32] [debug line = 88:4]
  %117 = shl i32 %116, 24, !dbg !760              ; [#uses=1 type=i32] [debug line = 88:4]
  %118 = load i32* %newValue, align 4, !dbg !760  ; [#uses=1 type=i32] [debug line = 88:4]
  %119 = shl i32 %118, 16, !dbg !760              ; [#uses=1 type=i32] [debug line = 88:4]
  %120 = add nsw i32 %117, %119, !dbg !760        ; [#uses=1 type=i32] [debug line = 88:4]
  %121 = load i32* %newValue, align 4, !dbg !760  ; [#uses=1 type=i32] [debug line = 88:4]
  %122 = shl i32 %121, 8, !dbg !760               ; [#uses=1 type=i32] [debug line = 88:4]
  %123 = add nsw i32 %120, %122, !dbg !760        ; [#uses=1 type=i32] [debug line = 88:4]
  %124 = load i32* %newValue, align 4, !dbg !760  ; [#uses=1 type=i32] [debug line = 88:4]
  %125 = add nsw i32 %123, %124, !dbg !760        ; [#uses=1 type=i32] [debug line = 88:4]
  %126 = load i32* %col, align 4, !dbg !760       ; [#uses=1 type=i32] [debug line = 88:4]
  %127 = sext i32 %126 to i64, !dbg !760          ; [#uses=1 type=i64] [debug line = 88:4]
  %128 = load i32* %row, align 4, !dbg !760       ; [#uses=1 type=i32] [debug line = 88:4]
  %129 = sext i32 %128 to i64, !dbg !760          ; [#uses=1 type=i64] [debug line = 88:4]
  %130 = load [1200 x i32]** %2, align 8, !dbg !760 ; [#uses=1 type=[1200 x i32]*] [debug line = 88:4]
  %131 = getelementptr inbounds [1200 x i32]* %130, i64 %129, !dbg !760 ; [#uses=1 type=[1200 x i32]*] [debug line = 88:4]
  %132 = getelementptr inbounds [1200 x i32]* %131, i32 0, i64 %127, !dbg !760 ; [#uses=1 type=i32*] [debug line = 88:4]
  store i32 %125, i32* %132, align 4, !dbg !760   ; [debug line = 88:4]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str627, i32 0, i32 0)) nounwind, !dbg !761 ; [debug line = 90:3]
  br label %133, !dbg !761                        ; [debug line = 90:3]

; <label>:133                                     ; preds = %90
  %134 = load i32* %col, align 4, !dbg !762       ; [#uses=1 type=i32] [debug line = 83:36]
  %135 = add nsw i32 %134, 1, !dbg !762           ; [#uses=1 type=i32] [debug line = 83:36]
  store i32 %135, i32* %col, align 4, !dbg !762   ; [debug line = 83:36]
  br label %86, !dbg !762                         ; [debug line = 83:36]

; <label>:136                                     ; preds = %86
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str526, i32 0, i32 0)) nounwind, !dbg !763 ; [debug line = 91:2]
  br label %137, !dbg !763                        ; [debug line = 91:2]

; <label>:137                                     ; preds = %136
  %138 = load i32* %row, align 4, !dbg !764       ; [#uses=1 type=i32] [debug line = 81:37]
  %139 = add nsw i32 %138, 1, !dbg !764           ; [#uses=1 type=i32] [debug line = 81:37]
  store i32 %139, i32* %row, align 4, !dbg !764   ; [debug line = 81:37]
  br label %80, !dbg !764                         ; [debug line = 81:37]

; <label>:140                                     ; preds = %80
  ret void, !dbg !765                             ; [debug line = 93:1]
}
...
define void @_Z6imDiffPA1200_iiiS0_iiP5t_SAD([1200 x i32]* %imINPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, i32 %tplHeight, i32 %tplWidth, %struct.t_SAD* %output_struct) nounwind uwtable {
  ...
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !766), !dbg !767 ; [debug line = 95:17] [debug variable = imINPUT]
  store i32 %imHeight, i32* %2, align 4
  call void @llvm.dbg.declare(metadata !{i32* %2}, metadata !768), !dbg !769 ; [debug line = 95:42] [debug variable = imHeight]
  store i32 %imWidth, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !770), !dbg !771 ; [debug line = 95:56] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %4, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %4}, metadata !772), !dbg !773 ; [debug line = 96:7] [debug variable = tplINPUT]
  store i32 %tplHeight, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !774), !dbg !775 ; [debug line = 96:33] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !776), !dbg !777 ; [debug line = 97:7] [debug variable = tplWidth]
  store %struct.t_SAD* %output_struct, %struct.t_SAD** %7, align 8
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD** %7}, metadata !778), !dbg !779 ; [debug line = 97:24] [debug variable = output_struct]
  %8 = load [1200 x i32]** %1, align 8, !dbg !780 ; [#uses=1 type=[1200 x i32]*] [debug line = 97:40]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !780 ; [debug line = 97:40]
  %9 = load [1200 x i32]** %4, align 8, !dbg !782 ; [#uses=1 type=[1200 x i32]*] [debug line = 97:77]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !782 ; [debug line = 97:77]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !783 ; [debug line = 98:1]
  call void @llvm.dbg.declare(metadata !{i32* %row_img}, metadata !784), !dbg !785 ; [debug line = 99:6] [debug variable = row_img]
  call void @llvm.dbg.declare(metadata !{i32* %row_tpl}, metadata !786), !dbg !787 ; [debug line = 99:15] [debug variable = row_tpl]
  call void @llvm.dbg.declare(metadata !{i32* %col_img}, metadata !788), !dbg !789 ; [debug line = 100:6] [debug variable = col_img]
  call void @llvm.dbg.declare(metadata !{i32* %col_tpl}, metadata !790), !dbg !791 ; [debug line = 100:15] [debug variable = col_tpl]
  call void @llvm.dbg.declare(metadata !{i32* %search_img}, metadata !792), !dbg !793 ; [debug line = 101:6] [debug variable = search_img]
  call void @llvm.dbg.declare(metadata !{i32* %template_img}, metadata !794), !dbg !795 ; [debug line = 101:18] [debug variable = template_img]
  call void @llvm.dbg.declare(metadata !{i32* %SAD}, metadata !796), !dbg !797 ; [debug line = 102:6] [debug variable = SAD]
  call void @llvm.dbg.declare(metadata !{i32* %minSAD}, metadata !798), !dbg !799 ; [debug line = 102:11] [debug variable = minSAD]
  store i32 0, i32* %minSAD, align 4, !dbg !800   ; [debug line = 104:2]
  br label %10, !dbg !800                         ; [debug line = 104:2]

; <label>:10                                      ; preds = %0
  store i32 0, i32* %row_img, align 4, !dbg !801  ; [debug line = 105:12]
  br label %11, !dbg !801                         ; [debug line = 105:12]

; <label>:11                                      ; preds = %96, %10
  %12 = load i32* %row_img, align 4, !dbg !801    ; [#uses=1 type=i32] [debug line = 105:12]
  %13 = load i32* %2, align 4, !dbg !801          ; [#uses=1 type=i32] [debug line = 105:12]
  %14 = load i32* %5, align 4, !dbg !801          ; [#uses=1 type=i32] [debug line = 105:12]
  %15 = sub nsw i32 %13, %14, !dbg !801           ; [#uses=1 type=i32] [debug line = 105:12]
  %16 = icmp slt i32 %12, %15, !dbg !801          ; [#uses=1 type=i1] [debug line = 105:12]
  br i1 %16, label %17, label %99, !dbg !801      ; [debug line = 105:12]

; <label>:17                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !803 ; [debug line = 105:69]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !803 ; [debug line = 105:69]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !805 ; [debug line = 106:1]
  br label %18, !dbg !805                         ; [debug line = 106:1]

; <label>:18                                      ; preds = %17
  store i32 0, i32* %col_img, align 4, !dbg !806  ; [debug line = 107:12]
  br label %19, !dbg !806                         ; [debug line = 107:12]

; <label>:19                                      ; preds = %92, %18
  %20 = load i32* %col_img, align 4, !dbg !806    ; [#uses=1 type=i32] [debug line = 107:12]
  %21 = load i32* %3, align 4, !dbg !806          ; [#uses=1 type=i32] [debug line = 107:12]
  %22 = load i32* %6, align 4, !dbg !806          ; [#uses=1 type=i32] [debug line = 107:12]
  %23 = sub nsw i32 %21, %22, !dbg !806           ; [#uses=1 type=i32] [debug line = 107:12]
  %24 = icmp slt i32 %20, %23, !dbg !806          ; [#uses=1 type=i1] [debug line = 107:12]
  br i1 %24, label %25, label %95, !dbg !806      ; [debug line = 107:12]

; <label>:25                                      ; preds = %19
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !808 ; [debug line = 107:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !808 ; [debug line = 107:67]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1000, i32 500, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !810 ; [debug line = 108:1]
  store i32 0, i32* %SAD, align 4, !dbg !811      ; [debug line = 109:2]
  br label %26, !dbg !811                         ; [debug line = 109:2]

; <label>:26                                      ; preds = %25
  store i32 0, i32* %row_tpl, align 4, !dbg !812  ; [debug line = 110:14]
  br label %27, !dbg !812                         ; [debug line = 110:14]

; <label>:27                                      ; preds = %70, %26
  %28 = load i32* %row_tpl, align 4, !dbg !812    ; [#uses=1 type=i32] [debug line = 110:14]
  %29 = load i32* %5, align 4, !dbg !812          ; [#uses=1 type=i32] [debug line = 110:14]
  %30 = icmp slt i32 %28, %29, !dbg !812          ; [#uses=1 type=i1] [debug line = 110:14]
  br i1 %30, label %31, label %73, !dbg !812      ; [debug line = 110:14]

; <label>:31                                      ; preds = %27
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !814 ; [debug line = 110:60]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !814 ; [debug line = 110:60]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !816 ; [debug line = 112:1]
  br label %32, !dbg !816                         ; [debug line = 112:1]

; <label>:32                                      ; preds = %31
  store i32 0, i32* %col_tpl, align 4, !dbg !817  ; [debug line = 113:12]
  br label %33, !dbg !817                         ; [debug line = 113:12]

; <label>:33                                      ; preds = %66, %32
  %34 = load i32* %col_tpl, align 4, !dbg !817    ; [#uses=1 type=i32] [debug line = 113:12]
  %35 = load i32* %6, align 4, !dbg !817          ; [#uses=1 type=i32] [debug line = 113:12]
  %36 = icmp slt i32 %34, %35, !dbg !817          ; [#uses=1 type=i1] [debug line = 113:12]
  br i1 %36, label %37, label %69, !dbg !817      ; [debug line = 113:12]

; <label>:37                                      ; preds = %33
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !819 ; [debug line = 113:57]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !819 ; [debug line = 113:57]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !821 ; [debug line = 114:1]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 4, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !822 ; [debug line = 115:1]
  %38 = load i32* %col_img, align 4, !dbg !823    ; [#uses=1 type=i32] [debug line = 116:2]
  %39 = load i32* %col_tpl, align 4, !dbg !823    ; [#uses=1 type=i32] [debug line = 116:2]
  %40 = add nsw i32 %38, %39, !dbg !823           ; [#uses=1 type=i32] [debug line = 116:2]
  %41 = sext i32 %40 to i64, !dbg !823            ; [#uses=1 type=i64] [debug line = 116:2]
  %42 = load i32* %row_img, align 4, !dbg !823    ; [#uses=1 type=i32] [debug line = 116:2]
  %43 = load i32* %row_tpl, align 4, !dbg !823    ; [#uses=1 type=i32] [debug line = 116:2]
  %44 = add nsw i32 %42, %43, !dbg !823           ; [#uses=1 type=i32] [debug line = 116:2]
  %45 = sext i32 %44 to i64, !dbg !823            ; [#uses=1 type=i64] [debug line = 116:2]
  %46 = load [1200 x i32]** %1, align 8, !dbg !823 ; [#uses=1 type=[1200 x i32]*] [debug line = 116:2]
  %47 = getelementptr inbounds [1200 x i32]* %46, i64 %45, !dbg !823 ; [#uses=1 type=[1200 x i32]*] [debug line = 116:2]
  %48 = getelementptr inbounds [1200 x i32]* %47, i32 0, i64 %41, !dbg !823 ; [#uses=1 type=i32*] [debug line = 116:2]
  %49 = load i32* %48, align 4, !dbg !823         ; [#uses=1 type=i32] [debug line = 116:2]
  %50 = and i32 %49, 255, !dbg !823               ; [#uses=1 type=i32] [debug line = 116:2]
  store i32 %50, i32* %search_img, align 4, !dbg !823 ; [debug line = 116:2]
  %51 = load i32* %col_tpl, align 4, !dbg !824    ; [#uses=1 type=i32] [debug line = 118:6]
  %52 = sext i32 %51 to i64, !dbg !824            ; [#uses=1 type=i64] [debug line = 118:6]
  %53 = load i32* %row_tpl, align 4, !dbg !824    ; [#uses=1 type=i32] [debug line = 118:6]
  %54 = sext i32 %53 to i64, !dbg !824            ; [#uses=1 type=i64] [debug line = 118:6]
  %55 = load [1200 x i32]** %4, align 8, !dbg !824 ; [#uses=1 type=[1200 x i32]*] [debug line = 118:6]
  %56 = getelementptr inbounds [1200 x i32]* %55, i64 %54, !dbg !824 ; [#uses=1 type=[1200 x i32]*] [debug line = 118:6]
  %57 = getelementptr inbounds [1200 x i32]* %56, i32 0, i64 %52, !dbg !824 ; [#uses=1 type=i32*] [debug line = 118:6]
  %58 = load i32* %57, align 4, !dbg !824         ; [#uses=1 type=i32] [debug line = 118:6]
  %59 = and i32 %58, 255, !dbg !824               ; [#uses=1 type=i32] [debug line = 118:6]
  store i32 %59, i32* %template_img, align 4, !dbg !824 ; [debug line = 118:6]
  %60 = load i32* %search_img, align 4, !dbg !825 ; [#uses=1 type=i32] [debug line = 120:13]
  %61 = load i32* %template_img, align 4, !dbg !825 ; [#uses=1 type=i32] [debug line = 120:13]
  %62 = sub nsw i32 %60, %61, !dbg !825           ; [#uses=1 type=i32] [debug line = 120:13]
  %63 = call i32 @abs(i32 %62) nounwind readnone, !dbg !825 ; [#uses=1 type=i32] [debug line = 120:13]
  %64 = load i32* %SAD, align 4, !dbg !825        ; [#uses=1 type=i32] [debug line = 120:13]
  %65 = add nsw i32 %64, %63, !dbg !825           ; [#uses=1 type=i32] [debug line = 120:13]
  store i32 %65, i32* %SAD, align 4, !dbg !825    ; [debug line = 120:13]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1031, i32 0, i32 0)) nounwind, !dbg !826 ; [debug line = 121:5]
  br label %66, !dbg !826                         ; [debug line = 121:5]

; <label>:66                                      ; preds = %37
  %67 = load i32* %col_tpl, align 4, !dbg !827    ; [#uses=1 type=i32] [debug line = 113:45]
  %68 = add nsw i32 %67, 1, !dbg !827             ; [#uses=1 type=i32] [debug line = 113:45]
  store i32 %68, i32* %col_tpl, align 4, !dbg !827 ; [debug line = 113:45]
  br label %33, !dbg !827                         ; [debug line = 113:45]

; <label>:69                                      ; preds = %33
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str930, i32 0, i32 0)) nounwind, !dbg !828 ; [debug line = 122:4]
  br label %70, !dbg !828                         ; [debug line = 122:4]

; <label>:70                                      ; preds = %69
  %71 = load i32* %row_tpl, align 4, !dbg !829    ; [#uses=1 type=i32] [debug line = 110:48]
  %72 = add nsw i32 %71, 1, !dbg !829             ; [#uses=1 type=i32] [debug line = 110:48]
  store i32 %72, i32* %row_tpl, align 4, !dbg !829 ; [debug line = 110:48]
  br label %27, !dbg !829                         ; [debug line = 110:48]

; <label>:73                                      ; preds = %27
  %74 = load i32* %minSAD, align 4, !dbg !830     ; [#uses=1 type=i32] [debug line = 123:4]
  %75 = load i32* %SAD, align 4, !dbg !830        ; [#uses=1 type=i32] [debug line = 123:4]
  %76 = icmp sgt i32 %74, %75, !dbg !830          ; [#uses=1 type=i1] [debug line = 123:4]
  br i1 %76, label %80, label %77, !dbg !830      ; [debug line = 123:4]

; <label>:77                                      ; preds = %73
  %78 = load i32* %minSAD, align 4, !dbg !830     ; [#uses=1 type=i32] [debug line = 123:4]
  %79 = icmp eq i32 %78, 0, !dbg !830             ; [#uses=1 type=i1] [debug line = 123:4]
  br i1 %79, label %80, label %91, !dbg !830      ; [debug line = 123:4]

; <label>:80                                      ; preds = %77, %73
  %81 = load i32* %SAD, align 4, !dbg !831        ; [#uses=1 type=i32] [debug line = 124:5]
  store i32 %81, i32* %minSAD, align 4, !dbg !831 ; [debug line = 124:5]
  %82 = load i32* %row_img, align 4, !dbg !833    ; [#uses=1 type=i32] [debug line = 125:5]
  %83 = load %struct.t_SAD** %7, align 8, !dbg !833 ; [#uses=1 type=%struct.t_SAD*] [debug line = 125:5]
  %84 = getelementptr inbounds %struct.t_SAD* %83, i32 0, i32 1, !dbg !833 ; [#uses=1 type=i32*] [debug line = 125:5]
  store i32 %82, i32* %84, align 4, !dbg !833     ; [debug line = 125:5]
  %85 = load i32* %col_img, align 4, !dbg !834    ; [#uses=1 type=i32] [debug line = 126:5]
  %86 = load %struct.t_SAD** %7, align 8, !dbg !834 ; [#uses=1 type=%struct.t_SAD*] [debug line = 126:5]
  %87 = getelementptr inbounds %struct.t_SAD* %86, i32 0, i32 0, !dbg !834 ; [#uses=1 type=i32*] [debug line = 126:5]
  store i32 %85, i32* %87, align 4, !dbg !834     ; [debug line = 126:5]
  %88 = load i32* %SAD, align 4, !dbg !835        ; [#uses=1 type=i32] [debug line = 127:5]
  %89 = load %struct.t_SAD** %7, align 8, !dbg !835 ; [#uses=1 type=%struct.t_SAD*] [debug line = 127:5]
  %90 = getelementptr inbounds %struct.t_SAD* %89, i32 0, i32 2, !dbg !835 ; [#uses=1 type=i32*] [debug line = 127:5]
  store i32 %88, i32* %90, align 4, !dbg !835     ; [debug line = 127:5]
  br label %91, !dbg !836                         ; [debug line = 128:4]

; <label>:91                                      ; preds = %80, %77
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str829, i32 0, i32 0)) nounwind, !dbg !837 ; [debug line = 129:3]
  br label %92, !dbg !837                         ; [debug line = 129:3]

; <label>:92                                      ; preds = %91
  %93 = load i32* %col_img, align 4, !dbg !838    ; [#uses=1 type=i32] [debug line = 107:55]
  %94 = add nsw i32 %93, 1, !dbg !838             ; [#uses=1 type=i32] [debug line = 107:55]
  store i32 %94, i32* %col_img, align 4, !dbg !838 ; [debug line = 107:55]
  br label %19, !dbg !838                         ; [debug line = 107:55]

; <label>:95                                      ; preds = %19
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str728, i32 0, i32 0)) nounwind, !dbg !839 ; [debug line = 130:2]
  br label %96, !dbg !839                         ; [debug line = 130:2]

; <label>:96                                      ; preds = %95
  %97 = load i32* %row_img, align 4, !dbg !840    ; [#uses=1 type=i32] [debug line = 105:57]
  %98 = add nsw i32 %97, 1, !dbg !840             ; [#uses=1 type=i32] [debug line = 105:57]
  store i32 %98, i32* %row_img, align 4, !dbg !840 ; [debug line = 105:57]
  br label %11, !dbg !840                         ; [debug line = 105:57]

; <label>:99                                      ; preds = %11
  ret void, !dbg !841                             ; [debug line = 132:1]
}
...
define void @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD([1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, i32 %tplHeight, i32 %tplWidth, %struct.t_SAD* %output_struct) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !842), !dbg !843 ; [debug line = 134:33] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %2, align 4
  call void @llvm.dbg.declare(metadata !{i32* %2}, metadata !844), !dbg !845 ; [debug line = 134:59] [debug variable = imHeight]
  store i32 %imWidth, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !846), !dbg !847 ; [debug line = 135:7] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %4, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %4}, metadata !848), !dbg !849 ; [debug line = 135:20] [debug variable = tplINPUT]
  store i32 %tplHeight, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !850), !dbg !851 ; [debug line = 135:46] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !852), !dbg !853 ; [debug line = 136:7] [debug variable = tplWidth]
  store %struct.t_SAD* %output_struct, %struct.t_SAD** %7, align 8
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD** %7}, metadata !854), !dbg !855 ; [debug line = 136:24] [debug variable = output_struct]
  %8 = load [1200 x i32]** %1, align 8, !dbg !856 ; [#uses=1 type=[1200 x i32]*] [debug line = 136:40]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %8, i32 1200) nounwind, !dbg !856 ; [debug line = 136:40]
  %9 = load [1200 x i32]** %4, align 8, !dbg !858 ; [#uses=1 type=[1200 x i32]*] [debug line = 136:78]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !858 ; [debug line = 136:78]
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !859 ; [debug line = 137:1]
  call void @llvm.dbg.declare(metadata !{i32* %row}, metadata !860), !dbg !861 ; [debug line = 138:6] [debug variable = row]
  call void @llvm.dbg.declare(metadata !{i32* %col}, metadata !862), !dbg !863 ; [debug line = 139:6] [debug variable = col]
  call void @llvm.dbg.declare(metadata !{i32* %row_offset}, metadata !864), !dbg !865 ; [debug line = 140:6] [debug variable = row_offset]
  %10 = load %struct.t_SAD** %7, align 8, !dbg !866 ; [#uses=1 type=%struct.t_SAD*] [debug line = 140:35]
  %11 = getelementptr inbounds %struct.t_SAD* %10, i32 0, i32 1, !dbg !866 ; [#uses=1 type=i32*] [debug line = 140:35]
  %12 = load i32* %11, align 4, !dbg !866         ; [#uses=1 type=i32] [debug line = 140:35]
  store i32 %12, i32* %row_offset, align 4, !dbg !866 ; [debug line = 140:35]
  call void @llvm.dbg.declare(metadata !{i32* %col_offset}, metadata !867), !dbg !868 ; [debug line = 141:6] [debug variable = col_offset]
  %13 = load %struct.t_SAD** %7, align 8, !dbg !869 ; [#uses=1 type=%struct.t_SAD*] [debug line = 141:35]
  %14 = getelementptr inbounds %struct.t_SAD* %13, i32 0, i32 0, !dbg !869 ; [#uses=1 type=i32*] [debug line = 141:35]
  %15 = load i32* %14, align 4, !dbg !869         ; [#uses=1 type=i32] [debug line = 141:35]
  store i32 %15, i32* %col_offset, align 4, !dbg !869 ; [debug line = 141:35]
  br label %16, !dbg !869                         ; [debug line = 141:35]

; <label>:16                                      ; preds = %0
  store i32 0, i32* %row, align 4, !dbg !870      ; [debug line = 143:13]
  br label %17, !dbg !870                         ; [debug line = 143:13]

; <label>:17                                      ; preds = %51, %16
  %18 = load i32* %row, align 4, !dbg !870        ; [#uses=1 type=i32] [debug line = 143:13]
  %19 = load i32* %5, align 4, !dbg !870          ; [#uses=1 type=i32] [debug line = 143:13]
  %20 = icmp slt i32 %18, %19, !dbg !870          ; [#uses=1 type=i1] [debug line = 143:13]
  br i1 %20, label %21, label %54, !dbg !870      ; [debug line = 143:13]

; <label>:21                                      ; preds = %17
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([5 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !872 ; [debug line = 143:47]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([5 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !872 ; [debug line = 143:47]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !874 ; [debug line = 144:1]
  br label %22, !dbg !874                         ; [debug line = 144:1]

; <label>:22                                      ; preds = %21
  store i32 0, i32* %col, align 4, !dbg !875      ; [debug line = 145:13]
  br label %23, !dbg !875                         ; [debug line = 145:13]

; <label>:23                                      ; preds = %47, %22
  %24 = load i32* %col, align 4, !dbg !875        ; [#uses=1 type=i32] [debug line = 145:13]
  %25 = load i32* %6, align 4, !dbg !875          ; [#uses=1 type=i32] [debug line = 145:13]
  %26 = icmp slt i32 %24, %25, !dbg !875          ; [#uses=1 type=i1] [debug line = 145:13]
  br i1 %26, label %27, label %50, !dbg !875      ; [debug line = 145:13]

; <label>:27                                      ; preds = %23
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !877 ; [debug line = 145:46]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !877 ; [debug line = 145:46]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 200, i32 100, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !879 ; [debug line = 146:1]
  %28 = load i32* %col, align 4, !dbg !880        ; [#uses=1 type=i32] [debug line = 147:2]
  %29 = sext i32 %28 to i64, !dbg !880            ; [#uses=1 type=i64] [debug line = 147:2]
  %30 = load i32* %row, align 4, !dbg !880        ; [#uses=1 type=i32] [debug line = 147:2]
  %31 = sext i32 %30 to i64, !dbg !880            ; [#uses=1 type=i64] [debug line = 147:2]
  %32 = load [1200 x i32]** %4, align 8, !dbg !880 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:2]
  %33 = getelementptr inbounds [1200 x i32]* %32, i64 %31, !dbg !880 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:2]
  %34 = getelementptr inbounds [1200 x i32]* %33, i32 0, i64 %29, !dbg !880 ; [#uses=1 type=i32*] [debug line = 147:2]
  %35 = load i32* %34, align 4, !dbg !880         ; [#uses=1 type=i32] [debug line = 147:2]
  %36 = load i32* %col_offset, align 4, !dbg !880 ; [#uses=1 type=i32] [debug line = 147:2]
  %37 = load i32* %col, align 4, !dbg !880        ; [#uses=1 type=i32] [debug line = 147:2]
  %38 = add nsw i32 %36, %37, !dbg !880           ; [#uses=1 type=i32] [debug line = 147:2]
  %39 = sext i32 %38 to i64, !dbg !880            ; [#uses=1 type=i64] [debug line = 147:2]
  %40 = load i32* %row_offset, align 4, !dbg !880 ; [#uses=1 type=i32] [debug line = 147:2]
  %41 = load i32* %row, align 4, !dbg !880        ; [#uses=1 type=i32] [debug line = 147:2]
  %42 = add nsw i32 %40, %41, !dbg !880           ; [#uses=1 type=i32] [debug line = 147:2]
  %43 = sext i32 %42 to i64, !dbg !880            ; [#uses=1 type=i64] [debug line = 147:2]
  %44 = load [1200 x i32]** %1, align 8, !dbg !880 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:2]
  %45 = getelementptr inbounds [1200 x i32]* %44, i64 %43, !dbg !880 ; [#uses=1 type=[1200 x i32]*] [debug line = 147:2]
  %46 = getelementptr inbounds [1200 x i32]* %45, i32 0, i64 %39, !dbg !880 ; [#uses=1 type=i32*] [debug line = 147:2]
  store i32 %35, i32* %46, align 4, !dbg !880     ; [debug line = 147:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([5 x i8]* @.str1233, i32 0, i32 0)) nounwind, !dbg !881 ; [debug line = 148:3]
  br label %47, !dbg !881                         ; [debug line = 148:3]

; <label>:47                                      ; preds = %27
  %48 = load i32* %col, align 4, !dbg !882        ; [#uses=1 type=i32] [debug line = 145:38]
  %49 = add nsw i32 %48, 1, !dbg !882             ; [#uses=1 type=i32] [debug line = 145:38]
  store i32 %49, i32* %col, align 4, !dbg !882    ; [debug line = 145:38]
  br label %23, !dbg !882                         ; [debug line = 145:38]

; <label>:50                                      ; preds = %23
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([5 x i8]* @.str1132, i32 0, i32 0)) nounwind, !dbg !883 ; [debug line = 150:2]
  br label %51, !dbg !883                         ; [debug line = 150:2]

; <label>:51                                      ; preds = %50
  %52 = load i32* %row, align 4, !dbg !884        ; [#uses=1 type=i32] [debug line = 143:39]
  %53 = add nsw i32 %52, 1, !dbg !884             ; [#uses=1 type=i32] [debug line = 143:39]
  store i32 %53, i32* %row, align 4, !dbg !884    ; [debug line = 143:39]
  br label %17, !dbg !884                         ; [debug line = 143:39]

; <label>:54                                      ; preds = %17
  ret void, !dbg !885                             ; [debug line = 151:1]
}
...
define void @_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii([1200 x i32]* %imINPUT, [1200 x i32]* %imOUTPUT, i32 %imHeight, i32 %imWidth, [1200 x i32]* %tplINPUT, [1200 x i32]* %tplOUTPUT, i32 %tplHeight, i32 %tplWidth) nounwind uwtable {
  ...
  %template_match_position = alloca %struct.t_SAD, align 4 ; [#uses=3 type=%struct.t_SAD*]
  store [1200 x i32]* %imINPUT, [1200 x i32]** %1, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %1}, metadata !886), !dbg !887 ; [debug line = 153:29] [debug variable = imINPUT]
  store [1200 x i32]* %imOUTPUT, [1200 x i32]** %2, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %2}, metadata !888), !dbg !889 ; [debug line = 154:7] [debug variable = imOUTPUT]
  store i32 %imHeight, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !890), !dbg !891 ; [debug line = 154:33] [debug variable = imHeight]
  store i32 %imWidth, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !892), !dbg !893 ; [debug line = 154:47] [debug variable = imWidth]
  store [1200 x i32]* %tplINPUT, [1200 x i32]** %5, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %5}, metadata !894), !dbg !895 ; [debug line = 155:7] [debug variable = tplINPUT]
  store [1200 x i32]* %tplOUTPUT, [1200 x i32]** %6, align 8
  call void @llvm.dbg.declare(metadata !{[1200 x i32]** %6}, metadata !896), !dbg !897 ; [debug line = 156:7] [debug variable = tplOUTPUT]
  store i32 %tplHeight, i32* %7, align 4
  call void @llvm.dbg.declare(metadata !{i32* %7}, metadata !898), !dbg !899 ; [debug line = 156:34] [debug variable = tplHeight]
  store i32 %tplWidth, i32* %8, align 4
  call void @llvm.dbg.declare(metadata !{i32* %8}, metadata !900), !dbg !901 ; [debug line = 157:7] [debug variable = tplWidth]
  %9 = load [1200 x i32]** %1, align 8, !dbg !902 ; [#uses=1 type=[1200 x i32]*] [debug line = 157:18]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %9, i32 1200) nounwind, !dbg !902 ; [debug line = 157:18]
  %10 = load [1200 x i32]** %2, align 8, !dbg !904 ; [#uses=1 type=[1200 x i32]*] [debug line = 157:55]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %10, i32 1200) nounwind, !dbg !904 ; [debug line = 157:55]
  %11 = load [1200 x i32]** %6, align 8, !dbg !905 ; [#uses=1 type=[1200 x i32]*] [debug line = 157:93]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %11, i32 1200) nounwind, !dbg !905 ; [debug line = 157:93]
  %12 = load [1200 x i32]** %5, align 8, !dbg !906 ; [#uses=1 type=[1200 x i32]*] [debug line = 157:132]
  call void (...)* @_ssdm_SpecArrayDimSize([1200 x i32]* %12, i32 1200) nounwind, !dbg !906 ; [debug line = 157:132]
  %13 = load [1200 x i32]** %1, align 8, !dbg !907 ; [#uses=1 type=[1200 x i32]*] [debug line = 159:1]
  call void (...)* @_ssdm_SpecStream([1200 x i32]* %13, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !907 ; [debug line = 159:1]
  call void @llvm.dbg.declare(metadata !{%struct.t_SAD* %template_match_position}, metadata !908), !dbg !909 ; [debug line = 162:8] [debug variable = template_match_position]
  call void (...)* @_ssdm_DataPack(%struct.t_SAD* %template_match_position, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str1334, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str21, i32 0, i32 0)) nounwind, !dbg !910 ; [debug line = 163:1]
  %14 = load [1200 x i32]** %1, align 8, !dbg !911 ; [#uses=1 type=[1200 x i32]*] [debug line = 164:2]
  %15 = load [1200 x i32]** %2, align 8, !dbg !911 ; [#uses=1 type=[1200 x i32]*] [debug line = 164:2]
  %16 = load i32* %3, align 4, !dbg !911          ; [#uses=1 type=i32] [debug line = 164:2]
  %17 = load i32* %4, align 4, !dbg !911          ; [#uses=1 type=i32] [debug line = 164:2]
  call void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %14, [1200 x i32]* %15, i32 %16, i32 %17, i32 0), !dbg !911 ; [debug line = 164:2]
  %18 = load [1200 x i32]** %5, align 8, !dbg !912 ; [#uses=1 type=[1200 x i32]*] [debug line = 165:2]
  %19 = load [1200 x i32]** %6, align 8, !dbg !912 ; [#uses=1 type=[1200 x i32]*] [debug line = 165:2]
  %20 = load i32* %7, align 4, !dbg !912          ; [#uses=1 type=i32] [debug line = 165:2]
  %21 = load i32* %8, align 4, !dbg !912          ; [#uses=1 type=i32] [debug line = 165:2]
  call void @_Z11imGrayScalePA1200_iS0_iii([1200 x i32]* %18, [1200 x i32]* %19, i32 %20, i32 %21, i32 0), !dbg !912 ; [debug line = 165:2]
  %22 = load [1200 x i32]** %2, align 8, !dbg !913 ; [#uses=1 type=[1200 x i32]*] [debug line = 166:2]
  %23 = load [1200 x i32]** %2, align 8, !dbg !913 ; [#uses=1 type=[1200 x i32]*] [debug line = 166:2]
  %24 = load i32* %3, align 4, !dbg !913          ; [#uses=1 type=i32] [debug line = 166:2]
  %25 = load i32* %4, align 4, !dbg !913          ; [#uses=1 type=i32] [debug line = 166:2]
  call void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %22, [1200 x i32]* %23, i32 %24, i32 %25, i32 255, i32 0), !dbg !913 ; [debug line = 166:2]
  %26 = load [1200 x i32]** %6, align 8, !dbg !914 ; [#uses=1 type=[1200 x i32]*] [debug line = 167:2]
  %27 = load [1200 x i32]** %6, align 8, !dbg !914 ; [#uses=1 type=[1200 x i32]*] [debug line = 167:2]
  %28 = load i32* %8, align 4, !dbg !914          ; [#uses=1 type=i32] [debug line = 167:2]
  %29 = load i32* %4, align 4, !dbg !914          ; [#uses=1 type=i32] [debug line = 167:2]
  call void @_Z19imGreyNormalizationPA1200_iS0_iiii([1200 x i32]* %26, [1200 x i32]* %27, i32 %28, i32 %29, i32 255, i32 0), !dbg !914 ; [debug line = 167:2]
  %30 = load [1200 x i32]** %2, align 8, !dbg !915 ; [#uses=1 type=[1200 x i32]*] [debug line = 171:2]
  %31 = load i32* %3, align 4, !dbg !915          ; [#uses=1 type=i32] [debug line = 171:2]
  %32 = load i32* %4, align 4, !dbg !915          ; [#uses=1 type=i32] [debug line = 171:2]
  %33 = load [1200 x i32]** %6, align 8, !dbg !915 ; [#uses=1 type=[1200 x i32]*] [debug line = 171:2]
  %34 = load i32* %7, align 4, !dbg !915          ; [#uses=1 type=i32] [debug line = 171:2]
  %35 = load i32* %8, align 4, !dbg !915          ; [#uses=1 type=i32] [debug line = 171:2]
  call void @_Z6imDiffPA1200_iiiS0_iiP5t_SAD([1200 x i32]* %30, i32 %31, i32 %32, [1200 x i32]* %33, i32 %34, i32 %35, %struct.t_SAD* %template_match_position), !dbg !915 ; [debug line = 171:2]
  %36 = load [1200 x i32]** %2, align 8, !dbg !916 ; [#uses=1 type=[1200 x i32]*] [debug line = 173:2]
  %37 = load i32* %3, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 173:2]
  %38 = load i32* %4, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 173:2]
  %39 = load [1200 x i32]** %5, align 8, !dbg !916 ; [#uses=1 type=[1200 x i32]*] [debug line = 173:2]
  %40 = load i32* %7, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 173:2]
  %41 = load i32* %8, align 4, !dbg !916          ; [#uses=1 type=i32] [debug line = 173:2]
  call void @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD([1200 x i32]* %36, i32 %37, i32 %38, [1200 x i32]* %39, i32 %40, i32 %41, %struct.t_SAD* %template_match_position), !dbg !916 ; [debug line = 173:2]
  ret void, !dbg !917                             ; [debug line = 176:1]
}
...
!171 = metadata !{i32 786478, i32 0, metadata !161, metadata !"imDiff", metadata !"imDiff", metadata !"_Z6imDiffPA1200_iiiS0_iiP5t_SAD", metadata !161, i32 95, metadata !172, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([1200 x i32]*, i32, i32, [1200 x i32]*, i32, i32, %struct.t_SAD*)* @_Z6imDiffPA1200_iiiS0_iiP5t_SAD, null, null, metadata !67, i32 97} ; [ DW_TAG_subprogram ]
...
!181 = metadata !{i32 786478, i32 0, metadata !161, metadata !"imConstructOutputImage", metadata !"imConstructOutputImage", metadata !"_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD", metadata !161, i32 134, metadata !172, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([1200 x i32]*, i32, i32, [1200 x i32]*, i32, i32, %struct.t_SAD*)* @_Z22imConstructOutputImagePA1200_iiiS0_iiP5t_SAD, null, null, metadata !67, i32 136} ; [ DW_TAG_subprogram ]
!182 = metadata !{i32 786478, i32 0, metadata !161, metadata !"imTemplateMatching", metadata !"imTemplateMatching", metadata !"_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii", metadata !161, i32 153, metadata !183, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([1200 x i32]*, [1200 x i32]*, i32, i32, [1200 x i32]*, [1200 x i32]*, i32, i32)* @_Z18imTemplateMatchingPA1200_iS0_iiS0_S0_ii, null, null, metadata !67, i32 157} ; [ DW_TAG_subprogram ]
...
!664 = metadata !{i32 21, i32 1, metadata !662, null}
!665 = metadata !{i32 786688, metadata !662, metadata !"row", metadata !161, i32 24, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!666 = metadata !{i32 24, i32 6, metadata !662, null}
!667 = metadata !{i32 786688, metadata !662, metadata !"col", metadata !161, i32 25, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!668 = metadata !{i32 25, i32 6, metadata !662, null}
!669 = metadata !{i32 786688, metadata !662, metadata !"gray_pixel", metadata !161, i32 26, metadata !109, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!670 = metadata !{i32 26, i32 16, metadata !662, null}
!671 = metadata !{i32 26, i32 26, metadata !662, null}
!672 = metadata !{i32 29, i32 12, metadata !673, null}
!673 = metadata !{i32 786443, metadata !662, i32 29, i32 7, metadata !161, i32 1} ; [ DW_TAG_lexical_block ]
!674 = metadata !{i32 29, i32 45, metadata !675, null}
!675 = metadata !{i32 786443, metadata !673, i32 29, i32 44, metadata !161, i32 2} ; [ DW_TAG_lexical_block ]
!676 = metadata !{i32 30, i32 1, metadata !675, null}
!677 = metadata !{i32 31, i32 12, metadata !678, null}
!678 = metadata !{i32 786443, metadata !675, i32 31, i32 7, metadata !161, i32 3} ; [ DW_TAG_lexical_block ]
!679 = metadata !{i32 31, i32 44, metadata !680, null}
!680 = metadata !{i32 786443, metadata !678, i32 31, i32 43, metadata !161, i32 4} ; [ DW_TAG_lexical_block ]
!681 = metadata !{i32 32, i32 1, metadata !680, null}
!682 = metadata !{i32 34, i32 2, metadata !680, null}
!683 = metadata !{i32 36, i32 5, metadata !684, null}
!684 = metadata !{i32 786443, metadata !680, i32 34, i32 21, metadata !161, i32 5} ; [ DW_TAG_lexical_block ]
!685 = metadata !{i32 37, i32 5, metadata !684, null}
!686 = metadata !{i32 39, i32 5, metadata !684, null}
!687 = metadata !{i32 40, i32 5, metadata !684, null}
!688 = metadata !{i32 42, i32 5, metadata !684, null}
!689 = metadata !{i32 43, i32 5, metadata !684, null}
!690 = metadata !{i32 45, i32 5, metadata !684, null}
!691 = metadata !{i32 46, i32 4, metadata !684, null}
!692 = metadata !{i32 48, i32 4, metadata !680, null}
!693 = metadata !{i32 51, i32 3, metadata !680, null}
!694 = metadata !{i32 31, i32 36, metadata !678, null}
!695 = metadata !{i32 52, i32 2, metadata !675, null}
!696 = metadata !{i32 29, i32 37, metadata !673, null}
!697 = metadata !{i32 54, i32 1, metadata !662, null}
!698 = metadata !{i32 786689, metadata !168, metadata !"imINPUT", metadata !161, i32 16777272, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!699 = metadata !{i32 56, i32 30, metadata !168, null}
!700 = metadata !{i32 786689, metadata !168, metadata !"imOUTPUT", metadata !161, i32 33554489, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!701 = metadata !{i32 57, i32 7, metadata !168, null}
!702 = metadata !{i32 786689, metadata !168, metadata !"imHeight", metadata !161, i32 50331705, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!703 = metadata !{i32 57, i32 33, metadata !168, null}
!704 = metadata !{i32 786689, metadata !168, metadata !"imWidth", metadata !161, i32 67108921, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!705 = metadata !{i32 57, i32 47, metadata !168, null}
!706 = metadata !{i32 786689, metadata !168, metadata !"newMax", metadata !161, i32 83886138, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!707 = metadata !{i32 58, i32 7, metadata !168, null}
!708 = metadata !{i32 786689, metadata !168, metadata !"newMin", metadata !161, i32 100663354, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!709 = metadata !{i32 58, i32 19, metadata !168, null}
!710 = metadata !{i32 58, i32 28, metadata !711, null}
!711 = metadata !{i32 786443, metadata !168, i32 58, i32 27, metadata !161, i32 6} ; [ DW_TAG_lexical_block ]
!712 = metadata !{i32 58, i32 65, metadata !711, null}
!713 = metadata !{i32 786688, metadata !711, metadata !"row", metadata !161, i32 60, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!714 = metadata !{i32 60, i32 6, metadata !711, null}
!715 = metadata !{i32 786688, metadata !711, metadata !"col", metadata !161, i32 61, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!716 = metadata !{i32 61, i32 6, metadata !711, null}
!717 = metadata !{i32 786688, metadata !711, metadata !"max", metadata !161, i32 62, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!718 = metadata !{i32 62, i32 6, metadata !711, null}
!719 = metadata !{i32 62, i32 36, metadata !711, null}
!720 = metadata !{i32 786688, metadata !711, metadata !"min", metadata !161, i32 63, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!721 = metadata !{i32 63, i32 6, metadata !711, null}
!722 = metadata !{i32 63, i32 15, metadata !711, null}
!723 = metadata !{i32 786688, metadata !711, metadata !"newValue", metadata !161, i32 64, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!724 = metadata !{i32 64, i32 6, metadata !711, null}
!725 = metadata !{i32 64, i32 14, metadata !711, null}
!726 = metadata !{i32 66, i32 12, metadata !727, null}
!727 = metadata !{i32 786443, metadata !711, i32 66, i32 7, metadata !161, i32 7} ; [ DW_TAG_lexical_block ]
!728 = metadata !{i32 66, i32 45, metadata !729, null}
!729 = metadata !{i32 786443, metadata !727, i32 66, i32 44, metadata !161, i32 8} ; [ DW_TAG_lexical_block ]
!730 = metadata !{i32 67, i32 1, metadata !729, null}
!731 = metadata !{i32 68, i32 12, metadata !732, null}
!732 = metadata !{i32 786443, metadata !729, i32 68, i32 7, metadata !161, i32 9} ; [ DW_TAG_lexical_block ]
!733 = metadata !{i32 68, i32 44, metadata !734, null}
!734 = metadata !{i32 786443, metadata !732, i32 68, i32 43, metadata !161, i32 10} ; [ DW_TAG_lexical_block ]
!735 = metadata !{i32 69, i32 1, metadata !734, null}
!736 = metadata !{i32 71, i32 2, metadata !734, null}
!737 = metadata !{i32 72, i32 5, metadata !738, null}
!738 = metadata !{i32 786443, metadata !734, i32 71, i32 46, metadata !161, i32 11} ; [ DW_TAG_lexical_block ]
!739 = metadata !{i32 73, i32 4, metadata !738, null}
!740 = metadata !{i32 74, i32 4, metadata !734, null}
!741 = metadata !{i32 75, i32 5, metadata !742, null}
!742 = metadata !{i32 786443, metadata !734, i32 74, i32 48, metadata !161, i32 12} ; [ DW_TAG_lexical_block ]
!743 = metadata !{i32 76, i32 4, metadata !742, null}
!744 = metadata !{i32 77, i32 3, metadata !734, null}
!745 = metadata !{i32 68, i32 36, metadata !732, null}
!746 = metadata !{i32 79, i32 2, metadata !729, null}
!747 = metadata !{i32 66, i32 37, metadata !727, null}
!748 = metadata !{i32 79, i32 2, metadata !727, null}
!749 = metadata !{i32 81, i32 12, metadata !750, null}
!750 = metadata !{i32 786443, metadata !711, i32 81, i32 7, metadata !161, i32 13} ; [ DW_TAG_lexical_block ]
!751 = metadata !{i32 81, i32 45, metadata !752, null}
!752 = metadata !{i32 786443, metadata !750, i32 81, i32 44, metadata !161, i32 14} ; [ DW_TAG_lexical_block ]
!753 = metadata !{i32 82, i32 1, metadata !752, null}
!754 = metadata !{i32 83, i32 12, metadata !755, null}
!755 = metadata !{i32 786443, metadata !752, i32 83, i32 7, metadata !161, i32 15} ; [ DW_TAG_lexical_block ]
!756 = metadata !{i32 83, i32 44, metadata !757, null}
!757 = metadata !{i32 786443, metadata !755, i32 83, i32 43, metadata !161, i32 16} ; [ DW_TAG_lexical_block ]
!758 = metadata !{i32 84, i32 1, metadata !757, null}
!759 = metadata !{i32 86, i32 2, metadata !757, null}
!760 = metadata !{i32 88, i32 4, metadata !757, null}
!761 = metadata !{i32 90, i32 3, metadata !757, null}
!762 = metadata !{i32 83, i32 36, metadata !755, null}
!763 = metadata !{i32 91, i32 2, metadata !752, null}
!764 = metadata !{i32 81, i32 37, metadata !750, null}
!765 = metadata !{i32 93, i32 1, metadata !711, null}
!766 = metadata !{i32 786689, metadata !171, metadata !"imINPUT", metadata !161, i32 16777311, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!767 = metadata !{i32 95, i32 17, metadata !171, null}
!768 = metadata !{i32 786689, metadata !171, metadata !"imHeight", metadata !161, i32 33554527, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!769 = metadata !{i32 95, i32 42, metadata !171, null}
!770 = metadata !{i32 786689, metadata !171, metadata !"imWidth", metadata !161, i32 50331743, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!771 = metadata !{i32 95, i32 56, metadata !171, null}
!772 = metadata !{i32 786689, metadata !171, metadata !"tplINPUT", metadata !161, i32 67108960, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!773 = metadata !{i32 96, i32 7, metadata !171, null}
!774 = metadata !{i32 786689, metadata !171, metadata !"tplHeight", metadata !161, i32 83886176, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!775 = metadata !{i32 96, i32 33, metadata !171, null}
!776 = metadata !{i32 786689, metadata !171, metadata !"tplWidth", metadata !161, i32 100663393, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!777 = metadata !{i32 97, i32 7, metadata !171, null}
!778 = metadata !{i32 786689, metadata !171, metadata !"output_struct", metadata !161, i32 117440609, metadata !174, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!779 = metadata !{i32 97, i32 24, metadata !171, null}
!780 = metadata !{i32 97, i32 40, metadata !781, null}
!781 = metadata !{i32 786443, metadata !171, i32 97, i32 39, metadata !161, i32 17} ; [ DW_TAG_lexical_block ]
!782 = metadata !{i32 97, i32 77, metadata !781, null}
!783 = metadata !{i32 98, i32 1, metadata !781, null}
!784 = metadata !{i32 786688, metadata !781, metadata !"row_img", metadata !161, i32 99, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!785 = metadata !{i32 99, i32 6, metadata !781, null}
!786 = metadata !{i32 786688, metadata !781, metadata !"row_tpl", metadata !161, i32 99, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!787 = metadata !{i32 99, i32 15, metadata !781, null}
!788 = metadata !{i32 786688, metadata !781, metadata !"col_img", metadata !161, i32 100, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!789 = metadata !{i32 100, i32 6, metadata !781, null}
!790 = metadata !{i32 786688, metadata !781, metadata !"col_tpl", metadata !161, i32 100, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!791 = metadata !{i32 100, i32 15, metadata !781, null}
!792 = metadata !{i32 786688, metadata !781, metadata !"search_img", metadata !161, i32 101, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!793 = metadata !{i32 101, i32 6, metadata !781, null}
!794 = metadata !{i32 786688, metadata !781, metadata !"template_img", metadata !161, i32 101, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!795 = metadata !{i32 101, i32 18, metadata !781, null}
!796 = metadata !{i32 786688, metadata !781, metadata !"SAD", metadata !161, i32 102, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!797 = metadata !{i32 102, i32 6, metadata !781, null}
!798 = metadata !{i32 786688, metadata !781, metadata !"minSAD", metadata !161, i32 102, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!799 = metadata !{i32 102, i32 11, metadata !781, null}
!800 = metadata !{i32 104, i32 2, metadata !781, null}
!801 = metadata !{i32 105, i32 12, metadata !802, null}
!802 = metadata !{i32 786443, metadata !781, i32 105, i32 7, metadata !161, i32 18} ; [ DW_TAG_lexical_block ]
!803 = metadata !{i32 105, i32 69, metadata !804, null}
!804 = metadata !{i32 786443, metadata !802, i32 105, i32 68, metadata !161, i32 19} ; [ DW_TAG_lexical_block ]
!805 = metadata !{i32 106, i32 1, metadata !804, null}
!806 = metadata !{i32 107, i32 12, metadata !807, null}
!807 = metadata !{i32 786443, metadata !804, i32 107, i32 7, metadata !161, i32 20} ; [ DW_TAG_lexical_block ]
!808 = metadata !{i32 107, i32 67, metadata !809, null}
!809 = metadata !{i32 786443, metadata !807, i32 107, i32 66, metadata !161, i32 21} ; [ DW_TAG_lexical_block ]
!810 = metadata !{i32 108, i32 1, metadata !809, null}
!811 = metadata !{i32 109, i32 2, metadata !809, null}
!812 = metadata !{i32 110, i32 14, metadata !813, null}
!813 = metadata !{i32 786443, metadata !809, i32 110, i32 9, metadata !161, i32 22} ; [ DW_TAG_lexical_block ]
!814 = metadata !{i32 110, i32 60, metadata !815, null}
!815 = metadata !{i32 786443, metadata !813, i32 110, i32 59, metadata !161, i32 23} ; [ DW_TAG_lexical_block ]
!816 = metadata !{i32 112, i32 1, metadata !815, null}
!817 = metadata !{i32 113, i32 12, metadata !818, null}
!818 = metadata !{i32 786443, metadata !815, i32 113, i32 7, metadata !161, i32 24} ; [ DW_TAG_lexical_block ]
!819 = metadata !{i32 113, i32 57, metadata !820, null}
!820 = metadata !{i32 786443, metadata !818, i32 113, i32 56, metadata !161, i32 25} ; [ DW_TAG_lexical_block ]
!821 = metadata !{i32 114, i32 1, metadata !820, null}
!822 = metadata !{i32 115, i32 1, metadata !820, null}
!823 = metadata !{i32 116, i32 2, metadata !820, null}
!824 = metadata !{i32 118, i32 6, metadata !820, null}
!825 = metadata !{i32 120, i32 13, metadata !820, null}
!826 = metadata !{i32 121, i32 5, metadata !820, null}
!827 = metadata !{i32 113, i32 45, metadata !818, null}
!828 = metadata !{i32 122, i32 4, metadata !815, null}
!829 = metadata !{i32 110, i32 48, metadata !813, null}
!830 = metadata !{i32 123, i32 4, metadata !809, null}
!831 = metadata !{i32 124, i32 5, metadata !832, null}
!832 = metadata !{i32 786443, metadata !809, i32 123, i32 37, metadata !161, i32 26} ; [ DW_TAG_lexical_block ]
!833 = metadata !{i32 125, i32 5, metadata !832, null}
!834 = metadata !{i32 126, i32 5, metadata !832, null}
!835 = metadata !{i32 127, i32 5, metadata !832, null}
!836 = metadata !{i32 128, i32 4, metadata !832, null}
!837 = metadata !{i32 129, i32 3, metadata !809, null}
!838 = metadata !{i32 107, i32 55, metadata !807, null}
!839 = metadata !{i32 130, i32 2, metadata !804, null}
!840 = metadata !{i32 105, i32 57, metadata !802, null}
!841 = metadata !{i32 132, i32 1, metadata !781, null}
!842 = metadata !{i32 786689, metadata !181, metadata !"imOUTPUT", metadata !161, i32 16777350, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!843 = metadata !{i32 134, i32 33, metadata !181, null}
!844 = metadata !{i32 786689, metadata !181, metadata !"imHeight", metadata !161, i32 33554566, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!845 = metadata !{i32 134, i32 59, metadata !181, null}
!846 = metadata !{i32 786689, metadata !181, metadata !"imWidth", metadata !161, i32 50331783, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!847 = metadata !{i32 135, i32 7, metadata !181, null}
!848 = metadata !{i32 786689, metadata !181, metadata !"tplINPUT", metadata !161, i32 67108999, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!849 = metadata !{i32 135, i32 20, metadata !181, null}
!850 = metadata !{i32 786689, metadata !181, metadata !"tplHeight", metadata !161, i32 83886215, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!851 = metadata !{i32 135, i32 46, metadata !181, null}
!852 = metadata !{i32 786689, metadata !181, metadata !"tplWidth", metadata !161, i32 100663432, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!853 = metadata !{i32 136, i32 7, metadata !181, null}
!854 = metadata !{i32 786689, metadata !181, metadata !"output_struct", metadata !161, i32 117440648, metadata !174, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!855 = metadata !{i32 136, i32 24, metadata !181, null}
!856 = metadata !{i32 136, i32 40, metadata !857, null}
!857 = metadata !{i32 786443, metadata !181, i32 136, i32 39, metadata !161, i32 27} ; [ DW_TAG_lexical_block ]
!858 = metadata !{i32 136, i32 78, metadata !857, null}
!859 = metadata !{i32 137, i32 1, metadata !857, null}
!860 = metadata !{i32 786688, metadata !857, metadata !"row", metadata !161, i32 138, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!861 = metadata !{i32 138, i32 6, metadata !857, null}
!862 = metadata !{i32 786688, metadata !857, metadata !"col", metadata !161, i32 139, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!863 = metadata !{i32 139, i32 6, metadata !857, null}
!864 = metadata !{i32 786688, metadata !857, metadata !"row_offset", metadata !161, i32 140, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!865 = metadata !{i32 140, i32 6, metadata !857, null}
!866 = metadata !{i32 140, i32 35, metadata !857, null}
!867 = metadata !{i32 786688, metadata !857, metadata !"col_offset", metadata !161, i32 141, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!868 = metadata !{i32 141, i32 6, metadata !857, null}
!869 = metadata !{i32 141, i32 35, metadata !857, null}
!870 = metadata !{i32 143, i32 13, metadata !871, null}
!871 = metadata !{i32 786443, metadata !857, i32 143, i32 8, metadata !161, i32 28} ; [ DW_TAG_lexical_block ]
!872 = metadata !{i32 143, i32 47, metadata !873, null}
!873 = metadata !{i32 786443, metadata !871, i32 143, i32 46, metadata !161, i32 29} ; [ DW_TAG_lexical_block ]
!874 = metadata !{i32 144, i32 1, metadata !873, null}
!875 = metadata !{i32 145, i32 13, metadata !876, null}
!876 = metadata !{i32 786443, metadata !873, i32 145, i32 8, metadata !161, i32 30} ; [ DW_TAG_lexical_block ]
!877 = metadata !{i32 145, i32 46, metadata !878, null}
!878 = metadata !{i32 786443, metadata !876, i32 145, i32 45, metadata !161, i32 31} ; [ DW_TAG_lexical_block ]
!879 = metadata !{i32 146, i32 1, metadata !878, null}
!880 = metadata !{i32 147, i32 2, metadata !878, null}
!881 = metadata !{i32 148, i32 3, metadata !878, null}
!882 = metadata !{i32 145, i32 38, metadata !876, null}
!883 = metadata !{i32 150, i32 2, metadata !873, null}
!884 = metadata !{i32 143, i32 39, metadata !871, null}
!885 = metadata !{i32 151, i32 1, metadata !857, null}
!886 = metadata !{i32 786689, metadata !182, metadata !"imINPUT", metadata !161, i32 16777369, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!887 = metadata !{i32 153, i32 29, metadata !182, null}
!888 = metadata !{i32 786689, metadata !182, metadata !"imOUTPUT", metadata !161, i32 33554586, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!889 = metadata !{i32 154, i32 7, metadata !182, null}
!890 = metadata !{i32 786689, metadata !182, metadata !"imHeight", metadata !161, i32 50331802, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!891 = metadata !{i32 154, i32 33, metadata !182, null}
!892 = metadata !{i32 786689, metadata !182, metadata !"imWidth", metadata !161, i32 67109018, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!893 = metadata !{i32 154, i32 47, metadata !182, null}
!894 = metadata !{i32 786689, metadata !182, metadata !"tplINPUT", metadata !161, i32 83886235, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!895 = metadata !{i32 155, i32 7, metadata !182, null}
!896 = metadata !{i32 786689, metadata !182, metadata !"tplOUTPUT", metadata !161, i32 100663452, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!897 = metadata !{i32 156, i32 7, metadata !182, null}
!898 = metadata !{i32 786689, metadata !182, metadata !"tplHeight", metadata !161, i32 117440668, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!899 = metadata !{i32 156, i32 34, metadata !182, null}
!900 = metadata !{i32 786689, metadata !182, metadata !"tplWidth", metadata !161, i32 134217885, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!901 = metadata !{i32 157, i32 7, metadata !182, null}
!902 = metadata !{i32 157, i32 18, metadata !903, null}
!903 = metadata !{i32 786443, metadata !182, i32 157, i32 17, metadata !161, i32 32} ; [ DW_TAG_lexical_block ]
!904 = metadata !{i32 157, i32 55, metadata !903, null}
!905 = metadata !{i32 157, i32 93, metadata !903, null}
!906 = metadata !{i32 157, i32 132, metadata !903, null}
!907 = metadata !{i32 159, i32 1, metadata !903, null}
!908 = metadata !{i32 786688, metadata !903, metadata !"template_match_position", metadata !161, i32 162, metadata !175, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!909 = metadata !{i32 162, i32 8, metadata !903, null}
!910 = metadata !{i32 163, i32 1, metadata !903, null}
!911 = metadata !{i32 164, i32 2, metadata !903, null}
!912 = metadata !{i32 165, i32 2, metadata !903, null}
!913 = metadata !{i32 166, i32 2, metadata !903, null}
!914 = metadata !{i32 167, i32 2, metadata !903, null}
!915 = metadata !{i32 171, i32 2, metadata !903, null}
!916 = metadata !{i32 173, i32 2, metadata !903, null}
!917 = metadata !{i32 176, i32 1, metadata !903, null}
