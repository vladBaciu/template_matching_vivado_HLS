; ModuleID = '/home/student/workspace_HLS/labs/lab1_task/task/Task_1/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@imNegation_str = internal unnamed_addr constant [11 x i8] c"imNegation\00"
@p_str1 = private unnamed_addr constant [3 x i8] c"L1\00", align 1
@p_str = private unnamed_addr constant [3 x i8] c"L0\00", align 1
...
; <label>:1                                       ; preds = %5, %0
  %row = phi i31 [ 0, %0 ], [ %row_1, %5 ]
  %phi_mul = phi i42 [ 0, %0 ], [ %next_mul, %5 ]
  %tmp_1 = trunc i42 %phi_mul to i22
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str) nounwind
  br label %3

; <label>:3                                       ; preds = %4, %2
  %col = phi i31 [ 0, %2 ], [ %col_1, %4 ]
  %col_cast = zext i31 %col to i32
  %tmp_2 = icmp slt i32 %col_cast, %imWidth_read
  %col_1 = add i31 %col, 1
  br i1 %tmp_2, label %4, label %5

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str1) nounwind
  %tmp_3 = trunc i31 %col to i22
  %tmp_4 = add i22 %tmp_3, %tmp_1
  %tmp_11_cast = zext i22 %tmp_4 to i64
  %imINPUT_addr = getelementptr [1440000 x i32]* %imINPUT, i64 0, i64 %tmp_11_cast
  %imOUTPUT_addr = getelementptr [1440000 x i32]* %imOUTPUT, i64 0, i64 %tmp_11_cast
  %imINPUT_load = load i32* %imINPUT_addr, align 4
  %tmp_9 = trunc i32 %imINPUT_load to i8
  %tmp_5 = xor i8 %tmp_9, -1
  %tmp_7 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %imINPUT_load, i32 8, i32 15)
  %tmp_8 = xor i8 %tmp_7, -1
  %tmp_s = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %imINPUT_load, i32 16, i32 23)
  %tmp_10 = xor i8 %tmp_s, -1
  %tmp_11 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %imINPUT_load, i32 24, i32 31)
  %tmp_12 = xor i8 %tmp_11, -1
  %tmp_13 = call i32 @_ssdm_op_BitConcatenate.i32.i8.i8.i8.i8(i8 %tmp_12, i8 %tmp_10, i8 %tmp_8, i8 %tmp_5)
  store i32 %tmp_13, i32* %imOUTPUT_addr, align 4
  br label %3

; <label>:5                                       ; preds = %3
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str, i32 %tmp_6) nounwind
  br label %1
...
entry:
  ...
  %empty_5 = zext i8 %3 to i16
  %empty_6 = shl i16 %empty, 8
  %empty_7 = or i16 %empty_6, %empty_5
  %empty_8 = zext i8 %1 to i24
  %empty_9 = zext i16 %empty_7 to i24
  %empty_10 = shl i24 %empty_8, 16
  %empty_11 = or i24 %empty_10, %empty_9
  %empty_12 = zext i8 %0 to i32
  %empty_13 = zext i24 %empty_11 to i32
  %empty_14 = shl i32 %empty_12, 24
