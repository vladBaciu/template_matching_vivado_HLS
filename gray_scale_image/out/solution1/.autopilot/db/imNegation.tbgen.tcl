set C_TypeInfoList {{ 
"imNegation" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"imINPUT": [[], {"array": [ {"array": [ {"scalar": "int"}, [1200]]}, [1200]]}] }, {"imOUTPUT": [[], {"array": [ {"array": [ {"scalar": "int"}, [1200]]}, [1200]]}] }, {"imHeight": [[], {"scalar": "int"}] }, {"imWidth": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName imNegation
...
set C_modelArgMapList {[ 
	{ "Name" : "imINPUT", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "imINPUT","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1199,"step" : 1},{"low" : 0,"up" : 1199,"step" : 1}]}]}]} , 
 	{ "Name" : "imOUTPUT", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "imOUTPUT","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1199,"step" : 1},{"low" : 0,"up" : 1199,"step" : 1}]}]}]} , 
